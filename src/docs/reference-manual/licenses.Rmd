# Licensing {#licensing.appendix}

Stan and its two dependent libraries, Boost and Eigen, are distributed
under generous, freedom-respecting licenses approved by the [Open
...
This chapter specifies the licenses for the tools that are distributed
with Stan.  The last tool mentioned, Google Test, is only used for
testing and is not needed to run Stan.
