...
\index{{\tt \bfseries binomial}!(ints n | ints N, reals theta): real|hyperpage}
...
\index{{\tt \bfseries binomial}!(ints N, reals theta): R|hyperpage}
...
`n` ~ __`binomial_logit`__(`N, alpha`)
...
\index{{\tt \bfseries binomial\_logit}!(ints n | ints N, reals alpha): real|hyperpage}
...
`n` ~ __`beta_binomial`__(`N, alpha, beta`)
...
\index{{\tt \bfseries beta\_binomial}!(ints n | ints N, reals alpha, reals beta): real|hyperpage}
...
\index{{\tt \bfseries beta\_binomial}!(ints N, reals alpha, reals beta): R|hyperpage}
...
\index{{\tt \bfseries hypergeometric}!(int n ~|~ int N, int a, int b): real|hyperpage}
...
\index{{\tt \bfseries hypergeometric}!(int N, int a, int2 b): int|hyperpage}
...
`y` ~ __`categorical_logit`__(`beta`)
...
\index{{\tt \bfseries categorical}!(ints y | vector theta): real|hyperpage}
...
\index{{\tt \bfseries categorical\_logit}!(ints y | vector beta): real|hyperpage}
...
\index{{\tt \bfseries categorical}!(vector theta): int|hyperpage}
...
\index{{\tt \bfseries categorical\_logit}!(vector beta): int|hyperpage}
...
`k` ~ __`ordered_logistic`__(`eta, c`)
...
\index{{\tt \bfseries ordered\_logistic}!(ints k | vector eta, vectors c): real|hyperpage}
...
\index{{\tt \bfseries ordered\_logistic}!(real eta, vector c): int|hyperpage}
...
\index{{\tt \bfseries ordered\_probit}!(ints k | vector eta, vectors c): real|hyperpage}
...
\index{{\tt \bfseries ordered\_probit}!(real eta, vector c): int|hyperpage}
