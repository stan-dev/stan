...
\index{{\tt \bfseries lkj\_corr}!(matrix y | real eta): real|hyperpage}
...
\index{{\tt \bfseries lkj\_corr}!(int K, real eta): matrix|hyperpage}
...
\index{{\tt \bfseries lkj\_corr\_cholesky}!(matrix L | real eta): real|hyperpage}
...
\index{{\tt \bfseries lkj\_corr\_cholesky}!(int K, real eta): matrix|hyperpage}
