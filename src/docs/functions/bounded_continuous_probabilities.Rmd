...
\index{{\tt \bfseries uniform}!(reals y | reals alpha, reals beta): real|hyperpage}
...
\index{{\tt \bfseries uniform}!(reals alpha, reals beta): R|hyperpage}
