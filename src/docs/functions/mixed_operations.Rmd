...
\index{{\tt \bfseries to\_matrix}!(matrix m): matrix|hyperpage}

`matrix` **`to_matrix`**(`matrix m`)
 Return the matrix m itself.

<!-- matrix; to_matrix; (vector v); -->
\index{{\tt \bfseries to\_matrix}!(vector v): matrix|hyperpage}

`matrix` **`to_matrix`**(`vector v`)
 Convert the column vector v to a `size(v)` by 1 matrix.

<!-- matrix; to_matrix; (row_vector v); -->
\index{{\tt \bfseries to\_matrix}!(row\_vector v): matrix|hyperpage}

`matrix` **`to_matrix`**(`row_vector v`)
 Convert the row vector v to a 1 by `size(v)` matrix.

<!-- matrix; to_matrix; (matrix m, int m, int n); -->
\index{{\tt \bfseries to\_matrix}!(matrix m, int m, int n): matrix|hyperpage}
...
\index{{\tt \bfseries to\_matrix}!(vector v, int m, int n): matrix|hyperpage}
...
\index{{\tt \bfseries to\_matrix}!(row\_vector v, int m, int n): matrix|hyperpage}

`matrix` **`to_matrix`**(`row_vector v, int m, int n`)
 Convert a row_vector a to a matrix with m rows and n columns filled
in column-major order.

<!-- matrix; to_matrix; (matrix m, int m, int n, int col_major); -->
\index{{\tt \bfseries to\_matrix}!(matrix m, int m, int n, int col\_major): matrix|hyperpage}
...
\index{{\tt \bfseries to\_matrix}!(vector v, int m, int n, int col\_major): matrix|hyperpage}
...
\index{{\tt \bfseries to\_matrix}!(row\_vector v, int m, int n, int col\_major): matrix|hyperpage}

`matrix` **`to_matrix`**(`row_vector v, int m, int n, int col_major`)
 Convert a row_vector a to a matrix with m rows and n columns filled
in row-major order if col_major equals 0 (otherwise, they get filled
in column-major order).

<!-- matrix; to_matrix; (real[] a, int m, int n); -->
\index{{\tt \bfseries to\_matrix}!(real[] a, int m, int n): matrix|hyperpage}
...
\index{{\tt \bfseries to\_matrix}!(int[] a, int m, int n): matrix|hyperpage}
...
\index{{\tt \bfseries to\_matrix}!(real[] a, int m, int n, int col\_major): matrix|hyperpage}
...
\index{{\tt \bfseries to\_matrix}!(int[] a, int m, int n, int col\_major): matrix|hyperpage}
...
\index{{\tt \bfseries to\_matrix}!(real[,] a): matrix|hyperpage}
...
\index{{\tt \bfseries to\_matrix}!(int[,] a): matrix|hyperpage}
...
\index{{\tt \bfseries to\_array\_1d}!(vector v): real[]|hyperpage}

`real[]` **`to_array_1d`**(`vector v`)
 Convert the column vector v to a one-dimensional array.

<!-- real[]; to_array_1d; (row_vector v); -->
\index{{\tt \bfseries to\_array\_1d}!(row\_vector v): real[]|hyperpage}

`real[]` **`to_array_1d`**(`row_vector v`)
 Convert the row vector v to a one-dimensional array.

<!-- real[]; to_array_1d; (matrix m); -->
\index{{\tt \bfseries to\_array\_1d}!(matrix m): real[]|hyperpage}

`real[]` **`to_array_1d`**(`matrix m`)
 Convert the matrix m to a one-dimensional array in column-major
order.

<!-- real[]; to_array_1d; (real[...] a); -->
\index{{\tt \bfseries to\_array\_1d}!(real[...] a): real[]|hyperpage}
...
\index{{\tt \bfseries to\_array\_1d}!(int[...] a): int[]|hyperpage}
