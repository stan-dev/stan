...
\index{{\tt \bfseries bernoulli}!(ints y | reals theta): real|hyperpage}
...
\index{{\tt \bfseries bernoulli}!(reals theta): R|hyperpage}
...
\index{{\tt \bfseries bernoulli\_logit}!(ints y | reals alpha): real|hyperpage}
...
\index{{\tt \bfseries bernoulli\_logit}!(reals alpha): R|hyperpage}
...
`y` ~ __`bernoulli_logit_glm`__(`x, alpha, beta`)
...
\index{{\tt \bfseries bernoulli\_logit\_glm}!(int[] y | matrix x, real alpha, vector beta): real|hyperpage}
...
\index{{\tt \bfseries bernoulli\_logit\_glm}!(int[] y | matrix x, vector alpha, vector beta): real|hyperpage}
