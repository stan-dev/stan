...
<!-- int; rows; (vector x); -->
\index{{\tt \bfseries rows}!(vector x): int|hyperpage}

`int` **`rows`**(`vector x`)
The number of rows in the vector x

<!-- int; rows; (row_vector x); -->
\index{{\tt \bfseries rows}!(row\_vector x): int|hyperpage}

`int` **`rows`**(`row_vector x`)
The number of rows in the row vector x, namely 1

<!-- int; rows; (matrix x); -->
\index{{\tt \bfseries rows}!(matrix x): int|hyperpage}

`int` **`rows`**(`matrix x`)
The number of rows in the matrix x

<!-- int; cols; (vector x); -->
\index{{\tt \bfseries cols}!(vector x): int|hyperpage}

`int` **`cols`**(`vector x`)
The number of columns in the vector x, namely 1

<!-- int; cols; (row_vector x); -->
\index{{\tt \bfseries cols}!(row\_vector x): int|hyperpage}

`int` **`cols`**(`row_vector x`)
The number of columns in the row vector x

<!-- int; cols; (matrix x); -->
\index{{\tt \bfseries cols}!(matrix x): int|hyperpage}
...
\index{{\tt \bfseries operator\_subtract}!(vector x): vector|hyperpage}

`vector` **`operator-`**(`vector x`)
The negation of the vector x.

<!-- row_vector; operator-; (row_vector x); -->
\index{{\tt \bfseries operator\_subtract}!(row\_vector x): row\_vector|hyperpage}

`row_vector` **`operator-`**(`row_vector x`)
The negation of the row vector x.

<!-- matrix; operator-; (matrix x); -->
\index{{\tt \bfseries operator\_subtract}!(matrix x): matrix|hyperpage}
...
\index{{\tt \bfseries operator\_add}!(vector x, vector y): vector|hyperpage}

`vector` **`operator+`**(`vector x, vector y`)
The sum of the vectors x and y.

<!-- row_vector; operator+; (row_vector x, row_vector y); -->
\index{{\tt \bfseries operator\_add}!(row\_vector x, row\_vector y): row\_vector|hyperpage}

`row_vector` **`operator+`**(`row_vector x, row_vector y`)
The sum of the row vectors x and y.

<!-- matrix; operator+; (matrix x, matrix y); -->
\index{{\tt \bfseries operator\_add}!(matrix x, matrix y): matrix|hyperpage}

`matrix` **`operator+`**(`matrix x, matrix y`)
The sum of the matrices x and y

<!-- vector; operator-; (vector x, vector y); -->
\index{{\tt \bfseries operator\_subtract}!(vector x, vector y): vector|hyperpage}

`vector` **`operator-`**(`vector x, vector y`)
The difference between the vectors x and y.

<!-- row_vector; operator-; (row_vector x, row_vector y); -->
\index{{\tt \bfseries operator\_subtract}!(row\_vector x, row\_vector y): row\_vector|hyperpage}

`row_vector` **`operator-`**(`row_vector x, row_vector y`)
The difference between the row vectors x and y

<!-- matrix; operator-; (matrix x, matrix y); -->
\index{{\tt \bfseries operator\_subtract}!(matrix x, matrix y): matrix|hyperpage}

`matrix` **`operator-`**(`matrix x, matrix y`)
The difference between the matrices x and y

<!-- vector; operator*; (real x, vector y); -->
\index{{\tt \bfseries operator\_multiply}!(real x, vector y): vector|hyperpage}

`vector` **`operator*`**(`real x, vector y`)
The product of the scalar x and vector y

<!-- row_vector; operator*; (real x, row_vector y); -->
\index{{\tt \bfseries operator\_multiply}!(real x, row\_vector y): row\_vector|hyperpage}

`row_vector` **`operator*`**(`real x, row_vector y`)
The product of the scalar x and the row vector y

<!-- matrix; operator*; (real x, matrix y); -->
\index{{\tt \bfseries operator\_multiply}!(real x, matrix y): matrix|hyperpage}

`matrix` **`operator*`**(`real x, matrix y`)
The product of the scalar x and the matrix y

<!-- vector; operator*; (vector x, real y); -->
\index{{\tt \bfseries operator\_multiply}!(vector x, real y): vector|hyperpage}

`vector` **`operator*`**(`vector x, real y`)
The product of the scalar y and vector x

<!-- matrix; operator*; (vector x, row_vector y); -->
\index{{\tt \bfseries operator\_multiply}!(vector x, row\_vector y): matrix|hyperpage}

`matrix` **`operator*`**(`vector x, row_vector y`)
The product of the vector x and row vector y

<!-- row_vector; operator*; (row_vector x, real y); -->
\index{{\tt \bfseries operator\_multiply}!(row\_vector x, real y): row\_vector|hyperpage}

`row_vector` **`operator*`**(`row_vector x, real y`)
The product of the scalar y and row vector x

<!-- real; operator*; (row_vector x, vector y); -->
\index{{\tt \bfseries operator\_multiply}!(row\_vector x, vector y): real|hyperpage}

`real` **`operator*`**(`row_vector x, vector y`)
The product of the row vector x and vector y

<!-- row_vector; operator*; (row_vector x, matrix y); -->
\index{{\tt \bfseries operator\_multiply}!(row\_vector x, matrix y): row\_vector|hyperpage}

`row_vector` **`operator*`**(`row_vector x, matrix y`)
The product of the row vector x and matrix y

<!-- matrix; operator*; (matrix x, real y); -->
\index{{\tt \bfseries operator\_multiply}!(matrix x, real y): matrix|hyperpage}

`matrix` **`operator*`**(`matrix x, real y`)
The product of the scalar y and matrix x

<!-- vector; operator*; (matrix x, vector y); -->
\index{{\tt \bfseries operator\_multiply}!(matrix x, vector y): vector|hyperpage}

`vector` **`operator*`**(`matrix x, vector y`)
The product of the matrix x and vector y

<!-- matrix; operator*; (matrix x, matrix y); -->
\index{{\tt \bfseries operator\_multiply}!(matrix x, matrix y): matrix|hyperpage}
...
<!-- vector; operator+; (vector x, real y); -->
\index{{\tt \bfseries operator\_add}!(vector x, real y): vector|hyperpage}

`vector` **`operator+`**(`vector x, real y`)
The result of adding y to every entry in the vector x

<!-- vector; operator+; (real x, vector y); -->
\index{{\tt \bfseries operator\_add}!(real x, vector y): vector|hyperpage}

`vector` **`operator+`**(`real x, vector y`)
The result of adding x to every entry in the vector y

<!-- row_vector; operator+; (row_vector x, real y); -->
\index{{\tt \bfseries operator\_add}!(row\_vector x, real y): row\_vector|hyperpage}

`row_vector` **`operator+`**(`row_vector x, real y`)
The result of adding y to every entry in the row vector x

<!-- row_vector; operator+; (real x, row_vector y); -->
\index{{\tt \bfseries operator\_add}!(real x, row\_vector y): row\_vector|hyperpage}

`row_vector` **`operator+`**(`real x, row_vector y`)
The result of adding x to every entry in the row vector y

<!-- matrix; operator+; (matrix x, real y); -->
\index{{\tt \bfseries operator\_add}!(matrix x, real y): matrix|hyperpage}

`matrix` **`operator+`**(`matrix x, real y`)
The result of adding y to every entry in the matrix x

<!-- matrix; operator+; (real x, matrix y); -->
\index{{\tt \bfseries operator\_add}!(real x, matrix y): matrix|hyperpage}

`matrix` **`operator+`**(`real x, matrix y`)
The result of adding x to every entry in the matrix y

<!-- vector; operator-; (vector x, real y); -->
\index{{\tt \bfseries operator\_subtract}!(vector x, real y): vector|hyperpage}

`vector` **`operator-`**(`vector x, real y`)
The result of subtracting y from every entry in the vector x

<!-- vector; operator-; (real x, vector y); -->
\index{{\tt \bfseries operator\_subtract}!(real x, vector y): vector|hyperpage}

`vector` **`operator-`**(`real x, vector y`)
The result of adding x to every entry in the negation of the vector y

<!-- row_vector; operator-; (row_vector x, real y); -->
\index{{\tt \bfseries operator\_subtract}!(row\_vector x, real y): row\_vector|hyperpage}

`row_vector` **`operator-`**(`row_vector x, real y`)
The result of subtracting y from every entry in the row vector x

<!-- row_vector; operator-; (real x, row_vector y); -->
\index{{\tt \bfseries operator\_subtract}!(real x, row\_vector y): row\_vector|hyperpage}
...
<!-- matrix; operator-; (matrix x, real y); -->
\index{{\tt \bfseries operator\_subtract}!(matrix x, real y): matrix|hyperpage}

`matrix` **`operator-`**(`matrix x, real y`)
The result of subtracting y from every entry in the matrix x

<!-- matrix; operator-; (real x, matrix y); -->
\index{{\tt \bfseries operator\_subtract}!(real x, matrix y): matrix|hyperpage}

`matrix` **`operator-`**(`real x, matrix y`)
The result of adding x to every entry in negation of the matrix y

<!-- vector; operator/; (vector x, real y); -->
\index{{\tt \bfseries operator\_divide}!(vector x, real y): vector|hyperpage}

`vector` **`operator/`**(`vector x, real y`)
The result of dividing each entry in the vector x by y

<!-- row_vector; operator/; (row_vector x, real y); -->
\index{{\tt \bfseries operator\_divide}!(row\_vector x, real y): row\_vector|hyperpage}

`row_vector` **`operator/`**(`row_vector x, real y`)
The result of dividing each entry in the row vector x by y

<!-- matrix; operator/; (matrix x, real y); -->
\index{{\tt \bfseries operator\_divide}!(matrix x, real y): matrix|hyperpage}
...
<!-- vector; operator.*; (vector x, vector y); -->
\index{{\tt \bfseries operator\_elt\_multiply}!(vector x, vector y): vector|hyperpage}

`vector` **`operator.*`**(`vector x, vector y`)
The elementwise product of y and x

<!-- row_vector; operator.*; (row_vector x, row_vector y); -->
\index{{\tt \bfseries operator\_elt\_multiply}!(row\_vector x, row\_vector y): row\_vector|hyperpage}

`row_vector` **`operator.*`**(`row_vector x, row_vector y`)
The elementwise product of y and x

<!-- matrix; operator.*; (matrix x, matrix y); -->
\index{{\tt \bfseries operator\_elt\_multiply}!(matrix x, matrix y): matrix|hyperpage}

`matrix` **`operator.*`**(`matrix x, matrix y`)
The elementwise product of y and x

<!-- vector; operator./; (vector x, vector y); -->
\index{{\tt \bfseries operator\_elt\_divide}!(vector x, vector y): vector|hyperpage}

`vector` **`operator./`**(`vector x, vector y`)
The elementwise quotient of y and x

<!-- vector; operator./; (vector x, real y); -->
\index{{\tt \bfseries operator\_elt\_divide}!(vector x, real y): vector|hyperpage}

`vector` **`operator./`**(`vector x, real y`)
The elementwise quotient of y and x

<!-- vector; operator./; (real x, vector y); -->
\index{{\tt \bfseries operator\_elt\_divide}!(real x, vector y): vector|hyperpage}

`vector` **`operator./`**(`real x, vector y`)
The elementwise quotient of y and x

<!-- row_vector; operator./; (row_vector x, row_vector y); -->
\index{{\tt \bfseries operator\_elt\_divide}!(row\_vector x, row\_vector y): row\_vector|hyperpage}

`row_vector` **`operator./`**(`row_vector x, row_vector y`)
The elementwise quotient of y and x

<!-- row_vector; operator./; (row_vector x, real y); -->
\index{{\tt \bfseries operator\_elt\_divide}!(row\_vector x, real y): row\_vector|hyperpage}

`row_vector` **`operator./`**(`row_vector x, real y`)
The elementwise quotient of y and x

<!-- row_vector; operator./; (real x, row_vector y); -->
\index{{\tt \bfseries operator\_elt\_divide}!(real x, row\_vector y): row\_vector|hyperpage}

`row_vector` **`operator./`**(`real x, row_vector y`)
The elementwise quotient of y and x

<!-- matrix; operator./; (matrix x, matrix y); -->
\index{{\tt \bfseries operator\_elt\_divide}!(matrix x, matrix y): matrix|hyperpage}

`matrix` **`operator./`**(`matrix x, matrix y`)
The elementwise quotient of y and x

<!-- matrix; operator./; (matrix x, real y); -->
\index{{\tt \bfseries operator\_elt\_divide}!(matrix x, real y): matrix|hyperpage}

`matrix` **`operator./`**(`matrix x, real y`)
The elementwise quotient of y and x

<!-- matrix; operator./; (real x, matrix y); -->
\index{{\tt \bfseries operator\_elt\_divide}!(real x, matrix y): matrix|hyperpage}
...
<!-- matrix; operator'; (matrix x); -->
\index{{\tt \bfseries operator\_transpose}!(matrix x): matrix|hyperpage}

`matrix` **`operator'`**(`matrix x`)
The transpose of the matrix x, written as `x'`

<!-- row_vector; operator'; (vector x); -->
\index{{\tt \bfseries operator\_transpose}!(vector x): row\_vector|hyperpage}

`row_vector` **`operator'`**(`vector x`)
The transpose of the vector x, written as `x'`

<!-- vector; operator'; (row_vector x); -->
\index{{\tt \bfseries operator\_transpose}!(row\_vector x): vector|hyperpage}
...
\index{{\tt \bfseries dot\_product}!(vector x, vector y): real|hyperpage}

`real` **`dot_product`**(`vector x, vector y`)
 The dot product of x and y

<!-- real; dot_product; (vector x, row_vector y); -->
\index{{\tt \bfseries dot\_product}!(vector x, row\_vector y): real|hyperpage}

`real` **`dot_product`**(`vector x, row_vector y`)
 The dot product of x and y

<!-- real; dot_product; (row_vector x, vector y); -->
\index{{\tt \bfseries dot\_product}!(row\_vector x, vector y): real|hyperpage}

`real` **`dot_product`**(`row_vector x, vector y`)
 The dot product of x and y

<!-- real; dot_product; (row_vector x, row_vector y); -->
\index{{\tt \bfseries dot\_product}!(row\_vector x, row\_vector y): real|hyperpage}

`real` **`dot_product`**(`row_vector x, row_vector y`)
 The dot product of x and y

<!-- row_vector; columns_dot_product; (vector x, vector y); -->
\index{{\tt \bfseries columns\_dot\_product}!(vector x, vector y): row\_vector|hyperpage}

`row_vector` **`columns_dot_product`**(`vector x, vector y`)
 The dot product of the columns of x and y

<!-- row_vector; columns_dot_product; (row_vector x, row_vector y); -->
\index{{\tt \bfseries columns\_dot\_product}!(row\_vector x, row\_vector y): row\_vector|hyperpage}

`row_vector` **`columns_dot_product`**(`row_vector x, row_vector y`)
 The dot product of the columns of x and y

<!-- row_vector; columns_dot_product; (matrix x, matrix y); -->
\index{{\tt \bfseries columns\_dot\_product}!(matrix x, matrix y): row\_vector|hyperpage}

`row_vector` **`columns_dot_product`**(`matrix x, matrix y`)
 The dot product of the columns of x and y

<!-- vector; rows_dot_product; (vector x, vector y); -->
\index{{\tt \bfseries rows\_dot\_product}!(vector x, vector y): vector|hyperpage}

`vector` **`rows_dot_product`**(`vector x, vector y`)
 The dot product of the rows of x and y

<!-- vector; rows_dot_product; (row_vector x, row_vector y); -->
\index{{\tt \bfseries rows\_dot\_product}!(row\_vector x, row\_vector y): vector|hyperpage}

`vector` **`rows_dot_product`**(`row_vector x, row_vector y`)
 The dot product of the rows of x and y

<!-- vector; rows_dot_product; (matrix x, matrix y); -->
\index{{\tt \bfseries rows\_dot\_product}!(matrix x, matrix y): vector|hyperpage}

`vector` **`rows_dot_product`**(`matrix x, matrix y`)
 The dot product of the rows of x and y

<!-- real; dot_self; (vector x); -->
\index{{\tt \bfseries dot\_self}!(vector x): real|hyperpage}

`real` **`dot_self`**(`vector x`)
 The dot product of the vector x with itself

<!-- real; dot_self; (row_vector x); -->
\index{{\tt \bfseries dot\_self}!(row\_vector x): real|hyperpage}

`real` **`dot_self`**(`row_vector x`)
 The dot product of the row vector x with itself

<!-- row_vector; columns_dot_self; (vector x); -->
\index{{\tt \bfseries columns\_dot\_self}!(vector x): row\_vector|hyperpage}

`row_vector` **`columns_dot_self`**(`vector x`)
 The dot product of the columns of x with themselves

<!-- row_vector; columns_dot_self; (row_vector x); -->
\index{{\tt \bfseries columns\_dot\_self}!(row\_vector x): row\_vector|hyperpage}

`row_vector` **`columns_dot_self`**(`row_vector x`)
 The dot product of the columns of x with themselves

<!-- row_vector; columns_dot_self; (matrix x); -->
\index{{\tt \bfseries columns\_dot\_self}!(matrix x): row\_vector|hyperpage}

`row_vector` **`columns_dot_self`**(`matrix x`)
 The dot product of the columns of x with themselves

<!-- vector; rows_dot_self; (vector x); -->
\index{{\tt \bfseries rows\_dot\_self}!(vector x): vector|hyperpage}

`vector` **`rows_dot_self`**(`vector x`)
 The dot product of the rows of x with themselves

<!-- vector; rows_dot_self; (row_vector x); -->
\index{{\tt \bfseries rows\_dot\_self}!(row\_vector x): vector|hyperpage}

`vector` **`rows_dot_self`**(`row_vector x`)
 The dot product of the rows of x with themselves

<!-- vector; rows_dot_self; (matrix x); -->
\index{{\tt \bfseries rows\_dot\_self}!(matrix x): vector|hyperpage}
...
\index{{\tt \bfseries tcrossprod}!(matrix x): matrix|hyperpage}
...
\index{{\tt \bfseries crossprod}!(matrix x): matrix|hyperpage}
...
\index{{\tt \bfseries quad\_form}!(matrix A, matrix B): matrix|hyperpage}

`matrix` **`quad_form`**(`matrix A, matrix B`)
 The quadratic form, i.e., `B' * A * B`.

<!-- real; quad_form; (matrix A, vector B); -->
\index{{\tt \bfseries quad\_form}!(matrix A, vector B): real|hyperpage}

`real` **`quad_form`**(`matrix A, vector B`)
 The quadratic form, i.e., `B' * A * B`.

<!-- matrix; quad_form_diag; (matrix m, vector v); -->
\index{{\tt \bfseries quad\_form\_diag}!(matrix m, vector v): matrix|hyperpage}
...
\index{{\tt \bfseries quad\_form\_diag}!(matrix m, row\_vector rv): matrix|hyperpage}
...
\index{{\tt \bfseries quad\_form\_sym}!(matrix A, matrix B): matrix|hyperpage}
...
\index{{\tt \bfseries quad\_form\_sym}!(matrix A, vector B): real|hyperpage}
...
\index{{\tt \bfseries trace\_quad\_form}!(matrix A, matrix B): real|hyperpage}

`real` **`trace_quad_form`**(`matrix A, matrix B`)
 The trace of the quadratic form, i.e., `trace(B' * A * B)`.

<!-- real; trace_gen_quad_form; (matrix D,matrix A, matrix B); -->
\index{{\tt \bfseries trace\_gen\_quad\_form}!(matrix D,matrix A, matrix B): real|hyperpage}
...
\index{{\tt \bfseries multiply\_lower\_tri\_self\_transpose}!(matrix x): matrix|hyperpage}
...
\index{{\tt \bfseries diag\_pre\_multiply}!(vector v, matrix m): matrix|hyperpage}
...
\index{{\tt \bfseries diag\_pre\_multiply}!(row\_vector rv, matrix m): matrix|hyperpage}
...
\index{{\tt \bfseries diag\_post\_multiply}!(matrix m, vector v): matrix|hyperpage}
...
\index{{\tt \bfseries diag\_post\_multiply}!(matrix m, row\_vector rv): matrix|hyperpage}
...
\index{{\tt \bfseries log\_sum\_exp}!(vector x): real|hyperpage}
...
\index{{\tt \bfseries log\_sum\_exp}!(row\_vector x): real|hyperpage}
...
\index{{\tt \bfseries log\_sum\_exp}!(matrix x): real|hyperpage}
...
<!-- real; min; (vector x); -->
\index{{\tt \bfseries min}!(vector x): real|hyperpage}

`real` **`min`**(`vector x`)
 The minimum value in x, or $+\infty$ if x is empty

<!-- real; min; (row_vector x); -->
\index{{\tt \bfseries min}!(row\_vector x): real|hyperpage}

`real` **`min`**(`row_vector x`)
 The minimum value in x, or $+\infty$ if x is empty

<!-- real; min; (matrix x); -->
\index{{\tt \bfseries min}!(matrix x): real|hyperpage}

`real` **`min`**(`matrix x`)
 The minimum value in x, or $+\infty$ if x is empty

<!-- real; max; (vector x); -->
\index{{\tt \bfseries max}!(vector x): real|hyperpage}

`real` **`max`**(`vector x`)
 The maximum value in x, or $-\infty$ if x is empty

<!-- real; max; (row_vector x); -->
\index{{\tt \bfseries max}!(row\_vector x): real|hyperpage}

`real` **`max`**(`row_vector x`)
 The maximum value in x, or $-\infty$ if x is empty

<!-- real; max; (matrix x); -->
\index{{\tt \bfseries max}!(matrix x): real|hyperpage}
...
<!-- real; sum; (vector x); -->
\index{{\tt \bfseries sum}!(vector x): real|hyperpage}

`real` **`sum`**(`vector x`)
 The sum of the values in x, or 0 if x is empty

<!-- real; sum; (row_vector x); -->
\index{{\tt \bfseries sum}!(row\_vector x): real|hyperpage}

`real` **`sum`**(`row_vector x`)
 The sum of the values in x, or 0 if x is empty

<!-- real; sum; (matrix x); -->
\index{{\tt \bfseries sum}!(matrix x): real|hyperpage}

`real` **`sum`**(`matrix x`)
 The sum of the values in x, or 0 if x is empty

<!-- real; prod; (vector x); -->
\index{{\tt \bfseries prod}!(vector x): real|hyperpage}

`real` **`prod`**(`vector x`)
 The product of the values in x, or 1 if x is empty

<!-- real; prod; (row_vector x); -->
\index{{\tt \bfseries prod}!(row\_vector x): real|hyperpage}

`real` **`prod`**(`row_vector x`)
 The product of the values in x, or 1 if x is empty

<!-- real; prod; (matrix x); -->
\index{{\tt \bfseries prod}!(matrix x): real|hyperpage}
...
<!-- real; mean; (vector x); -->
\index{{\tt \bfseries mean}!(vector x): real|hyperpage}
...
\index{{\tt \bfseries mean}!(row\_vector x): real|hyperpage}
...
<!-- real; mean; (matrix x); -->
\index{{\tt \bfseries mean}!(matrix x): real|hyperpage}
...
\index{{\tt \bfseries variance}!(vector x): real|hyperpage}
...
\index{{\tt \bfseries variance}!(row\_vector x): real|hyperpage}
...
\index{{\tt \bfseries variance}!(matrix x): real|hyperpage}
...
<!-- real; sd; (vector x); -->
\index{{\tt \bfseries sd}!(vector x): real|hyperpage}
...
\index{{\tt \bfseries sd}!(row\_vector x): real|hyperpage}
...
<!-- real; sd; (matrix x); -->
\index{{\tt \bfseries sd}!(matrix x): real|hyperpage}
...
\index{{\tt \bfseries rep\_matrix}!(row\_vector rv, int m): matrix|hyperpage}
...
\index{{\tt \bfseries diagonal}!(matrix x): vector|hyperpage}

`vector` **`diagonal`**(`matrix x`)
The diagonal of the matrix x

<!-- matrix; diag_matrix; (vector x); -->
\index{{\tt \bfseries diag\_matrix}!(vector x): matrix|hyperpage}
...
\index{{\tt \bfseries col}!(matrix x, int n): vector|hyperpage}

`vector` **`col`**(`matrix x, int n`)
The n-th column of matrix x

<!-- row_vector; row; (matrix x, int m); -->
\index{{\tt \bfseries row}!(matrix x, int m): row\_vector|hyperpage}
...
\index{{\tt \bfseries block}!(matrix x, int i, int j, int n\_rows, int n\_cols): matrix|hyperpage}
...
\index{{\tt \bfseries sub\_col}!(matrix x, int i, int j, int n\_rows): vector|hyperpage}
...
\index{{\tt \bfseries sub\_row}!(matrix x, int i, int j, int n\_cols): row\_vector|hyperpage}
...
\index{{\tt \bfseries head}!(vector v, int n): vector|hyperpage}

`vector` **`head`**(`vector v, int n`)
Return the vector consisting of the first n elements of v.

<!-- row_vector; head; (row_vector rv, int n); -->
\index{{\tt \bfseries head}!(row\_vector rv, int n): row\_vector|hyperpage}

`row_vector` **`head`**(`row_vector rv, int n`)
Return the row vector consisting of the first n elements of rv.

<!-- T[]; head; (T[] sv, int n); -->
\index{{\tt \bfseries head}!(T[] sv, int n): T[]|hyperpage}
...
\index{{\tt \bfseries tail}!(vector v, int n): vector|hyperpage}

`vector` **`tail`**(`vector v, int n`)
Return the vector consisting of the last n elements of v.

<!-- row_vector; tail; (row_vector rv, int n); -->
\index{{\tt \bfseries tail}!(row\_vector rv, int n): row\_vector|hyperpage}

`row_vector` **`tail`**(`row_vector rv, int n`)
Return the row vector consisting of the last n elements of rv.

<!-- T[]; tail; (T[] sv, int n); -->
\index{{\tt \bfseries tail}!(T[] sv, int n): T[]|hyperpage}
...
\index{{\tt \bfseries segment}!(vector v, int i, int n): vector|hyperpage}
...
\index{{\tt \bfseries segment}!(row\_vector rv, int i, int n): row\_vector|hyperpage}
...
\index{{\tt \bfseries segment}!(T[] sv, int i, int n): T[]|hyperpage}
...
\index{{\tt \bfseries append\_col}!(matrix x, matrix y): matrix|hyperpage}
...
\index{{\tt \bfseries append\_col}!(matrix x, vector y): matrix|hyperpage}
...
\index{{\tt \bfseries append\_col}!(vector x, matrix y): matrix|hyperpage}
...
\index{{\tt \bfseries append\_col}!(vector x, vector y): matrix|hyperpage}
...
\index{{\tt \bfseries append\_col}!(row\_vector x, row\_vector y): row\_vector|hyperpage}

`row_vector` **`append_col`**(`row_vector x, row_vector y`)
Combine row vectors x and y of any size into another row vector.

<!-- row_vector; append_col; (real x, row_vector y); -->
\index{{\tt \bfseries append\_col}!(real x, row\_vector y): row\_vector|hyperpage}

`row_vector` **`append_col`**(`real x, row_vector y`)
Append x to the front of y, returning another row vector.

<!-- row_vector; append_col; (row_vector x, real y); -->
\index{{\tt \bfseries append\_col}!(row\_vector x, real y): row\_vector|hyperpage}
...
\index{{\tt \bfseries append\_row}!(matrix x, matrix y): matrix|hyperpage}
...
\index{{\tt \bfseries append\_row}!(matrix x, row\_vector y): matrix|hyperpage}
...
\index{{\tt \bfseries append\_row}!(row\_vector x, matrix y): matrix|hyperpage}
...
\index{{\tt \bfseries append\_row}!(row\_vector x, row\_vector y): matrix|hyperpage}
...
\index{{\tt \bfseries append\_row}!(vector x, vector y): vector|hyperpage}

`vector` **`append_row`**(`vector x, vector y`)
Concatenate vectors x and y of any size into another vector.

<!-- vector; append_row; (real x, vector y); -->
\index{{\tt \bfseries append\_row}!(real x, vector y): vector|hyperpage}

`vector` **`append_row`**(`real x, vector y`)
Append x to the top of y, returning another vector.

<!-- vector; append_row; (vector x, real y); -->
\index{{\tt \bfseries append\_row}!(vector x, real y): vector|hyperpage}
...
\index{{\tt \bfseries softmax}!(vector x): vector|hyperpage}

`vector` **`softmax`**(`vector x`)
 The softmax of x

<!-- vector; log_softmax; (vector x); -->
\index{{\tt \bfseries log\_softmax}!(vector x): vector|hyperpage}
...
\index{{\tt \bfseries cumulative\_sum}!(real[] x): real[]|hyperpage}

`real[]` **`cumulative_sum`**(`real[] x`)
 The cumulative sum of x

<!-- vector; cumulative_sum; (vector v); -->
\index{{\tt \bfseries cumulative\_sum}!(vector v): vector|hyperpage}

`vector` **`cumulative_sum`**(`vector v`)
 The cumulative sum of v

<!-- row_vector; cumulative_sum; (row_vector rv); -->
\index{{\tt \bfseries cumulative\_sum}!(row\_vector rv): row\_vector|hyperpage}
...
\index{{\tt \bfseries cov\_exp\_quad}!(row\_vectors x, real alpha, real rho): matrix|hyperpage}

`matrix` **`cov_exp_quad`**(`row_vectors x, real alpha, real rho`)
 The covariance matrix with an exponentiated quadratic kernel of x.

<!-- matrix; cov_exp_quad; (vectors x, real alpha, real rho); -->
\index{{\tt \bfseries cov\_exp\_quad}!(vectors x, real alpha, real rho): matrix|hyperpage}

`matrix` **`cov_exp_quad`**(`vectors x, real alpha, real rho`)
 The covariance matrix with an exponentiated quadratic kernel of x.

<!-- matrix; cov_exp_quad; (real[] x, real alpha, real rho); -->
\index{{\tt \bfseries cov\_exp\_quad}!(real[] x, real alpha, real rho): matrix|hyperpage}

`matrix` **`cov_exp_quad`**(`real[] x, real alpha, real rho`)
 The covariance matrix with an exponentiated quadratic kernel of x.

<!-- matrix; cov_exp_quad; (row_vectors x1, row_vectors x2, real alpha, real rho); -->
\index{{\tt \bfseries cov\_exp\_quad}!(row\_vectors x1, row\_vectors x2, real alpha, real rho): matrix|hyperpage}
...
\index{{\tt \bfseries cov\_exp\_quad}!(vectors x1, vectors x2, real alpha, real rho): matrix|hyperpage}
...
\index{{\tt \bfseries cov\_exp\_quad}!(real[] x1, real[] x2, real alpha, real rho): matrix|hyperpage}
...
\index{{\tt \bfseries operator\_divide}!(row\_vector b, matrix A): row\_vector|hyperpage}

`row_vector` **`operator/`**(`row_vector b, matrix A`)
 The right division of b by A; equivalently `b * inverse(A)`

<!-- matrix; operator/; (matrix B, matrix A); -->
\index{{\tt \bfseries operator\_divide}!(matrix B, matrix A): matrix|hyperpage}

`matrix` **`operator/`**(`matrix B, matrix A`)
 The right division of B by A; equivalently `B * inverse(A)`

<!-- vector; operator\; (matrix A, vector b); -->
\index{{\tt \bfseries operator\_left\_div}!(matrix A, vector b): vector|hyperpage}

`vector` **`operator\`**(`matrix A, vector b`)


<!-- matrix; operator\; (matrix A, matrix B); -->
\index{{\tt \bfseries operator\_left\_div}!(matrix A, matrix B): matrix|hyperpage}
...
\index{{\tt \bfseries mdivide\_left\_tri\_low}!(matrix A, vector b): vector|hyperpage}
...
\index{{\tt \bfseries mdivide\_left\_tri\_low}!(matrix A, matrix B): matrix|hyperpage}
...
\index{{\tt \bfseries mdivide\_right\_tri\_low}!(row\_vector b, matrix A): row\_vector|hyperpage}
...
\index{{\tt \bfseries mdivide\_right\_tri\_low}!(matrix B, matrix A): matrix|hyperpage}
...
\index{{\tt \bfseries mdivide\_left\_spd}!(matrix A, vector b): matrix|hyperpage}
...
\index{{\tt \bfseries mdivide\_left\_spd}!(matrix A, matrix B): vector|hyperpage}
...
\index{{\tt \bfseries mdivide\_right\_spd}!(row\_vector b, matrix A): row\_vector|hyperpage}
...
\index{{\tt \bfseries mdivide\_right\_spd}!(matrix B, matrix A): matrix|hyperpage}
...
\index{{\tt \bfseries matrix\_exp}!(matrix A): matrix|hyperpage}

`matrix` **`matrix_exp`**(`matrix A`)
 The matrix exponential of A

<!-- matrix; matrix_exp_multiply; (matrix A, matrix B); -->
\index{{\tt \bfseries matrix\_exp\_multiply}!(matrix A, matrix B): matrix|hyperpage}
...
\index{{\tt \bfseries scale\_matrix\_exp\_multiply}!(real t, matrix A, matrix B): matrix|hyperpage}
...
<!-- real; trace; (matrix A); -->
\index{{\tt \bfseries trace}!(matrix A): real|hyperpage}
...
\index{{\tt \bfseries determinant}!(matrix A): real|hyperpage}

`real` **`determinant`**(`matrix A`)
 The determinant of A

<!-- real; log_determinant; (matrix A); -->
\index{{\tt \bfseries log\_determinant}!(matrix A): real|hyperpage}
...
\index{{\tt \bfseries inverse}!(matrix A): matrix|hyperpage}

`matrix` **`inverse`**(`matrix A`)
 The inverse of A

<!-- matrix; inverse_spd; (matrix A); -->
\index{{\tt \bfseries inverse\_spd}!(matrix A): matrix|hyperpage}
...
\index{{\tt \bfseries eigenvalues\_sym}!(matrix A): vector|hyperpage}

`vector` **`eigenvalues_sym`**(`matrix A`)
 The vector of eigenvalues of a symmetric matrix A in ascending order

<!-- matrix; eigenvectors_sym; (matrix A); -->
\index{{\tt \bfseries eigenvectors\_sym}!(matrix A): matrix|hyperpage}
...
\index{{\tt \bfseries qr\_thin\_Q}!(matrix A): matrix|hyperpage}
...
\index{{\tt \bfseries qr\_thin\_R}!(matrix A): matrix|hyperpage}
...
\index{{\tt \bfseries qr\_Q}!(matrix A): matrix|hyperpage}
...
\index{{\tt \bfseries qr\_R}!(matrix A): matrix|hyperpage}
...
\index{{\tt \bfseries cholesky\_decompose}!(matrix A): matrix|hyperpage}
...
\index{{\tt \bfseries singular\_values}!(matrix A): vector|hyperpage}
...
\index{{\tt \bfseries sort\_asc}!(vector v): vector|hyperpage}

`vector` **`sort_asc`**(`vector v`)
 Sort the elements of v in ascending order

<!-- row_vector; sort_asc; (row_vector v); -->
\index{{\tt \bfseries sort\_asc}!(row\_vector v): row\_vector|hyperpage}

`row_vector` **`sort_asc`**(`row_vector v`)
 Sort the elements of v in ascending order

<!-- vector; sort_desc; (vector v); -->
\index{{\tt \bfseries sort\_desc}!(vector v): vector|hyperpage}

`vector` **`sort_desc`**(`vector v`)
 Sort the elements of v in descending order

<!-- row_vector; sort_desc; (row_vector v); -->
\index{{\tt \bfseries sort\_desc}!(row\_vector v): row\_vector|hyperpage}

`row_vector` **`sort_desc`**(`row_vector v`)
 Sort the elements of v in descending order

<!-- int[]; sort_indices_asc; (vector v); -->
\index{{\tt \bfseries sort\_indices\_asc}!(vector v): int[]|hyperpage}
...
\index{{\tt \bfseries sort\_indices\_asc}!(row\_vector v): int[]|hyperpage}
...
\index{{\tt \bfseries sort\_indices\_desc}!(vector v): int[]|hyperpage}
...
\index{{\tt \bfseries sort\_indices\_desc}!(row\_vector v): int[]|hyperpage}
...
\index{{\tt \bfseries rank}!(vector v, int s): int|hyperpage}

`int` **`rank`**(`vector v, int s`)
 Number of components of v less than v[s]

<!-- int; rank; (row_vector v, int s); -->
\index{{\tt \bfseries rank}!(row\_vector v, int s): int|hyperpage}
