...
\index{{\tt \bfseries wishart}!(matrix W | real nu, matrix Sigma): real|hyperpage}
...
\index{{\tt \bfseries wishart}!(real nu, matrix Sigma): matrix|hyperpage}
...
\index{{\tt \bfseries inv\_wishart}!(matrix W | real nu, matrix Sigma): real|hyperpage}
...
\index{{\tt \bfseries inv\_wishart}!(real nu, matrix Sigma): matrix|hyperpage}
