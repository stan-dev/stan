...
\index{{\tt \bfseries csr\_extract\_w}!(matrix a): vector|hyperpage}

`vector` **`csr_extract_w`**(`matrix a`)
 Return non-zero values in matrix a; see section \@ref(CSR).

<!-- int[]; csr_extract_v; (matrix a); -->
\index{{\tt \bfseries csr\_extract\_v}!(matrix a): int[]|hyperpage}
...
\index{{\tt \bfseries csr\_extract\_u}!(matrix a): int[]|hyperpage}
...
\index{{\tt \bfseries csr\_to\_dense\_matrix}!(int m, int n, vector w, int[] v, int[] u): matrix|hyperpage}
...
\index{{\tt \bfseries csr\_matrix\_times\_vector}!(int m, int n, vector w, int[] v, int[] u, vector b): vector|hyperpage}
