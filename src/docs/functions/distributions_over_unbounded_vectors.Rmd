...
\index{{\tt \bfseries multi\_normal}!(vectors y | vectors mu, matrix Sigma): real|hyperpage}
...
\index{{\tt \bfseries multi\_normal}!(vectors y | row\_vectors mu, matrix Sigma): real|hyperpage}
...
\index{{\tt \bfseries multi\_normal}!(row\_vectors y | vectors mu, matrix Sigma): real|hyperpage}
...
\index{{\tt \bfseries multi\_normal}!(row\_vectors y | row\_vectors mu, matrix Sigma): real|hyperpage}
...
\index{{\tt \bfseries multi\_normal}!(vector mu, matrix Sigma): vector|hyperpage}
...
\index{{\tt \bfseries multi\_normal}!(row\_vector mu, matrix Sigma): vector|hyperpage}
...
\index{{\tt \bfseries multi\_normal}!(vectors mu, matrix Sigma): vectors|hyperpage}
...
\index{{\tt \bfseries multi\_normal}!(row\_vectors mu, matrix Sigma): vectors|hyperpage}
...
`y` ~ __`multi_normal_prec`__(`mu, Omega`)
...
\index{{\tt \bfseries multi\_normal\_prec}!(vectors y | vectors mu, matrix Omega): real|hyperpage}
...
\index{{\tt \bfseries multi\_normal\_prec}!(vectors y | row\_vectors mu, matrix Omega): real|hyperpage}
...
\index{{\tt \bfseries multi\_normal\_prec}!(row\_vectors y | vectors mu, matrix Omega): real|hyperpage}
...
\index{{\tt \bfseries multi\_normal\_prec}!(row\_vectors y | row\_vectors mu, matrix Omega): real|hyperpage}
...
`y` ~ __`multi_normal_cholesky`__(`mu, L`)
...
\index{{\tt \bfseries multi\_normal\_cholesky}!(vectors y | vectors mu, matrix L): real|hyperpage}
...
\index{{\tt \bfseries multi\_normal\_cholesky}!(vectors y | row\_vectors mu, matrix L): real|hyperpage}
...
\index{{\tt \bfseries multi\_normal\_cholesky}!(row\_vectors y | vectors mu, matrix L): real|hyperpage}
...
\index{{\tt \bfseries multi\_normal\_cholesky}!(row\_vectors y | row\_vectors mu, matrix L): real|hyperpage}
...
\index{{\tt \bfseries multi\_normal\_cholesky}!(vector mu, matrix L): vector|hyperpage}
...
\index{{\tt \bfseries multi\_normal\_cholesky}!(row\_vector mu, matrix L): vector|hyperpage}
...
\index{{\tt \bfseries multi\_normal\_cholesky}!(vectors mu, matrix L): vectors|hyperpage}
...
\index{{\tt \bfseries multi\_normal\_cholesky}!(row\_vectors mu, matrix L): vectors|hyperpage}
...
\index{{\tt \bfseries multi\_gp}!(matrix y | matrix Sigma, vector w): real|hyperpage}
...
\index{{\tt \bfseries multi\_gp\_cholesky}!(matrix y | matrix L, vector w): real|hyperpage}
...
`y` ~ __`multi_student_t`__(`nu, mu, Sigma`)
...
\index{{\tt \bfseries multi\_student\_t}!(vectors y | real nu, vectors mu, matrix Sigma): real|hyperpage}
...
\index{{\tt \bfseries multi\_student\_t}!(vectors y | real nu, row\_vectors mu, matrix Sigma): real|hyperpage}
...
\index{{\tt \bfseries multi\_student\_t}!(row\_vectors y | real nu, vectors mu, matrix Sigma): real|hyperpage}
...
\index{{\tt \bfseries multi\_student\_t}!(row\_vectors y | real nu, row\_vectors mu, matrix Sigma): real|hyperpage}
...
\index{{\tt \bfseries multi\_student\_t}!(real nu, vector mu, matrix Sigma): vector|hyperpage}
...
\index{{\tt \bfseries multi\_student\_t}!(real nu, row\_vector mu, matrix Sigma): vector|hyperpage}
...
\index{{\tt \bfseries multi\_student\_t}!(real nu, vectors mu, matrix Sigma): vectors|hyperpage}
...
\index{{\tt \bfseries multi\_student\_t}!(real nu, row\_vectors mu, matrix Sigma): vectors|hyperpage}
...
`y` ~ __`gaussian_dlm_obs`__(`F, G, V, W, m0, C0`)
...
\index{{\tt \bfseries gaussian\_dlm\_obs}!(matrix y | matrix F, matrix G, matrix V, matrix W, vector m0, matrix C0): real|hyperpage}
...
\index{{\tt \bfseries gaussian\_dlm\_obs}!(matrix y | matrix F, matrix G, vector V, matrix W, vector m0, matrix C0): real|hyperpage}
