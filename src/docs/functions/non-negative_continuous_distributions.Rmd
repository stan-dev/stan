...
\index{{\tt \bfseries rayleigh}!(reals y | reals sigma): real|hyperpage}

`real` **`rayleigh_lpdf`**(`reals y | reals sigma`)
The log of the Rayleigh density of y given scale sigma

<!-- real; rayleigh_cdf; (real y, real sigma); -->
\index{{\tt \bfseries rayleigh}!(real y, real sigma): real|hyperpage}
...
\index{{\tt \bfseries rayleigh}!(reals sigma): R|hyperpage}
...
`y` ~ __`wiener`__(`alpha, tau, beta, delta`)
...
\index{{\tt \bfseries wiener}!(reals y | reals alpha, reals tau, reals beta, reals delta): real|hyperpage}
