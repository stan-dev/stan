...
\index{{\tt \bfseries normal}!(reals y | reals mu, reals sigma): real|hyperpage}
...
\index{{\tt \bfseries normal}!(reals mu, reals sigma): R|hyperpage}
...
\index{{\tt \bfseries std\_normal}!(reals y): real|hyperpage}
...
`y` ~ __`normal_id_glm`__(`x, alpha, beta, sigma`)
...
\index{{\tt \bfseries normal\_id\_glm}!(vector y | matrix x, real alpha, vector beta, real sigma): real|hyperpage}
...
\index{{\tt \bfseries normal\_id\_glm}!(vector y | matrix x, vector alpha, vector beta, real sigma): real|hyperpage}
...
`y` ~ __`exp_mod_normal`__(`mu, sigma, lambda`)
...
\index{{\tt \bfseries exp\_mod\_normal}!(reals y | reals mu, reals sigma, reals lambda): real|hyperpage}
...
\index{{\tt \bfseries exp\_mod\_normal}!(reals mu, reals sigma, reals lambda): R|hyperpage}
...
`y` ~ __`skew_normal`__(`xi, omega, alpha`)
...
\index{{\tt \bfseries skew\_normal}!(reals y | reals xi, reals omega, reals alpha): real|hyperpage}
...
\index{{\tt \bfseries skew\_normal}!(reals xi, reals omega, real alpha): R|hyperpage}
...
\index{{\tt \bfseries student\_t}!(reals y | reals nu, reals mu, reals sigma): real|hyperpage}
...
\index{{\tt \bfseries student\_t}!(reals nu, reals mu, reals sigma): R|hyperpage}
...
\index{{\tt \bfseries cauchy}!(reals y | reals mu, reals sigma): real|hyperpage}
...
\index{{\tt \bfseries cauchy}!(reals mu, reals sigma): R|hyperpage}
...
`y` ~ __`double_exponential`__(`mu, sigma`)
...
\index{{\tt \bfseries double\_exponential}!(reals y | reals mu, reals sigma): real|hyperpage}
...
\index{{\tt \bfseries double\_exponential}!(reals mu, reals sigma): R|hyperpage}
...
\index{{\tt \bfseries logistic}!(reals y | reals mu, reals sigma): real|hyperpage}
...
\index{{\tt \bfseries logistic}!(reals mu, reals sigma): R|hyperpage}
...
\index{{\tt \bfseries gumbel}!(reals y | reals mu, reals beta): real|hyperpage}
...
\index{{\tt \bfseries gumbel}!(reals mu, reals beta): R|hyperpage}
