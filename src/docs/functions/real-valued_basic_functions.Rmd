...
<!-- real; pi; () -->
\index{{\tt \bfseries pi}!(): real|hyperpage}

`real` **`pi`**()
 $\pi$, the ratio of a circle's circumference to its diameter

<!-- real; e; () -->
\index{{\tt \bfseries e}!(): real|hyperpage}

`real` **`e`**()
 $e$, the base of the natural logarithm

<!-- real; sqrt2; () -->
\index{{\tt \bfseries sqrt2}!(): real|hyperpage}

`real` **`sqrt2`**()
 The square root of 2

<!-- real; log2; () -->
\index{{\tt \bfseries log2}!(): real|hyperpage}

`real` **`log2`**()
 The natural logarithm of 2

<!-- real; log10; () -->
\index{{\tt \bfseries log10}!(): real|hyperpage}
...
<!-- real; not_a_number; () -->
\index{{\tt \bfseries not\_a\_number}!(): real|hyperpage}
...
\index{{\tt \bfseries positive\_infinity}!(): real|hyperpage}
...
\index{{\tt \bfseries negative\_infinity}!(): real|hyperpage}
...
\index{{\tt \bfseries machine\_precision}!(): real|hyperpage}
...
<!-- real; target; () -->
\index{{\tt \bfseries target}!(): real|hyperpage}

`real` **`target`**()
 Returns the current value of the log probability accumulator.

<!-- real; get_lp; () -->
\index{{\tt \bfseries get\_lp}!(): real|hyperpage}
...
\index{{\tt \bfseries operator\_logical\_less\_than}!(int x, int y): int|hyperpage}

`int` **`operator<`**(`int x, int y`)


<!-- int; operator<; (real x, real y); -->
\index{{\tt \bfseries operator\_logical\_less\_than}!(real x, real y): int|hyperpage}
...
<!-- int; operator<=; (int x, int y); -->
\index{{\tt \bfseries operator\_logical\_less\_than\_equal}!(int x, int y): int|hyperpage}

`int` **`operator<=`**(`int x, int y`)


<!-- int; operator<=; (real x, real y); -->
\index{{\tt \bfseries operator\_logical\_less\_than\_equal}!(real x, real y): int|hyperpage}
...
<!-- int; operator>; (int x, int y); -->
\index{{\tt \bfseries operator\_logical\_greater\_than}!(int x, int y): int|hyperpage}

`int` **`operator>`**(`int x, int y`)


<!-- int; operator>; (real x, real y); -->
\index{{\tt \bfseries operator\_logical\_greater\_than}!(real x, real y): int|hyperpage}
...
<!-- int; operator>=; (int x, int y); -->
\index{{\tt \bfseries operator\_logical\_greater\_than\_equal}!(int x, int y): int|hyperpage}

`int` **`operator>=`**(`int x, int y`)


<!-- int; operator>=; (real x, real y); -->
\index{{\tt \bfseries operator\_logical\_greater\_than\_equal}!(real x, real y): int|hyperpage}
...
<!-- int; operator==; (int x, int y); -->
\index{{\tt \bfseries operator\_logial\_equal}!(int x, int y): int|hyperpage}

`int` **`operator==`**(`int x, int y`)


<!-- int; operator==; (real x, real y); -->
\index{{\tt \bfseries operator\_logial\_equal}!(real x, real y): int|hyperpage}
...
<!-- int; operator!=; (int x, int y); -->
\index{{\tt \bfseries operator\_logical\_not\_equal}!(int x, int y): int|hyperpage}

`int` **`operator!=`**(`int x, int y`)


<!-- int; operator!=; (real x, real y); -->
\index{{\tt \bfseries operator\_logical\_not\_equal}!(real x, real y): int|hyperpage}
...
<!-- int; operator!; (int x); -->
\index{{\tt \bfseries operator\_negation}!(int x): int|hyperpage}

`int` **`operator!`**(`int x`)


<!-- int; operator!; (real x); -->
\index{{\tt \bfseries operator\_negation}!(real x): int|hyperpage}
...
<!-- int; operator&&; (int x, int y); -->
\index{{\tt \bfseries operator\_logical\_and}!(int x, int y): int|hyperpage}

`int` **`operator&&`**(`int x, int y`)


<!-- int; operator&&; (real x, real y); -->
\index{{\tt \bfseries operator\_logical\_and}!(real x, real y): int|hyperpage}
...
<!-- int; operator||; (int x, int y); -->
\index{{\tt \bfseries operator\_logical\_or}!(int x, int y): int|hyperpage}

`int` **`operator||`**(`int x, int y`)


<!-- int; operator||; (real x, real y); -->
\index{{\tt \bfseries operator\_logical\_or}!(real x, real y): int|hyperpage}
...
<!-- real; step; (real x); -->
\index{{\tt \bfseries step}!(real x): real|hyperpage}
...
<!-- int; is_inf; (real x); -->
\index{{\tt \bfseries is\_inf}!(real x): int|hyperpage}

`int` **`is_inf`**(`real x`)
 Returns 1 if x is infinite (positive or negative) and 0 otherwise. 

<!-- int; is_nan; (real x); -->
\index{{\tt \bfseries is\_nan}!(real x): int|hyperpage}
...
\index{{\tt \bfseries operator\_add}!(real x, real y): real|hyperpage}
...
<!-- real; operator-; (real x, real y); -->
\index{{\tt \bfseries operator\_subtract}!(real x, real y): real|hyperpage}
...
<!-- real; operator*; (real x, real y); -->
\index{{\tt \bfseries operator\_multiply}!(real x, real y): real|hyperpage}
...
<!-- real; operator/; (real x, real y); -->
\index{{\tt \bfseries operator\_divide}!(real x, real y): real|hyperpage}
...
<!-- real; operator^; (real x, real y); -->
\index{{\tt \bfseries operator\_pow}!(real x, real y): real|hyperpage}
...
\index{{\tt \bfseries operator\_subtract}!(real x): real|hyperpage}
...
<!-- real; operator+; (real x); -->
\index{{\tt \bfseries operator\_add}!(real x): real|hyperpage}
...
<!-- R; fabs; (T x); -->
\index{{\tt \bfseries fabs}!(T x): R|hyperpage}

`R` **`fabs`**(`T x`)
absolute value of x

<!-- real; abs; (real x); -->
\index{{\tt \bfseries abs}!(real x): real|hyperpage}
...
<!-- int; abs; (int x); -->
\index{{\tt \bfseries abs}!(int x): int|hyperpage}

`int` **`abs`**(`int x`)
 Returns the absolute value of x, defined by \[ \text{abs}(x) = |x| \]

<!-- real; fdim; (real x, real y); -->
\index{{\tt \bfseries fdim}!(real x, real y): real|hyperpage}
...
\index{{\tt \bfseries fmin}!(real x, real y): real|hyperpage}
...
\index{{\tt \bfseries fmax}!(real x, real y): real|hyperpage}
...
\index{{\tt \bfseries fmod}!(real x, real y): real|hyperpage}
...
<!-- R; floor; (T x); -->
\index{{\tt \bfseries floor}!(T x): R|hyperpage}
...
<!-- R; ceil; (T x); -->
\index{{\tt \bfseries ceil}!(T x): R|hyperpage}
...
<!-- R; round; (T x); -->
\index{{\tt \bfseries round}!(T x): R|hyperpage}
...
<!-- R; trunc; (T x); -->
\index{{\tt \bfseries trunc}!(T x): R|hyperpage}
...
<!-- R; sqrt; (T x); -->
\index{{\tt \bfseries sqrt}!(T x): R|hyperpage}

`R` **`sqrt`**(`T x`)
square root of x

<!-- R; cbrt; (T x); -->
\index{{\tt \bfseries cbrt}!(T x): R|hyperpage}

`R` **`cbrt`**(`T x`)
cube root of x

<!-- R; square; (T x); -->
\index{{\tt \bfseries square}!(T x): R|hyperpage}

`R` **`square`**(`T x`)
square of x

<!-- R; exp; (T x); -->
\index{{\tt \bfseries exp}!(T x): R|hyperpage}

`R` **`exp`**(`T x`)
natural exponential of x

<!-- R; exp2; (T x); -->
\index{{\tt \bfseries exp2}!(T x): R|hyperpage}

`R` **`exp2`**(`T x`)
base-2 exponential of x

<!-- R; log; (T x); -->
\index{{\tt \bfseries log}!(T x): R|hyperpage}

`R` **`log`**(`T x`)
natural logarithm of x

<!-- R; log2; (T x); -->
\index{{\tt \bfseries log2}!(T x): R|hyperpage}

`R` **`log2`**(`T x`)
base-2 logarithm of x

<!-- R; log10; (T x); -->
\index{{\tt \bfseries log10}!(T x): R|hyperpage}

`R` **`log10`**(`T x`)
base-10 logarithm of x

<!-- real; pow; (real x, real y); -->
\index{{\tt \bfseries pow}!(real x, real y): real|hyperpage}

`real` **`pow`**(`real x, real y`)
 Returns x raised to the power of y. \[ \text{pow}(x,y) = x^y \]

<!-- R; inv; (T x); -->
\index{{\tt \bfseries inv}!(T x): R|hyperpage}

`R` **`inv`**(`T x`)
inverse of x

<!-- R; inv_sqrt; (T x); -->
\index{{\tt \bfseries inv\_sqrt}!(T x): R|hyperpage}

`R` **`inv_sqrt`**(`T x`)
inverse of the square root of x

<!-- R; inv_square; (T x); -->
\index{{\tt \bfseries inv\_square}!(T x): R|hyperpage}
...
\index{{\tt \bfseries hypot}!(real x, real y): real|hyperpage}
...
<!-- R; cos; (T x); -->
\index{{\tt \bfseries cos}!(T x): R|hyperpage}

`R` **`cos`**(`T x`)
cosine of the angle x (in radians)

<!-- R; sin; (T x); -->
\index{{\tt \bfseries sin}!(T x): R|hyperpage}

`R` **`sin`**(`T x`)
sine of the angle x (in radians)

<!-- R; tan; (T x); -->
\index{{\tt \bfseries tan}!(T x): R|hyperpage}

`R` **`tan`**(`T x`)
tangent of the angle x (in radians)

<!-- R; acos; (T x); -->
\index{{\tt \bfseries acos}!(T x): R|hyperpage}

`R` **`acos`**(`T x`)
principal arc (inverse) cosine (in radians) of x

<!-- R; asin; (T x); -->
\index{{\tt \bfseries asin}!(T x): R|hyperpage}

`R` **`asin`**(`T x`)
principal arc (inverse) sine (in radians) of x

<!-- R; atan; (T x); -->
\index{{\tt \bfseries atan}!(T x): R|hyperpage}
...
\index{{\tt \bfseries atan2}!(real y, real x): real|hyperpage}
...
<!-- R; cosh; (T x); -->
\index{{\tt \bfseries cosh}!(T x): R|hyperpage}

`R` **`cosh`**(`T x`)
hyperbolic cosine of x (in radians)

<!-- R; sinh; (T x); -->
\index{{\tt \bfseries sinh}!(T x): R|hyperpage}

`R` **`sinh`**(`T x`)
hyperbolic sine of x (in radians)

<!-- R; tanh; (T x); -->
\index{{\tt \bfseries tanh}!(T x): R|hyperpage}

`R` **`tanh`**(`T x`)
hyperbolic tangent of x (in radians)

<!-- R; acosh; (T x); -->
\index{{\tt \bfseries acosh}!(T x): R|hyperpage}

`R` **`acosh`**(`T x`)
inverse hyperbolic cosine (in radians)

<!-- R; asinh; (T x); -->
\index{{\tt \bfseries asinh}!(T x): R|hyperpage}

`R` **`asinh`**(`T x`)
inverse hyperbolic cosine (in radians)

<!-- R; atanh; (T x); -->
\index{{\tt \bfseries atanh}!(T x): R|hyperpage}
...
<!-- R; logit; (T x); -->
\index{{\tt \bfseries logit}!(T x): R|hyperpage}

`R` **`logit`**(`T x`)
log odds, or logit, function applied to x

<!-- R; inv_logit; (T x); -->
\index{{\tt \bfseries inv\_logit}!(T x): R|hyperpage}

`R` **`inv_logit`**(`T x`)
logistic sigmoid function applied to x

<!-- R; inv_cloglog; (T x); -->
\index{{\tt \bfseries inv\_cloglog}!(T x): R|hyperpage}
...
<!-- R; erf; (T x); -->
\index{{\tt \bfseries erf}!(T x): R|hyperpage}

`R` **`erf`**(`T x`)
error function, also known as the Gauss error function, of x

<!-- R; erfc; (T x); -->
\index{{\tt \bfseries erfc}!(T x): R|hyperpage}

`R` **`erfc`**(`T x`)
complementary error function of x

<!-- R; Phi; (T x); -->
\index{{\tt \bfseries Phi}!(T x): R|hyperpage}

`R` **`Phi`**(`T x`)
standard normal cumulative distribution function of x

<!-- R; inv_Phi; (T x); -->
\index{{\tt \bfseries inv\_Phi}!(T x): R|hyperpage}
...
<!-- R; Phi_approx; (T x); -->
\index{{\tt \bfseries Phi\_approx}!(T x): R|hyperpage}
...
\index{{\tt \bfseries binary\_log\_loss}!(int y, real y\_hat): real|hyperpage}
...
\index{{\tt \bfseries owens\_t}!(real h, real a): real|hyperpage}
...
\index{{\tt \bfseries inc\_beta}!(real alpha, real beta, real x): real|hyperpage}
...
\index{{\tt \bfseries lbeta}!(real alpha, real beta): real|hyperpage}
...
<!-- R; tgamma; (T x); -->
\index{{\tt \bfseries tgamma}!(T x): R|hyperpage}
...
<!-- R; lgamma; (T x); -->
\index{{\tt \bfseries lgamma}!(T x): R|hyperpage}

`R` **`lgamma`**(`T x`)
natural logarithm of the gamma function applied to x,

<!-- R; digamma; (T x); -->
\index{{\tt \bfseries digamma}!(T x): R|hyperpage}
...
<!-- R; trigamma; (T x); -->
\index{{\tt \bfseries trigamma}!(T x): R|hyperpage}
...
\index{{\tt \bfseries lmgamma}!(int n, real x): real|hyperpage}
...
\index{{\tt \bfseries gamma\_p}!(real a, real z): real|hyperpage}
...
\index{{\tt \bfseries gamma\_q}!(real a, real z): real|hyperpage}
...
\index{{\tt \bfseries binomial\_coefficient\_log}!(real x, real y): real|hyperpage}
...
\index{{\tt \bfseries choose}!(int x, int y): int|hyperpage}
...
\index{{\tt \bfseries bessel\_first\_kind}!(int v, real x): real|hyperpage}
...
\index{{\tt \bfseries bessel\_second\_kind}!(int v, real x): real|hyperpage}
...
\index{{\tt \bfseries modified\_bessel\_first\_kind}!(int v, real z): real|hyperpage}
...
\index{{\tt \bfseries modified\_bessel\_second\_kind}!(int v, real z): real|hyperpage}
...
\index{{\tt \bfseries falling\_factorial}!(real x, real n): real|hyperpage}
...
\index{{\tt \bfseries lchoose}!(real x, real y): real|hyperpage}
...
\index{{\tt \bfseries log\_falling\_factorial}!(real x, real n): real|hyperpage}
...
\index{{\tt \bfseries rising\_factorial}!(real x, real n): real|hyperpage}
...
\index{{\tt \bfseries log\_rising\_factorial}!(real x, real n): real|hyperpage}
...
<!-- R; expm1; (T x); -->
\index{{\tt \bfseries expm1}!(T x): R|hyperpage}

`R` **`expm1`**(`T x`)
natural exponential of x minus 1

<!-- real; fma; (real x, real y, real z); -->
\index{{\tt \bfseries fma}!(real x, real y, real z): real|hyperpage}
...
\index{{\tt \bfseries multiply\_log}!(real x, real y): real|hyperpage}
...
\index{{\tt \bfseries lmultiply}!(real x, real y): real|hyperpage}
...
<!-- R; log1p; (T x); -->
\index{{\tt \bfseries log1p}!(T x): R|hyperpage}

`R` **`log1p`**(`T x`)
natural logarithm of 1 plus x

<!-- R; log1m; (T x); -->
\index{{\tt \bfseries log1m}!(T x): R|hyperpage}

`R` **`log1m`**(`T x`)
natural logarithm of 1 minus x

<!-- R; log1p_exp; (T x); -->
\index{{\tt \bfseries log1p\_exp}!(T x): R|hyperpage}

`R` **`log1p_exp`**(`T x`)
natural logarithm of one plus the natural exponentiation of x

<!-- R; log1m_exp; (T x); -->
\index{{\tt \bfseries log1m\_exp}!(T x): R|hyperpage}

`R` **`log1m_exp`**(`T x`)
logarithm of one minus the natural exponentiation of x

<!-- real; log_diff_exp; (real x, real y); -->
\index{{\tt \bfseries log\_diff\_exp}!(real x, real y): real|hyperpage}
...
\index{{\tt \bfseries log\_mix}!(real theta, real lp1, real lp2): real|hyperpage}
...
\index{{\tt \bfseries log\_sum\_exp}!(real x, real y): real|hyperpage}
...
<!-- R; log_inv_logit; (T x); -->
\index{{\tt \bfseries log\_inv\_logit}!(T x): R|hyperpage}

`R` **`log_inv_logit`**(`T x`)
natural logarithm of the inverse logit function of x

<!-- R; log1m_inv_logit; (T x); -->
\index{{\tt \bfseries log1m\_inv\_logit}!(T x): R|hyperpage}
