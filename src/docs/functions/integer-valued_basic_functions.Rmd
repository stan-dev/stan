...
\index{{\tt \bfseries operator\_add}!(int x, int y): int|hyperpage}

`int` **`operator+`**(`int x, int y`)
 The sum of the addends x and y \[ \text{operator+}(x,y) = (x + y) \] 

<!-- int; operator-; (int x, int y); -->
\index{{\tt \bfseries operator\_subtract}!(int x, int y): int|hyperpage}
...
<!-- int; operator*; (int x, int y); -->
\index{{\tt \bfseries operator\_multiply}!(int x, int y): int|hyperpage}
...
<!-- int; operator/; (int x, int y); -->
\index{{\tt \bfseries operator\_divide}!(int x, int y): int|hyperpage}
...
<!-- int; operator%; (int x, int y); -->
\index{{\tt \bfseries operator\_mod}!(int x, int y): int|hyperpage}
...
<!-- int; operator-; (int x); -->
\index{{\tt \bfseries operator\_subtract}!(int x): int|hyperpage}

`int` **`operator-`**(`int x`)
 The negation of the subtrahend x \[ \text{operator-}(x) = -x 

<!-- int; operator+; (int x); -->
\index{{\tt \bfseries operator\_add}!(int x): int|hyperpage}
...
<!-- R; abs; (T x); -->
\index{{\tt \bfseries abs}!(T x): R|hyperpage}

`R` **`abs`**(`T x`)
absolute value of x

<!-- int; int_step; (int x); -->
\index{{\tt \bfseries int\_step}!(int x): int|hyperpage}

`int` **`int_step`**(`int x`)


<!-- int; int_step; (real x); -->
\index{{\tt \bfseries int\_step}!(real x): int|hyperpage}
...
<!-- int; min; (int x, int y); -->
\index{{\tt \bfseries min}!(int x, int y): int|hyperpage}
...
<!-- int; max; (int x, int y); -->
\index{{\tt \bfseries max}!(int x, int y): int|hyperpage}
