...
\index{{\tt \bfseries pareto}!(reals y | reals y\_min, reals alpha): real|hyperpage}
...
\index{{\tt \bfseries pareto}!(reals y\_min, reals alpha): R|hyperpage}
...
\index{{\tt \bfseries pareto\_type\_2}!(reals y | reals mu, reals lambda, reals alpha): real|hyperpage}
...
\index{{\tt \bfseries pareto\_type\_2}!(reals mu, reals lambda, reals alpha): R|hyperpage}
