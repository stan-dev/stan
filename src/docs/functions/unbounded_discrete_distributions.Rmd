...
`n` ~ __`neg_binomial`__(`alpha, beta`)
...
\index{{\tt \bfseries neg\_binomial}!(ints n | reals alpha, reals beta): real|hyperpage}
...
\index{{\tt \bfseries neg\_binomial}!(reals alpha, reals beta): R|hyperpage}
...
\index{{\tt \bfseries neg\_binomial\_2}!(ints y | reals mu, reals phi): real|hyperpage}
...
\index{{\tt \bfseries neg\_binomial\_2}!(ints n, reals mu, reals phi): real|hyperpage}
...
\index{{\tt \bfseries neg\_binomial\_2}!(reals mu, reals phi): R|hyperpage}
...
`y` ~ __`neg_binomial_2_log`__(`eta, phi`)
...
\index{{\tt \bfseries neg\_binomial\_2\_log}!(ints y | reals eta, reals phi): real|hyperpage}
...
\index{{\tt \bfseries neg\_binomial\_2\_log}!(reals eta, reals phi): R|hyperpage}
...
`y` ~ __`neg_binomial_2_log_glm`__(`x, alpha, beta, phi`)
...
\index{{\tt \bfseries neg\_binomial\_2\_log\_glm}!(int[] y | matrix x, real alpha, vector beta, real phi): real|hyperpage}
...
\index{{\tt \bfseries neg\_binomial\_2\_log\_glm}!(int[] y | matrix x, vector alpha, vector beta, real phi): real|hyperpage}
...
\index{{\tt \bfseries poisson}!(ints n | reals lambda): real|hyperpage}
...
\index{{\tt \bfseries poisson}!(reals lambda): R|hyperpage}
...
\index{{\tt \bfseries poisson\_log}!(ints n | reals alpha): real|hyperpage}

`real` **`poisson_log_lpmf`**(`ints n | reals alpha`)
The log Poisson probability mass of n given log rate alpha

<!-- R; poisson_log_rng; (reals alpha); -->
\index{{\tt \bfseries poisson\_log}!(reals alpha): R|hyperpage}
...
`y` ~ __`poisson_log_glm`__(`x, alpha, beta`)
...
\index{{\tt \bfseries poisson\_log\_glm}!(int[] y | matrix x, real alpha, vector beta): real|hyperpage}
...
\index{{\tt \bfseries poisson\_log\_glm}!(int[] y | matrix x, vector alpha, vector beta): real|hyperpage}
