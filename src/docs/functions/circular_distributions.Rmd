...
\index{{\tt \bfseries von\_mises}!(reals y | reals mu, reals kappa): R|hyperpage}
...
\index{{\tt \bfseries von\_mises}!(reals mu, reals kappa): R|hyperpage}
