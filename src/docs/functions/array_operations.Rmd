...
<!-- real; min; (real[] x); -->
\index{{\tt \bfseries min}!(real[] x): real|hyperpage}

`real` **`min`**(`real[] x`)
 The minimum value in x, or $+\infty$ if x is size 0.

<!-- int; min; (int[] x); -->
\index{{\tt \bfseries min}!(int[] x): int|hyperpage}

`int` **`min`**(`int[] x`)
 The minimum value in x, or error if x is size 0.

<!-- real; max; (real[] x); -->
\index{{\tt \bfseries max}!(real[] x): real|hyperpage}

`real` **`max`**(`real[] x`)
 The maximum value in x, or $-\infty$ if x is size 0.

<!-- int; max; (int[] x); -->
\index{{\tt \bfseries max}!(int[] x): int|hyperpage}
...
<!-- int; sum; (int[] x); -->
\index{{\tt \bfseries sum}!(int[] x): int|hyperpage}
...
<!-- real; sum; (real[] x); -->
\index{{\tt \bfseries sum}!(real[] x): real|hyperpage}

`real` **`sum`**(`real[] x`)
 The sum of the elements in x; see definition above.

<!-- real; prod; (real[] x); -->
\index{{\tt \bfseries prod}!(real[] x): real|hyperpage}

`real` **`prod`**(`real[] x`)
 The product of the elements in x, or 1 if x is size 0.

<!-- real; prod; (int[] x); -->
\index{{\tt \bfseries prod}!(int[] x): real|hyperpage}
...
\index{{\tt \bfseries log\_sum\_exp}!(real[] x): real|hyperpage}
...
<!-- real; mean; (real[] x); -->
\index{{\tt \bfseries mean}!(real[] x): real|hyperpage}
...
\index{{\tt \bfseries variance}!(real[] x): real|hyperpage}
...
<!-- real; sd; (real[] x); -->
\index{{\tt \bfseries sd}!(real[] x): real|hyperpage}
...
\index{{\tt \bfseries distance}!(vector x, vector y): real|hyperpage}
...
\index{{\tt \bfseries distance}!(vector x, row\_vector y): real|hyperpage}

`real` **`distance`**(`vector x, row_vector y`)
The Euclidean distance between x and y

<!-- real; distance; (row_vector x, vector y); -->
\index{{\tt \bfseries distance}!(row\_vector x, vector y): real|hyperpage}

`real` **`distance`**(`row_vector x, vector y`)
The Euclidean distance between x and y

<!-- real; distance; (row_vector x, row_vector y); -->
\index{{\tt \bfseries distance}!(row\_vector x, row\_vector y): real|hyperpage}

`real` **`distance`**(`row_vector x, row_vector y`)
The Euclidean distance between x and y

<!-- real; squared_distance; (vector x, vector y); -->
\index{{\tt \bfseries squared\_distance}!(vector x, vector y): real|hyperpage}
...
\index{{\tt \bfseries squared\_distance}!(vector x, row\_vector [] y): real|hyperpage}

`real` **`squared_distance`**(`vector x, row_vector [] y`)
The squared Euclidean distance between x and y

<!-- real; squared_distance; (row_vector x, vector [] y); -->
\index{{\tt \bfseries squared\_distance}!(row\_vector x, vector [] y): real|hyperpage}

`real` **`squared_distance`**(`row_vector x, vector [] y`)
The squared Euclidean distance between x and y

<!-- real; squared_distance; (row_vector x, row_vector[] y); -->
\index{{\tt \bfseries squared\_distance}!(row\_vector x, row\_vector[] y): real|hyperpage}
...
<!-- int[]; dims; (T x); -->
\index{{\tt \bfseries dims}!(T x): int[]|hyperpage}
...
\index{{\tt \bfseries num\_elements}!(T[] x): int|hyperpage}
...
<!-- int; size; (T[] x); -->
\index{{\tt \bfseries size}!(T[] x): int|hyperpage}
...
\index{{\tt \bfseries rep\_array}!(T x, int n): T[]|hyperpage}

`T[]` **`rep_array`**(`T x, int n`)
Return the n array with every entry assigned to x.

<!-- T[,]; rep_array; (T x, int m, int n); -->
\index{{\tt \bfseries rep\_array}!(T x, int m, int n): T[,]|hyperpage}

`T[,]` **`rep_array`**(`T x, int m, int n`)
Return the m by n array with every entry assigned to x.

<!-- T[,,]; rep_array; (T x, int k, int m, int n); -->
\index{{\tt \bfseries rep\_array}!(T x, int k, int m, int n): T[,,]|hyperpage}
...
\index{{\tt \bfseries append\_array}!(T x, T y): T|hyperpage}
...
\index{{\tt \bfseries sort\_asc}!(real[] v): real[]|hyperpage}

`real[]` **`sort_asc`**(`real[] v`)
 Sort the elements of v in ascending order

<!-- int[]; sort_asc; (int[] v); -->
\index{{\tt \bfseries sort\_asc}!(int[] v): int[]|hyperpage}

`int[]` **`sort_asc`**(`int[] v`)
 Sort the elements of v in ascending order

<!-- real[]; sort_desc; (real[] v); -->
\index{{\tt \bfseries sort\_desc}!(real[] v): real[]|hyperpage}

`real[]` **`sort_desc`**(`real[] v`)
 Sort the elements of v in descending order

<!-- int[]; sort_desc; (int[] v); -->
\index{{\tt \bfseries sort\_desc}!(int[] v): int[]|hyperpage}

`int[]` **`sort_desc`**(`int[] v`)
 Sort the elements of v in descending order

<!-- int[]; sort_indices_asc; (real[] v); -->
\index{{\tt \bfseries sort\_indices\_asc}!(real[] v): int[]|hyperpage}
...
\index{{\tt \bfseries sort\_indices\_asc}!(int[] v): int[]|hyperpage}
...
\index{{\tt \bfseries sort\_indices\_desc}!(real[] v): int[]|hyperpage}
...
\index{{\tt \bfseries sort\_indices\_desc}!(int[] v): int[]|hyperpage}
...
\index{{\tt \bfseries rank}!(real[] v, int s): int|hyperpage}

`int` **`rank`**(`real[] v, int s`)
 Number of components of v less than v[s]

<!-- int; rank; (int[] v, int s); -->
\index{{\tt \bfseries rank}!(int[] v, int s): int|hyperpage}
