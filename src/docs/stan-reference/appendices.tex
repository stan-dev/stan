...
\item Stan supports general conditional statements using a standard
  if-else syntax.  For example, a zero-inflated (or -deflated)
  Poisson mixture model may be defined using an array of mixture
  component indicators \code{z} as follows.
%
\begin{quote}
\begin{Verbatim}
data {
