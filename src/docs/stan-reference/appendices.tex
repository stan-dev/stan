...
Single-statement blocks can be rendered in one of two ways.  Without
statement-block delineating brackets, they will look as follows.
%
\begin{quote}
\begin{Verbatim} 
for (n in 1:N)
...
\end{quote}
% 
With brackets the rednering is as follows.
%
\begin{quote}
\begin{Verbatim}
for (n in 1:N) {
