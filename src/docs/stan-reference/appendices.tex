...
$I_v(z)$ is the modified Bessel function of the first kind with order \farg{v} applied to \farg{z}.
\[
...
\section{owens\_t}\label{owens-t-appendix.section}
$\mbox{owens\_t}(h,a)$ is the Owen's T
...
\section{tgamma}\label{gamma-appendix.section}
...
\section{trigamma}\label{trigamma-appendix.section}
$\Psi_1(x)$ is the trigamma function.
%
\[
