...
This chapter%
%
\footnote{The content of this chapter is the same as that in the
  command-line getting started section of \url{http://mc-stan.com/}.}
%
is designed to help users get acquainted with the overall
...
\refsection{stanc} for more documentation on the \stanc compiler.
...
found in \refsection{compiling-cpp}.  Installation information for
...
constraining it to continuous values between zero and one inclusive,
