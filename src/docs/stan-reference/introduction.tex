...
The following simple model is availabe in the source
...
are i.i.d.\ with Bernoulli chance-of-success \code{theta}.  There is
an implicit uniform prior on \code{theta} arising from the
constraint in its definition in the \code{parameters} block
