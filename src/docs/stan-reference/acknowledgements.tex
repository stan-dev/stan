...
Thanks to Jeffrey Arnold for submitting multiple code patches and
...
Terrance Savitsky, Dan Stowell, and Dougal Sutherland for submitting
documentation patches.  Thanks to Seth Flaxman for reporting errors in
the documentation.
