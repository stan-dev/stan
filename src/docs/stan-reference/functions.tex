...
The dot product of \farg{x} and \farg{y}}
%
\fitem{vector}{columns\_dot\_product}{vector \farg{x}, vector \farg{y}}{
...
The dot product of the columns of \farg{x} and \farg{y}}
%
\fitem{vector}{columns\_dot\_product}{matrix \farg{x}, matrix \farg{y}}{
The dot product of the columns of \farg{x} and \farg{y}}
%
\fitem{vector}{rows\_dot\_product}{vector \farg{x}, vector \farg{y}}{
The dot product of the rows of \farg{x} and \farg{y}}
%
\fitem{row\_vector}{rows\_dot\_product}{row\_vector \farg{x}, row\_vector \farg{y}}{
The dot product of the rows of \farg{x} and \farg{y}}
%
...
%
\fitem{vector}{columns\_dot\_self}{vector \farg{x}}{
...
%
\fitem{row\_vector}{rows\_dot\_self}{row\_vector \farg{x}}{
The dot product of the rows of \farg{x} with themselves}
%
...
sub-block of a vector or row vector.
