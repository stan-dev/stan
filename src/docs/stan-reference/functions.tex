...
\fitem{T[]}{append\_array}{T[] \farg{x}, T[] \farg{y}}{
  ...
  The base type T can be an integer, a real, a vector, a row\_vector, or a
  matrix. If T is a vector, row\_vector, or a matrix, the dimensions of the
  elements in both input arrays must match.}
\end{description}
%
