...
Convert a column vector to a Nx1 matrix.}
%
\fitem{matrix}{to\_matrix}{row\_vector \farg{v}}{
Convert a row vector to a 1xN matrix.}
%
...
Return the matrix \farg{m} as a column vector in column-major order.}
%
\fitem{vector}{to\_vector}{row\_vector \farg{m}}{
Return the row vector \farg{m} as a column vector in column-major order.}
%
\fitem{vector}{to\_vector}{real[] \farg{a}}{
Convert an one-dimensional array to a column vector.}
%
...
Return the matrix \farg{m} as a row vector in column-major order.}
%
\fitem{row\_vector}{to\_row\_vector}{row\_vector \farg{m}}{
Return the column vector \farg{m} as a row vector in column-major order.}
%
\fitem{row\_vector}{to\_row\_vector}{real[] \farg{a}}{
Convert an one-dimensional array to a row vector.}
%
\fitem{row\_vector}{to\_row\_vector}{int[] \farg{a}}{
Convert an one-dimensional array to a row vector.}
%

\fitem{real[,]}{to\_real}{matrix \farg{m}}{
Convert a matrix to a two dimensional array.}
%
\fitem{real[]}{to\_real}{vector \farg{v}}{
Convert a column vector to an one-dimensional array.}
%
\fitem{real[]}{to\_real}{row\_vector \farg{v}}{
Convert a row vector to an one-dimensional array.}
%
\fitem{real[]}{flatten}{real[...] \farg{a}}{
Convert an array of any size to an one-dimensional array in row-major order.}
%
\fitem{int[]}{flatten}{int[...] \farg{a}}{
Convert an array of any size to an one-dimensional array in row-major order.}
%
\end{description}
