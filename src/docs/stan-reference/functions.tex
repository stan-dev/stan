...
sparse data structures within Stan, see \refchapter{sparse-ragged}.
...
\begin{description}
  \fitem{matrix}{csr\_to\_dense\_matrix}{int \farg{m}, int \farg{n},
    matrix \farg{w}, int \farg{v}, int \farg{u}}{Return dense
    $\mbox{\farg{m}} \times \mbox{\farg{n}}$ matrix with specified
    values \farg{w}, column indices \farg{v}, and row starting indices
    \farg{u}; see \refsection{CSR}.}
\end{description}
