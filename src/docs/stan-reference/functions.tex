...
\begin{description}
  ...
  \fitem{real}{if\_else}{int \farg{cond}, real \farg{x}, real \farg{y}}{
    ...
    Unlike the ternary operator in \Cpp, Stan's \code{if\_else} function 
...
\begin{description}
  ...
  \fitem{real}{operator*}{real \farg{x}, real \farg{y}}{
    ...
    \[
    \mbox{operator*}(x,y) = xy
    \]}
  %
  \fitem{real}{operator/}{real \farg{x}, real \farg{y}}{
    Returns the quotient of \farg{x} and \farg{y}.
    \[
    \mbox{operator/}(x,y) = \frac{x}{y}
    \]}
  %
\end{description}
...
%
  \fitem{real}{abs}{real \farg{x}}{     
    Returns the absolute value of \farg{x}. 
    {\it This function is deprecated and will be removed in the future;
