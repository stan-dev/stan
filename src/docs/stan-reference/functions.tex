...
\begin{description}
  \fitem{matrix}{quad\_form\_diag}{matrix, vector \farg{v}
    \farg{m}}{Scale the square matrix \farg{m}
    using the column vector \farg{v}, i.e.,
    \code{diag\_matrix(\farg{v})~*~\farg{m}~*~diag\_matrix(\farg{v})}.}
%
  \fitem{matrix}{quad\_form\_diag}{matrix, row\_vector \farg{rv}
    \farg{m}}{Scale the square matrix \farg{m}
    using the row vector \farg{rv}, i.e.,
