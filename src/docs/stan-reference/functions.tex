...
\begin{description}
  ...
  %
  \fitemUnaryVec{inv\_logit}{logistic sigmoid function applied to \farg{y}}{
    \[
    \mbox{\code{inv\_logit}}(y) = \frac{1}{1 + \exp(-y)}
    \]}
  %
  \fitemUnaryVec{inv\_cloglog}{inverse of the complementary log-log function  applied to \farg{y}}{
    \[
...
\begin{description}
  ...
  %
  \fitemUnaryVec{real}{lgamma}{natural logarithm of the gamma function
    applied to \farg{x}.}{
    \[
    \mbox{\code{lgamma}}(x) 
    = 
