...
%
\begin{description}
\fitem{int}{operator{!}}{int \farg{x}}{1 if \farg{x} is zero and 0 otherwise}
...
%
\begin{description}
\fitem{int}{operator{!}}{real \farg{x}}{1 if \farg{x} is zero and 0 otherwise}
...
\begin{description}
%
  \fitem{real}{binomial\_logit\_log}{int \farg{n}, int \farg{N}, real
