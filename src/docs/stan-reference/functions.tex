...
\fitem{matrix}{qr\_R}{matrix \farg{A}}{
  The upper trapazoidal matrix in the fat QR decomposition of \farg{A},
...
the upper trapazoidal matrix by $-1$ without changing the product. Thus,
Stan adopts the normalization that the diagonal elements of the upper
trapazoidal matrix are strictly positive and the columns of the 
