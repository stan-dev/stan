...
One case where rounding is reasonable is linear interpolation of
function values.   For
example, consider
%
\begin{quote}
...
\end{quote}
%
In this example, the first derivative for \code{x} with respect to
\code{c} will be reasonable, but the second derivatives will all be
zero.
...
Whenever a conversion implies reduction of dimensionality (like converting a matrix to a vector or a two dimensional array to an one dimensional array), the conversion is proceed in row-major order when the input is an array and in column-major order when the input is a vector, a row vector or a matrix.
...
Convert the column vector \farg{v} to a Nx1 matrix.}
%
\fitem{matrix}{to\_matrix}{row\_vector \farg{v}}{
Convert the row vector \farg{v} to a 1xN matrix.}
%
\fitem{matrix}{to\_matrix}{real[,] \farg{a}}{
Convert the two dimensional array \farg{a} to a matrix.}
%
...
Convert the column vector \farg{v} a a row vector.}
%
...
Convert the matrix \farg{m} to a two dimensional array.}
%
%
%
\fitem{real[]}{to\_array\_1d}{vector \farg{v}}{
Convert the column vector \farg{v} to an one-dimensional array.}
%
\fitem{real[]}{to\_array\_1d}{row\_vector \farg{v}}{
Convert the row vector \farg{v} to an one-dimensional array.}
%
\fitem{real[]}{to\_array\_1d}{matrix \farg{m}}{
Convert the matrix \farg{m} to an one-dimensional array in column-major order.}
%
\fitem{real[]}{to\_array\_1d}{real[...] \farg{a}}{
Convert the array \farg{a} (of any dimension up to 10) to an one-dimensional array in row-major order.}
%
