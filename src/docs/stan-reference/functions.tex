...
%
\begin{description}
\fitem{int}{binomial\_rng}{ints \farg{N}, reals \farg{theta}}{Generate a binomial
...
%
\begin{description}
\fitem{int}{beta\_binomial\_rng}{ints \farg{N}, reals \farg{alpha}, reals \farg{beta}}{Generate a beta-binomial variate with \farg{N} trials, prior success count
...
%
\begin{description}
\fitem{int}{hypergeometric\_rng}{ints \farg{N}, reals \farg{a}, reals \farg{b}}{Generate a hypergeometric variate with \farg{N} trials, total success count of
...
\begin{description}
  \fitem{real}{exp\_mod\_normal\_log}{reals \farg{y}, \\ reals \farg{mu}, reals
    \farg{sigma}, \newline reals \farg{lambda}}{The log of the exponentially modified normal density of \farg{y} given location \farg{mu}, scale \farg{sigma}, and shape \farg{lambda}}
%
