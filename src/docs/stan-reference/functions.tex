...
\fitem{int}{abs}{int \farg{x}}{
  ...
  \[\mbox{abs}(x) = |x|\]}
%
\fitem{int}{int\_step}{int \farg{x}}{\\[-32pt]} 
%
...
\fitemindex{int}{operator!=}{int \farg{x}, int \farg{y}}{1 if \farg{x} is
  not equal to \farg{y} and 0 otherwise.
\[
\mbox{operator!=}(x,y) = 
\begin{cases}
  0 & \mbox{if } x = y\\
...
%
\begin{description}
\fitemindex{int}{operator!}{real \farg{x}}{1 if \farg{x} is zero and 0 otherwise.
\[
\mbox{operator!}(x) = 
\begin{cases}
  0 & \mbox{if } x \neq 0 \\
...
\fitemindex{int}{operator||}{real \farg{x}, real \farg{y}}{1 if \farg{x}
  is unequal to 0 or \farg{y} is unequal to 0.
\[
\mbox{operator||}(x,y) = 
\begin{cases}
  0 & \mbox{if } x,y=0 \\
...
%
\[
\frac{\partial\,\mbox{opreator+}(x,y)}{\partial x} = 
\begin{cases}
...
%
\[
\frac{\partial\,\mbox{opreator+}(x,y)}{\partial y} = 
\begin{cases}
  1 & \mbox{if } -\infty\leq x,y \leq \infty \\[6pt]
  \textrm{NaN} & \mbox{if } x = \textrm{NaN or } y = \textrm{NaN}
\end{cases}
...
\begin{cases}
  \sech^2(x) & \mbox{if } -\infty\leq x\leq \infty \\[6pt]
  \textrm{NaN} & \mbox{if } x = \textrm{NaN}
\end{cases}
\]
}
...
The logistic sigmoid function applied to \farg{y}.
\[
\mbox{inv\_logit}(y) = 
\begin{cases}
...
\]
%
See \refsection{inv-logit-appendix} for definition of 
$\mbox{logit}^{-1}(y)$ and $\frac{\partial\,\mbox{logit}^{-1}(y)}{\partial y}$.
}
%
...
\]
%
See \refsection{inv-cloglog-appendix} for definition of 
$\mbox{cloglog}^{-1}(y)$ and $\frac{\partial\,\mbox{cloglog}^{-1}(y)}{\partial y}$.
}
%
\end{description}
...
\fitem{real}{owens\_t}{real \farg{h}, real \farg{a}}{The Owen's T
  function for the probability of the event $X > h$ and $0<Y<aX$
...
\]
%
See \refsection{owens-t-appendix} for definition of 
$\mbox{owens\_t}(h,a)$, $\frac{\partial\,\mbox{owens\_t}(h,a)}{\partial h}$,
 and $\frac{\partial\,\mbox{owens\_t}(h,a)}{\partial a}$.
}
\end{description}
...
\]
%
See \refsection{gamma-appendix} for definition of 
$\Gamma(x)$ and $\frac{\partial\,\Gamma(x)}{\partial x}$.
}
%
...
\]
%
See \refsection{digamma-appendix} for definition of 
$\Psi(x)$ and $\frac{\partial\,\Psi(x)}{\partial x}$.
}
%
...
\]
%
See \refsection{trigamma-appendix} for definition of 
$\Psi_1(x)$ and $\frac{\partial\,\Psi_1(x)}{\partial x}$.
}
%
...
\]
%
See \refsection{lmgamma-appendix} for definition of 
$\ln\Gamma_n(x)$ and $\frac{\partial\,\ln\Gamma_n(x)}{\partial x}$.
}
%
...
%
\fitem{real}{modified\_bessel\_first\_kind}{int \farg{v}, real \farg{z}}{The modified Bessel function of the first kind with order \farg{v} applied to \farg{z} defined for all \farg{z} and \farg{v}.
\[
...
\]
%
See \refsection{modified-bessel-first-kind-appendix} for definition of 
$I_v(z)$ and $\frac{\partial\,I_v(z)}{\partial z}$.
}
%
\fitem{real}{modified\_bessel\_second\_kind}{int \farg{v}, real \farg{z}}{
The modified Bessel function of the second kind with order \farg{v} applied to \farg{z} defined for  positive \farg{z} and \farg{v}.
\[
...
\]
%
See \refsection{modified-bessel-second-kind-appendix} for definition of 
$K_v(z)$ and $\frac{\partial\,K_v(z)}{\partial z}$.
}
%
