...
%
\fitem{real}{Phi\_approx}{real \farg{x}}{
...
\begin{description}
%
  \fitem{real}{hypergeometric\_log}{ints \farg{n}, ints \farg{N}, ints
    \farg{a}, ints \farg{b}}{The log hypergeometric probability mass of
