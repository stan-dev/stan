...
The falling factorial of \farg{x} with power \farg{n} defined for positive \farg{x} and integers \farg{n} by
\[
...
The rising factorial of \farg{x} with power \farg{n} defined for positive \farg{x} and integers \farg{n} by
\[
