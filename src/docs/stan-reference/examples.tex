...
non-linearity along the $d$-th dimension, rather than ``relevance'' \citep{PiironenVehtari:2016}.
...
put non-negligible mass on both sets of functions. In this case, an inverse gamma
will work well provided it has a left tail that puts negligible mass on
