...
outlined below.  This form of model is straighforward and may be used for
...
measured among inputs ($\rho$). See \refsection{} for more information
...
put non-neglible mass on both sets of functions. In this case, an inverse gamma
will work well provided it has a left tail that puts neglible mass on
...
\begin{align}
  ...
  & x_i^T, \beta_{[1:D]} \in \reals{R}^D,\, x \in \reals^{N \times D}, f \in \
\end{align} 
