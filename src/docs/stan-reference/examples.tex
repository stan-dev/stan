...
\]
%
the joint distribution $p(y, \mu, \sigma, \lambda)$ is exchangelable
...
term inside the integral as a generated quantity.  As with predicitve
liklihood, working in expectation is more statistically efficient than
sampling.
...
could also be written using the conditionlal operator; see
