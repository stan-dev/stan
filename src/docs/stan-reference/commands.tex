...
alpha  16.2     2.0 41.5  1.4  5.2  9.7 17.6  59.2   435     2.3  1.0
beta   10.0     1.1 22.8  0.8  3.3  6.2 11.2  37.5   405     2.1  1.0
...
{Set the output precision, namely the number of digits past the decimal place.}
{default = \code{1}}
%
\cmdarg{autocorr=}{+int}
{Calculates and then displays the autocorrelation of the specified chain at various lags.}
