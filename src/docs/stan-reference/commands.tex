...
\begin{quote}
\begin{Verbatim}[fontshape=sl,fontsize=\small]
> ./model sample output sample=samples.csv diagnostic=diagnostics.csv random seed=1
> ./model sample output diagnostic=diagnostics.csv sample=samples.csv random seed=1
> ./model sample random seed=1 output sample=samples.csv diagnostic=diagnostics.csv 
> ./model sample random seed=1 output diagnostic=diagnostics.csv sample=samples.csv 
\end{Verbatim}
\end{quote}
%
...
\put(50, 370) { \makebox(500, 10)[l]{sample, append\_sample, diagnostic, append\_diagnostic, refresh, save\_warmup} }
%
...
%
        \hiercmdarg{\indentarrow\indentarrow\indentarrow\indentarrow}{stepsize\_jitter}{$$double$$}
          ...
          {Defaults to 0}
%
      \hiershortcmd{\indentarrow\indentarrow\indentarrow}{metro}
...
%
  \hiercmdarg{\indentarrow}{sample}{$$string$$}
...
%
  \hiercmdarg{\indentarrow}{append\_sample}{$$boolean$$}
    ...
    {Defaults to 0}
%
  \hiercmdarg{\indentarrow}{diagnostic}{$$string$$}
