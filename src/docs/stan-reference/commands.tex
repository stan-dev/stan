...
\begin{quote}
\begin{Verbatim}[fontshape=sl,fontsize=\small]
> ./model output sample=samples.csv diagnostic=diagnostics.csv random seed=1
> ./model output diagnostic=diagnostics.csv sample=samples.csv random seed=1
> ./model random seed=1 output sample=samples.csv diagnostic=diagnostics.csv 
> ./model random seed=1 output diagnostic=diagnostics.csv sample=samples.csv 
\end{Verbatim}
\end{quote}
%
