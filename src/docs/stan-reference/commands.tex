...
> ./model output random seed=1
> ./model output random seed=1 sample=samples.csv diagnostic=diagnostics.csv 
> ./model output random seed=1 diagnostic=diagnostics.csv sample=samples.csv 
\end{Verbatim}
\end{quote}
%
