...
Warmup took (1.1, 1.2, 1.1) seconds, 3.4 seconds total
Sampling took (1.2, 1.1, 1.1) seconds, 3.4 seconds total

       mean se_mean   sd 2.5%  25%  50%  75% 97.5% n_eff n_eff/s Rhat
alpha  16.2     2.0 41.5  1.4  5.2  9.7 17.6  59.2   435   127.9  1.0
beta   10.0     1.1 22.8  0.8  3.3  6.2 11.2  37.5   405   119.1  1.0
...
($\alpha=16.2$ and $\beta=10.0$) that are a long way away from the posterior
medians ($\alpha=9.7$ and $\beta=6.2$);  the posterior median is the
...
%
\cmdarg{precision}{+int}
{Sets the mantissa precision, i.e. the number of digits past the decimal place.}
{default = \code{1}}
%
\cmdarg{autocorr=}{+int}
