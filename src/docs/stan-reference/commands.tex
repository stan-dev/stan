...
%
        \hiercmdarg{\indentarrow\indentarrow\indentarrow\indentarrow}{stepsize\_jitter}{$$double$$}
          ...
          {Defaults to 0}
%
      \hierlongcmd{\indentarrow\indentarrow\indentarrow}{metro}
...
%
      \hierlongcmd{\indentarrow\indentarrow\indentarrow}{bfgs}
        ...
        {No subarguments}
%
      \hierlongcmd{\indentarrow\indentarrow\indentarrow}{newton}
        {Newton's method}
        {No subarguments}
%
...
%
  \hiercmdarg{\indentarrow}{refresh}{$$int$$}
    ...
    {Defaults to 100}
%
  \hiercmdarg{\indentarrow}{save\_warmup}{$$boolean$$}
    {Stream warmup samples to output?}
    {Valid values: [0, 1]}
    {Defaults to 0}
%
