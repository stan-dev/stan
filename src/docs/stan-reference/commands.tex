...
\chapter{Print Command for Output Analysis}
...
There is only a single command-line option for \code{print}, namely
\code{--help}, which prints usage information.

In a forthcoming release, there will be controls for the number of
significant digits in the output;  as is, the print errs on the side
of using too few digits.
