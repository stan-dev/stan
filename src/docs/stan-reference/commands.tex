...
%
    \hiercmdarg{\indentarrow\indentarrow}{algorithm}{$$list element$$}
      ...
      {Valid values: \  \code{nesterov, bfgs, lbfgs, newton}}
...
Broyden-Fletcher-Goldfarb-Shanno (BFGS) method and a the
limited-memory version of this algorithm, L-BFGS, is also implemented
(see \citep{NocedalWright:2006} for more information on BFGS and L-BFGS).
