...
\citep{Hoffman-Gelman:2011,Hoffman-Gelman:2014} for details of its use
in \Stan.  For information on run-time configuration of step-size
adaptation, see the interface-specific user's guides for RStan,
PyStan, or CmdStan.  The step sizes per parameter are estimated
during warmup.
