...
\begin{description}
%
\fitem{real}{bernoulli\_lpmf}{ints \farg{y} | reals \farg{theta}}{The
...
\fitem{real}{bernoulli\_cdf}{ints \farg{y}, reals \farg{theta}}{The
  ...
  \farg{theta}}
%
\fitem{real}{bernoulli\_lcdf}{ints \farg{y} | reals \farg{theta}}{The
  log of the Bernoulli cumulative distribution function of \farg{y} given
  chance of success \farg{theta}}
%
\fitem{real}{bernoulli\_lccdf}{ints \farg{y} | reals \farg{theta}}{The
...
\begin{description}
%
\fitem{real}{bernoulli\_logit\_lpmf}{ints \farg{y} | reals \farg{alpha}}{The
  log Bernoulli probability mass of \farg{y} given chance of success
...
\begin{description}
%
  \fitem{real}{binomial\_lpmf}{ints \farg{n} | ints \farg{N}, reals
...
%
  \fitem{real}{binomial\_cdf}{ints \farg{n}, ints \farg{N}, reals
    ...
    successes in \farg{N} trials given chance of success \farg{theta}}
%
  \fitem{real}{binomial\_lcdf}{ints \farg{n} | ints \farg{N}, reals
...
%
  \fitem{real}{binomial\_lccdf}{ints \farg{n} | ints \farg{N}, reals
...
\begin{description}
%
  \fitem{real}{binomial\_logit\_lpmf}{ints \farg{n} | ints \farg{N}, reals
...
\begin{description}
%
\fitem{real}{beta\_binomial\_lpmf}{ints \farg{n} | ints \farg{N}, reals
...
\fitem{real}{beta\_binomial\_cdf}{ints \farg{n}, ints \farg{N}, reals
  ...
  \farg{beta}}
%
\fitem{real}{beta\_binomial\_lcdf}{ints \farg{n} | ints \farg{N}, reals
  ...
  \farg{beta}}
%
\fitem{real}{beta\_binomial\_lccdf}{ints \farg{n} | ints \farg{N}, reals
...
\begin{description}
%
  \fitem{real}{hypergeometric\_lpmf}{int \farg{n} | int \farg{N}, int
...
\begin{description}
  \fitem{real}{categorical\_lpmf}{ints \farg{y} | vector
...
%
\fitem{real}{categorical\_logit\_lpmf}{ints \farg{y} | vector
...
\begin{description}
  \fitem{real}{ordered\_logistic\_lpmf}{int \farg{k} | real \farg{eta},
...
\begin{description}
%
 \fitem{real}{neg\_binomial\_lpmf}{ints \farg{n} | reals
...
%
 \fitem{real}{neg\_binomial\_lcdf}{ints \farg{n} | reals
   \farg{alpha}, reals \farg{beta}}{The log of the negative binomial cumulative
   distribution function
   of \farg{n} given shape \farg{alpha} and inverse scale \farg{beta}}
%
 \fitem{real}{neg\_binomial\_lccdf}{ints \farg{n} | reals
...
\begin{description}
%
 \fitem{real}{neg\_binomial\_2\_lpmf}{ints \farg{y} | reals
...
%
 \fitem{real}{neg\_binomial\_2\_lcdf}{ints \farg{n} | reals
   \farg{mu}, reals \farg{phi}}{The log of the negative binomial
   cumulative distribution function of \farg{n}
   given location \farg{mu} and precision  \farg{phi}.}
%
 \fitem{real}{neg\_binomial\_2\_lccdf}{ints \farg{n} | reals
   \farg{mu}, reals \farg{phi}}{The log of the negative binomial
   complementary cumulative distribution function of \farg{n}
   given location \farg{mu} and precision \farg{phi}.}
%
...
\begin{description}
%
  \fitem{real}{neg\_binomial\_2\_log\_lpmf}{ints \farg{y} | reals
...
\begin{description}
\fitem{real}{poisson\_lpmf}{ints \farg{n} | reals \farg{lambda}}{The
...
%
\fitem{real}{poisson\_lcdf}{ints \farg{n} | reals \farg{lambda}}{The log of the
  Poisson cumulative distribution function of \farg{n} given rate \farg{lambda}}
%
\fitem{real}{poisson\_lccdf}{ints \farg{n} | reals \farg{lambda}}{The log of the
...
\begin{description}
\fitem{real}{poisson\_log\_lpmf}{ints \farg{n} | reals \farg{alpha}}{The
...
\begin{description}
 \fitem{real}{multinomial\_lpmf}{int[] \farg{y} | vector
...
\begin{description}
  \fitem{real}{normal\_lpdf}{reals \farg{y} | reals \farg{mu}, reals
...
%
\fitem{real}{normal\_lcdf}{reals \farg{y} | reals \farg{mu}, reals
...
%
\fitem{real}{normal\_lccdf}{reals \farg{y} | reals \farg{mu} | reals
...
\section{Normal Distribution on Sufficient Statistics}\label{normal-ss-distribution.section}

\subsubsection{Probability Density Function}

If $\mu \in \reals$ and $\sigma \in \posreals$, then for $\bar{y} \in
\reals, s^2 \in
\posreals$ and $n \in \mathbb{N}^{+}$,
\[
\distro{Normal}(\bar{y}, s^2, n|\mu,\sigma)
=
\sigma^{-n-2}
\exp\left( - \, \frac{1}{2\sigma^2}
           \left[s^2 + n(\bar{y} - \mu)^2 \right]
    \right)
\!.
\]

Where $\bar{y} = \frac{1}{n} \sum\limits_{i=1}^n y_i, s^2 = \sum\limits_{i=1}^n (\bar{y} -y_i)^2$, $y_i$ are the observed random variables and $n$ is the number of observed random variables.

\pitem{y bar}{normal\_sufficient}{s squared, n, mu, sigma}

\subsubsection{Stan Functions}

\begin{description}
  \fitem{real}{normal\_sufficient\_log}{reals \farg{y bar}, reals \farg{s squared}, ints \farg{n}, reals \farg{mu}, reals
    \farg{sigma}}{The log of the normal density of given the mean of the observed random variables \farg{y bar}, the sum of the squared deviations \farg{s squared}, the number of observed random variables \farg{n},
   the location parameter \farg{mu} and the scale parameter \farg{sigma}}
\end{description}
...
\begin{description}
  \fitemtwolines{real}{exp\_mod\_normal\_lpdf}{reals \farg{y} | reals
...
%
  \fitemtwolines{real}{exp\_mod\_normal\_lcdf}{reals \farg{y} | reals \farg{mu},
    reals \farg{sigma}}{reals \farg{lambda}}{The log of the
    exponentially modified normal cumulative distribution function of \farg{y}
    given location \farg{mu}, scale \farg{sigma}, and shape \farg{lambda}}
%
  \fitemtwolines{real}{exp\_mod\_normal\_lccdf}{reals \farg{y} | reals \farg{mu},
    reals \farg{sigma}}{reals \farg{lambda}}{The log of the
...
\begin{description}
  \fitem{real}{skew\_normal\_lpdf}{reals \farg{y} | reals \farg{mu}, reals
...
%
\fitemtwolines{real}{skew\_normal\_lcdf}{reals \farg{y} | reals \farg{mu}, reals
  \farg{sigma}}{reals \farg{alpha}}{The log of the skew normal cumulative
  distribution function of \farg{y} given location \farg{mu}, scale
  \farg{sigma}, and shape \farg{alpha}}
%
\fitemtwolines{real}{skew\_normal\_lccdf}{reals \farg{y} | reals \farg{mu}, reals
...
\begin{description}
  \fitem{real}{student\_t\_lpdf}{reals \farg{y} | reals \farg{nu}, reals
...
%
  \fitem{real}{student\_t\_cdf}{reals \farg{y}, reals \farg{nu}, reals
    ...
    \farg{sigma}}
%
  \fitem{real}{student\_t\_lcdf}{reals \farg{y} | reals \farg{nu}, reals
    \farg{mu}, reals \farg{sigma}}{The log of the Student-$t$ cumulative
    distribution function of \farg{y}
    given degrees of freedom \farg{nu}, location \farg{mu}, and scale
    \farg{sigma}}
%
  \fitem{real}{student\_t\_lccdf}{reals \farg{y} | reals \farg{nu}, reals
...
\begin{description}
%
\fitem{real}{cauchy\_lpdf}{reals \farg{y} | reals \farg{mu}, reals
...
\fitem{real}{cauchy\_cdf}{reals \farg{y}, reals \farg{mu}, reals
 \farg{sigma}}{ The Cauchy cumulative distribution function of \farg{y} given
  location \farg{mu} and scale \farg{sigma}}
%
\fitem{real}{cauchy\_lcdf}{reals \farg{y} | reals \farg{mu}, reals
 \farg{sigma}}{ The log of the Cauchy cumulative distribution function
	of \farg{y} given location \farg{mu} and scale \farg{sigma}}
%
\fitem{real}{cauchy\_lccdf}{reals \farg{y} | reals \farg{mu}, reals
...
\begin{description}
\fitem{real}{double\_exponential\_lpdf}{reals \farg{y} | reals \farg{mu},
...
function of \farg{y} given location \farg{mu} and scale \farg{sigma}}
%
\fitem{real}{double\_exponential\_lcdf}{reals \farg{y} | reals \farg{mu},
reals \farg{sigma}}{ The log of the double exponential cumulative distribution
function of \farg{y} given location \farg{mu} and scale \farg{sigma}}
%
\fitem{real}{double\_exponential\_lccdf}{reals \farg{y} | reals \farg{mu},
...
\begin{description}
\fitem{real}{logistic\_lpdf}{reals \farg{y} | reals \farg{mu},
...
%
\fitem{real}{logistic\_lcdf}{reals \farg{y} | reals \farg{mu},
  reals \farg{sigma}}{ The log of the logistic cumulative distribution
  function of \farg{y} given location \farg{mu} and scale \farg{sigma}}
%
\fitem{real}{logistic\_lccdf}{reals \farg{y} | reals \farg{mu},
...
\begin{description}
  \fitem{real}{gumbel\_lpdf}{reals \farg{y} | reals \farg{mu}, reals
...
%
\fitem{real}{gumbel\_lcdf}{reals \farg{y} | reals \farg{mu}, reals
  \farg{beta}}{The log of the gumbel cumulative distribution function of \farg{y}
  given location \farg{mu} and scale \farg{beta}}
%
\fitem{real}{gumbel\_lccdf}{reals \farg{y} | reals \farg{mu}, reals
...
\begin{description}
 \fitem{real}{lognormal\_lpdf}{reals \farg{y} | reals \farg{mu}, reals
...
%
\fitem{real}{lognormal\_lcdf}{reals \farg{y} | reals \farg{mu}, reals
  \farg{sigma}}{The log of the lognormal cumulative distribution fucntion
   of \farg{y} given location \farg{mu} and scale \farg{sigma}}
%
\fitem{real}{lognormal\_lccdf}{reals \farg{y} | reals \farg{mu}, reals
...
\begin{description}
\fitem{real}{chi\_square\_lpdf}{reals \farg{y} | reals \farg{nu}}{The
...
\fitem{real}{chi\_square\_cdf}{reals \farg{y}, reals \farg{nu}}{The
   ...
   of freedom \farg{nu}}
%
\fitem{real}{chi\_square\_lcdf}{reals \farg{y} | reals \farg{nu}}{The
   log of the Chi-square cumulative distribution function of
   \farg{y} given degrees of freedom \farg{nu}}
%
\fitem{real}{chi\_square\_lccdf}{reals \farg{y} | reals \farg{nu}}{The
...
\begin{description}
\fitem{real}{inv\_chi\_square\_lpdf}{reals \farg{y} | reals
...
\fitem{real}{inv\_chi\_square\_cdf}{reals \farg{y}, reals
  ...
  \farg{y} given degrees of freedom \farg{nu}}
%
\fitem{real}{inv\_chi\_square\_lcdf}{reals \farg{y} | reals
  \farg{nu}}{The log of the inverse Chi-squared cumulative distribution
   function of \farg{y} given degrees of freedom \farg{nu}}
%
\fitem{real}{inv\_chi\_square\_lccdf}{reals \farg{y} | reals
...
\begin{description}
  \fitem{real}{scaled\_inv\_chi\_square\_lpdf}{reals \farg{y} | reals
...
\begin{description}
  \fitem{real}{scaled\_inv\_chi\_square\_cdf}{reals \farg{y}, reals
    ...
    \farg{sigma}}
%
  \fitem{real}{scaled\_inv\_chi\_square\_lcdf}{reals \farg{y} | reals
    \farg{nu}, reals \farg{sigma}}{The log of the scaled inverse Chi-square
    cumulative distribution function
    of \farg{y} given degrees of freedom \farg{nu} and scale
    \farg{sigma}}
%
  \fitem{real}{scaled\_inv\_chi\_square\_lccdf}{reals \farg{y} | reals
    \farg{nu}, reals \farg{sigma}}{The log of the scaled inverse Chi-square
...
\begin{description}
  \fitem{real}{exponential\_lpdf}{reals \farg{y} | reals \farg{beta}}{The
...
\fitem{real}{exponential\_cdf}{reals \farg{y}, reals \farg{beta}}{The
  ...
  \farg{beta}}
%
\fitem{real}{exponential\_lcdf}{reals \farg{y} | reals \farg{beta}}{The
  log of the exponential cumulative distribution function of \farg{y} given
  inverse scale \farg{beta}}
%
\fitem{real}{exponential\_lccdf}{reals \farg{y} | reals \farg{beta}}{The
...
\begin{description}
 \fitem{real}{gamma\_lpdf}{reals \farg{y} | reals \farg{alpha}, reals
...
%
 \fitem{real}{gamma\_cdf}{reals \farg{y}, reals \farg{alpha}, reals
   ...
   \farg{alpha} and inverse scale \farg{beta}}
%
 \fitem{real}{gamma\_lcdf}{reals \farg{y} | reals \farg{alpha}, reals
   \farg{beta}}{The log of the cumulative gamma distribution function of \farg{y} given shape
   \farg{alpha} and inverse scale \farg{beta}}
%
 \fitem{real}{gamma\_lccdf}{reals \farg{y} | reals \farg{alpha}, reals
...
\begin{description}
\fitem{real}{inv\_gamma\_lpdf}{reals \farg{y} | reals \farg{alpha}, reals
...
%
\fitem{real}{inv\_gamma\_lcdf}{reals \farg{y} | reals \farg{alpha}, reals
...
%
\fitem{real}{inv\_gamma\_lccdf}{reals \farg{y} | reals \farg{alpha}, reals
...
\begin{description}
\fitem{real}{weibull\_lpdf}{reals \farg{y} | reals \farg{alpha}, reals
...
%
\fitem{real}{weibull\_lcdf}{reals \farg{y} | reals \farg{alpha}, reals
  \farg{sigma}}{The log of the Weibull cumulative distribution function of
  \farg{y} given shape \farg{alpha} and scale \farg{sigma}}
%
\fitem{real}{weibull\_lccdf}{reals \farg{y} | reals \farg{alpha}, reals
...
\begin{description}
\fitem{real}{frechet\_lpdf}{reals \farg{y} | reals \farg{alpha}, reals
...
\fitem{real}{frechet\_cdf}{reals \farg{y}, reals \farg{alpha}, reals
  ...
  shape \farg{alpha} and scale \farg{sigma}}
%
\fitem{real}{frechet\_lcdf}{reals \farg{y} | reals \farg{alpha}, reals
  \farg{sigma}}{The log of the Fr\'{e}chet cumulative distribution function of
  \farg{y} given shape \farg{alpha} and scale \farg{sigma}}
%
\fitem{real}{frechet\_lccdf}{reals \farg{y} | reals \farg{alpha}, reals
...
\subsubsection{Stan Functions}
\begin{description}
\fitem{real}{rayleigh\_lpdf}{reals \farg{y} | reals \farg{sigma}}{The log of the Rayleigh
...
%
\fitem{real}{rayleigh\_lcdf}{real \farg{y} | real \farg{sigma}}{The log of the
 Rayleigh cumulative distribution of \farg{y} given scale \farg{sigma}}
%
\fitem{real}{rayleigh\_lccdf}{real \farg{y} | real
...
\subsubsection{Stan Functions}
\begin{description}
\fitemtwolines{real}{wiener\_lpdf}{reals \farg{y} | reals \farg{alpha},
...
\begin{description}
  \fitem{real}{pareto\_lpdf}{reals \farg{y} | reals \farg{y\_min}, reals
...
%
  \fitem{real}{pareto\_cdf}{reals \farg{y}, reals \farg{y\_min}, reals
    ...
    positive minimum value \farg{y\_min} and shape \farg{alpha}}
%
  \fitem{real}{pareto\_lcdf}{reals \farg{y} | reals \farg{y\_min}, reals
...
%
  \fitem{real}{pareto\_lccdf}{reals \farg{y} | reals \farg{y\_min}, reals
...
\begin{description}
  \fitemtwolines{real}{pareto\_type\_2\_lpdf}{reals \farg{y} | reals \farg{mu}, reals \farg{lambda}}{reals
...
%
  \fitemtwolines{real}{pareto\_type\_2\_cdf}{reals \farg{y}, reals \farg{mu}, reals \farg{lambda}}{reals
    ...
    location \farg{mu}, scale \farg{lambda}, and shape \farg{alpha}}
%
  \fitemtwolines{real}{pareto\_type\_2\_lcdf}{reals \farg{y} | reals \farg{mu}, reals \farg{lambda}}{reals
    \farg{alpha}}{The log of the Pareto Type 2 cumulative distribution function of \farg{y} given
    location \farg{mu}, scale \farg{lambda}, and shape \farg{alpha}}
%
  \fitemtwolines{real}{pareto\_type\_2\_lccdf}{reals \farg{y} | reals \farg{mu}, reals \farg{lambda}}{reals
...
\begin{description}
%
  \fitem{real}{beta\_lpdf}{reals \farg{theta} | reals \farg{alpha}, reals
...
%
  \fitem{real}{beta\_cdf}{reals \farg{theta}, reals \farg{alpha}, reals
    ...
    \farg{alpha} and prior failures (plus one) \farg{beta}}
%
  \fitem{real}{beta\_lcdf}{reals \farg{theta} | reals \farg{alpha}, reals
    ...
    \farg{alpha} and prior failures (plus one) \farg{beta}}
%
  \fitem{real}{beta\_lccdf}{reals \farg{theta} | reals \farg{alpha}, reals
...
\begin{description}
  \fitem{real}{von\_mises\_lpdf}{reals \farg{y} | reals \farg{mu}, reals
...
\begin{description}
\fitem{real}{uniform\_lpdf}{reals \farg{y} | reals \farg{alpha}, reals
...
%
\fitem{real}{uniform\_lcdf}{reals \farg{y} | reals \farg{alpha}, reals
...
%
\fitem{real}{uniform\_lccdf}{reals \farg{y} | reals \farg{alpha}, reals
...
\begin{description}
%
  \fitem{real}{multi\_normal\_lpdf}{vectors \farg{y} | vectors
...
%
  \fitem{real}{multi\_normal\_lpdf}{vectors \farg{y} | row\_vectors
    \farg{mu}, matrix \farg{Sigma}}{The log of the multivariate normal
    density of vector(s) \farg{y} given location row vector(s)
    \farg{mu} and covariance matrix \farg{Sigma}}
%
  \fitem{real}{multi\_normal\_lpdf}{row\_vectors \farg{y} | vectors
    \farg{mu}, matrix \farg{Sigma}}{The log of the multivariate normal
    density of row vector(s) \farg{y} given location vector(s)
    \farg{mu} and covariance matrix \farg{Sigma}}
%
  \fitem{real}{multi\_normal\_lpdf}{row\_vectors \farg{y} | row\_vectors
    \farg{mu}, matrix \farg{Sigma}}{The log of the multivariate normal
...
\begin{description}
%
\fitemtwolines{real}{multi\_normal\_prec\_lpdf}{vectors \farg{y} | vectors
  ...
  matrix \farg{Omega}}
%
\fitemtwolines{real}{multi\_normal\_prec\_lpdf}{vectors \farg{y} | row\_vectors
  \farg{mu}}{matrix \farg{Omega}}{The log of the multivariate normal density of vector(s)
  \farg{y} given location row vector(s) \farg{mu} and positive definite precision
  matrix \farg{Omega}}
%
\fitemtwolines{real}{multi\_normal\_prec\_lpdf}{row\_vectors \farg{y} | vectors
  \farg{mu}}{matrix \farg{Omega}}{The log of the multivariate normal density of row vector(s)
  \farg{y} given location vector(s) \farg{mu} and positive definite precision
  matrix \farg{Omega}}
%
\fitemtwolines{real}{multi\_normal\_prec\_lpdf}{row\_vectors \farg{y} | row\_vectors
  \farg{mu}}{matrix \farg{Omega}}{The log of the multivariate normal density of row vector(s)
  \farg{y} given location row vector(s) \farg{mu} and positive definite precision
  matrix \farg{Omega}}
%
...
\begin{description}
%
\fitemtwolines{real}{multi\_normal\_cholesky\_lpdf}{vectors \farg{y} | vectors
...
%
\fitemtwolines{real}{multi\_normal\_cholesky\_lpdf}{vectors \farg{y} | row\_vectors
  \farg{mu}}{matrix \farg{L}}{The log of the multivariate normal density of vector(s)
  \farg{y} given location row vector(s) \farg{mu} and lower-triangular Cholesky
  factor of the covariance matrix \farg{L}}
%
\fitemtwolines{real}{multi\_normal\_cholesky\_lpdf}{row\_vectors \farg{y} | vectors
  \farg{mu}}{matrix \farg{L}}{The log of the multivariate normal density of row vector(s)
  \farg{y} given location vector(s) \farg{mu} and lower-triangular Cholesky
  factor of the covariance matrix \farg{L}}
%
\fitemtwolines{real}{multi\_normal\_cholesky\_lpdf}{row\_vectors \farg{y} | row\_vectors
  \farg{mu}}{matrix \farg{L}}{The log of the multivariate normal density of row vector(s)
  \farg{y} given location row vector(s) \farg{mu} and lower-triangular Cholesky
  factor of the covariance matrix \farg{L}}
%
...
\begin{description}
%
\fitem{real}{multi\_gp\_lpdf}{matrix \farg{y} | matrix \farg{Sigma},
...
\begin{description}
%
\fitem{real}{multi\_gp\_cholesky\_lpdf}{matrix \farg{y} | matrix \farg{L},
  vector \farg{w}}{The log of the multivariate GP density of matrix
...
\begin{description}
%
\fitemtwolines{real}{multi\_student\_t\_lpdf}{vectors \farg{y} | real \farg{nu},
...
%
\fitemtwolines{real}{multi\_student\_t\_lpdf}{row\_vectors \farg{y} | real \farg{nu},
  vectors \farg{mu}}{matrix \farg{Sigma}}{The log of the multivariate Student-$t$
...
\begin{description}
%
\fitemtwolines{real}{gaussian\_dlm\_obs\_lpdf}{matrix \farg{y} | matrix \farg{F},
...
\begin{description}
  \fitem{real}{dirichlet\_lpdf}{vector \farg{theta} | vector
...
\begin{description}
%
  \fitem{real}{lkj\_corr\_lpdf}{matrix \farg{y} | real
...
\begin{description}
%
  \fitem{real}{lkj\_corr\_cholesky\_lpdf}{matrix \farg{L} | real
...
\begin{description}
%
\fitem{real}{wishart\_lpdf}{matrix \farg{W} | real \farg{nu}, matrix
...
\begin{description}
%
\fitem{real}{inv\_wishart\_lpdf}{matrix \farg{W} | real \farg{nu}, matrix
