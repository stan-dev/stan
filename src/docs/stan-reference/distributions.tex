...
\ref{vectorization-prng.subsection} for more details.
...
\subsection{Evaluating Vectorized PRNG Functions}\label{vectorization-prng.subsection}

Some PRNG functions accept vector arguments.  Such functions are
indicated by the plural pseudo-types \code{reals} or \code{ints}.  As
in the vectorized arguments subsections of
Section~\ref{prob-vectorization.section}, the pseudo type \code{reals}
may be filled with a real, an int, a one-dimensional array of real or
int, a vector, or a row-vector.  Similarly, \code{ints} may be filled
with an int or a one-dimensional array.  Note that \code{reals} is a
superset of \code{ints}, here.  Hence, all combinations of
\code{reals} and \code{ints} are allowed in the case that a function
has two or more arguments.  For instance, the following is allowed in a
generated quantities block.
...
The result of a vectorized PRNG function depends on the dimensions of
the arguments.  If there are any non-scalar arguments, the return type
is an array matching the dimension of any of the non-scalar arguments,
as all non-scalar arguments must have matching dimension.  If all
arguments are scalars, then the return type is a scalar.
...
%
\begin{description}
\fitem{real}{normal\_rng}{reals \farg{mu},  reals \farg{sigma}}{Generate a normal
...
%
\begin{description}
\fitem{real}{exp\_mod\_normal\_rng}{reals \farg{mu}, reals \farg{sigma},
reals \farg{lambda}}{Generate a exponentially modified normal variate
...
%
\begin{description}
\fitem{real}{skew\_normal\_rng}{reals \farg{xi}, reals \farg{omega},
  real \farg{alpha}}{Generate a skew normal variate with location
  \farg{xi}, scale \farg{omega}, and shape \farg{alpha}; may only be used in
  generated quantities block}
\end{description}
...
%
\begin{description}
\fitem{real}{student\_t\_rng}{reals \farg{nu}, reals \farg{mu}, reals
...
%
\begin{description}
\fitem{real}{cauchy\_rng}{reals \farg{mu}, reals \farg{sigma}}{Generate a Cauchy
  variate with location \farg{mu} and scale \farg{sigma}; may only be used in
  generated quantities block}
\end{description}
...
%
\begin{description}
\fitem{real}{double\_exponential\_rng}{reals \farg{mu}, reals
...
%
\begin{description}
\fitem{real}{logistic\_rng}{reals \farg{mu}, reals
...
%
\begin{description}
\fitem{real}{gumbel\_rng}{reals \farg{mu}, reals
...
%
\begin{description}
\fitem{real}{lognormal\_rng}{reals \farg{mu}, reals
...
%
\begin{description}
\fitem{real}{chi\_square\_rng}{reals \farg{nu}}{Generate a Chi-square
...
%
\begin{description}
\fitem{real}{inv\_chi\_square\_rng}{reals \farg{nu}}{Generate an
...
%
\begin{description}
\fitem{real}{scaled\_inv\_chi\_square\_rng}{reals \farg{nu}, reals
...
%
\begin{description}
\fitem{real}{exponential\_rng}{reals \farg{beta}}{Generate an
...
%
\begin{description}
\fitem{real}{gamma\_rng}{reals \farg{alpha}, reals
...
%
\begin{description}
\fitem{real}{inv\_gamma\_rng}{reals \farg{alpha}, reals
...
%
\begin{description}
\fitem{real}{weibull\_rng}{reals \farg{alpha}, reals
...
%
\begin{description}
\fitem{real}{frechet\_rng}{reals \farg{alpha}, reals
...
%
\begin{description}
\fitem{real}{rayleigh\_rng}{reals
...
%
\begin{description}
\fitem{real}{pareto\_rng}{reals \farg{y\_min}, reals
...
%
\begin{description}
\fitem{real}{pareto\_type\_2\_rng}{reals \farg{mu}, reals \farg{lambda}, reals
...
%
\begin{description}
\fitem{real}{beta\_rng}{reals \farg{alpha}, reals
