...
Stan provides a parameterization of the LKJ correlation matrix
densities directly in terms of their Cholesky factors.  For example, 
if \code{L} is a matrix parameter, then
%
\begin{quote}
\begin{Verbatim}
...
would then require Jacobian adjustments.}
%
