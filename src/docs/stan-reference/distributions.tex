...
distribution using the location and inverse dispersion as a
...
\nats$,
\[
\distro{NegativeBinomial2}(y|\eta,\phi)
 =
\binom{y + \phi - 1}{y}
\,
...
%
\fitem{int}{neg\_binomial\_2\_rng}{real \farg{eta}, real \farg{phi}}{Generate a
