...
\pitem{y}{neg\_binomial\_2\_lpmf}{eta, phi}
...
\subsubsection{Stan Functions}
\begin{description}
\fitem{real}{wiener\_lpdf}{reals \farg{y}, reals \farg{alpha},
...
\begin{description}
  \fitem{real}{pareto\_type\_2\_lpdf}{reals \farg{y}, reals \farg{mu}, reals \farg{lambda}, reals
...
%
  \fitem{real}{pareto\_type\_2\_cdf}{reals \farg{y}, reals \farg{mu}, reals \farg{lambda}, reals
    ...
    location \farg{mu}, scale \farg{lambda}, and shape \farg{alpha}}
%
  \fitem{real}{pareto\_type\_2\_lcdf}{reals \farg{y}, reals \farg{mu}, reals \farg{lambda}, reals
    \farg{alpha}}{The log of the Pareto Type 2 cumulative distribution function of \farg{y} given
    location \farg{mu}, scale \farg{lambda}, and shape \farg{alpha}}
%
  \fitem{real}{pareto\_type\_2\_lccdf}{reals \farg{y}, reals \farg{mu}, reals \farg{lambda}, reals
...
\begin{description}
%
\fitem{real}{multi\_normal\_prec\_lpdf}{vectors \farg{y}, vectors
  ...
  matrix \farg{Omega}}
%
\fitem{real}{multi\_normal\_prec\_lpdf}{vectors \farg{y}, row\_vectors
  \farg{mu}, matrix \farg{Omega}}{The log of the multivariate normal density of vector(s)
  \farg{y} given location row vector(s) \farg{mu} and positive definite precision
  matrix \farg{Omega}}
%
\fitem{real}{multi\_normal\_prec\_lpdf}{row\_vectors \farg{y}, vectors
  \farg{mu}, matrix \farg{Omega}}{The log of the multivariate normal density of row vector(s)
  \farg{y} given location vector(s) \farg{mu} and positive definite precision
  matrix \farg{Omega}}
%
\fitem{real}{multi\_normal\_prec\_lpdf}{row\_vectors \farg{y}, row\_vectors
  \farg{mu}, matrix \farg{Omega}}{The log of the multivariate normal density of row vector(s)
  \farg{y} given location row vector(s) \farg{mu} and positive definite precision
  matrix \farg{Omega}}
%
...
\begin{description}
%
\fitem{real}{multi\_normal\_cholesky\_lpdf}{vectors \farg{y}, vectors
...
%
\fitem{real}{multi\_normal\_cholesky\_lpdf}{vectors \farg{y}, row\_vectors
  \farg{mu}, matrix \farg{L}}{The log of the multivariate normal density of vector(s)
  \farg{y} given location row vector(s) \farg{mu} and lower-triangular Cholesky
  factor of the covariance matrix \farg{L}}
%
\fitem{real}{multi\_normal\_cholesky\_lpdf}{row\_vectors \farg{y}, vectors
  \farg{mu}, matrix \farg{L}}{The log of the multivariate normal density of row vector(s)
  \farg{y} given location vector(s) \farg{mu} and lower-triangular Cholesky
  factor of the covariance matrix \farg{L}}
%
\fitem{real}{multi\_normal\_cholesky\_lpdf}{row\_vectors \farg{y}, row\_vectors
  \farg{mu}, matrix \farg{L}}{The log of the multivariate normal density of row vector(s)
  \farg{y} given location row vector(s) \farg{mu} and lower-triangular Cholesky
  factor of the covariance matrix \farg{L}}
%
...
\begin{description}
%
\fitem{real}{multi\_student\_t\_lpdf}{vectors \farg{y}, real \farg{nu},
...
%
\fitem{real}{multi\_student\_t\_lpdf}{row\_vectors \farg{y}, real \farg{nu},
  vectors \farg{mu}, matrix \farg{Sigma}}{The log of the multivariate Student-$t$
