...
\pitem{n}{beta\_binomial}{N,alpha}
...
\fitem{real}{gaussian\_dlm\_obs\_log}{vector \farg{y}, matrix \farg{F},
  matrix \farg{G}, matrix \farg{V}, \\ \hspace*{132pt} matrix \farg{W}, vector
  \farg{m0}, matrix \farg{C0}\vspace*{8pt}} {The log of the density of the
...
%
\fitem{real}{gaussian\_dlm\_obs\_log}{vector \farg{y}, matrix \farg{F},
  matrix \farg{G}, vector \farg{V}, \\ \hspace*{132pt} matrix \farg{W}, vector \farg{m0},
  matrix \farg{C0}\vspace*{8pt}} {The log of the density of the Gaussian Dynamic
