...
matrix and vector types are not declared with their sizes.  For
...
on a one-dimensional array to produce a two-dimensional array might be
declared as follows.
%
\begin{quote}
\begin{Verbatim}
