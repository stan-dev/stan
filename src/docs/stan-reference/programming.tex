...
parameters \code{theta}, and data \code{x} and \code{x\_int}.  It
...
\begin{figure}
\begin{center}
\includegraphics[height=2in]{programs/ode/sho/sho-trajectory.pdf}%
\end{center}
\vspace*{-0.25in}
...
parameters uses the \code{solve\_ode} function in the model block
