...
Hyperparameter fitting may be added to this model in the same way as
for the simulation model.  The hyperparameters for the covariance
function are declared as additional parameters and the definition of
the covariance matrix \code{Sigma} is moved from teh transformed data
block to a local variable block in the model.
