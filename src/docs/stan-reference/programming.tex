\part{Example Models and Programming Techniques}\label{programming-techniques.part}
...
\end{itemize}
%
For a discussion of stiff ODE sytems, see \refsection{stiff-ode}.  In
...
\section{Multiple Indexing and Range Indexing}
...
\subsection{Slicing with Range Indexes}
...
\subsubsection{Lower and Upper Bound Indexes}
...
\subsubsection{Lower or Upper Bound Indexes}
...
\subsubsection{Full Range Indexes}
...
\subsection{Multiple Indexing on the Left of Assignments}
...
\subsubsection{Assign-by-Value and Aliasing}
...
\subsection{Multiple Indexes with Vectors and Matrices}
...
\subsubsection{Matrices with One Multiple Index}
...
\subsubsection{Arrays of Vectors or Matrices}
...
\subsection{Matrices with Parameters and Constants}
