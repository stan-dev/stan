...
Even if the lower bound is a paramter rather than data, there is no
...
It's also possible implement the transform by directly trnasforming
...
Suppowe there are lower and upper bounds that vary by parameter.
