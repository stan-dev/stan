...
\\ {\footnotesize chief of staff, chief of marketing, chief of
  ...
  expectation propagation,  posterior analysis, R}
\item Bob Carpenter \ (Columbia University) \\ {\footnotesize language
    ...
    maintenance, fundraising, support, training, \Cpp}
...
\\ {\footnotesize RStan, modeling, \Cpp, Rcpp, R}
...
\\ {\footnotesize PyStan, \Cpp, Python}
...
\\ {\footnotesize Stan.jl, parsing, \Cpp, Julia}
...
\\ {\footnotesize RStan, ShinyStan, R, multilevel modeling, training}
