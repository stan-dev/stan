...
data {
  ...
  real(0,) sigma_mu;      // config. unmodeled param
}
transformed data {
  real(0,) alpha;         // const. unmodeled param
  real(0,) beta;          // const. unmodeled param
  alpha <- 0.1;       
  beta <- 0.1;
} 
parameters {
...
transformed parameters {
  real(0,) sigma_y;       // derived quantity (param)
...
truncation ::= 'T' (int_range | real_range)
