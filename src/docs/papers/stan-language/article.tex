...
Hamiltonian Monte Carlo, see \citep{Duane:1987, Neal:1994, Neal:2011}; for more information
on the no-U-turn sampler used by default in \proglang{Stan}, see
\citep{HoffmanGelman:2011}.
...
exponentials \\ 
\code{log\_falling\_factorial} & falling factorial (Pochhamer) \\
\code{log\_inv\_logit} &  natural logarithm of the logistic sigmoid \\ 
\code{log\_rising\_factorial} & falling factorial (Pochhamer) \\
