...
range 0--127 as in Unicode, as shown in the [identifier characters table](#identifier-characters-table).

**Identifier Characters Table.** <a id="identifier-characters-table"></a>
*The alpanumeric characters and underscore in base ASCII are the only legal characters in Stan identifiers.*
...
then `(y - mu)' * Sigma * (y - mu)` is a well-formed expression of type `real`.  The type of the
...
**Higher-order Functions Table.** <a id="higher-order-functions-table"></a>
