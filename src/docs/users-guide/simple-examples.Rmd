```{r simple-ex-1, include=FALSE, cache=FALSE}
...
```{r simple-ex-8, echo=FALSE, results=FALSE}
r <- (1.68/2)/12
R <- (4.25/2)/12
...
```{r simple-ex-15, echo=FALSE, results=FALSE}
J <- 40
...
```{r simple-ex-20, echo=FALSE, results=FALSE}
J <- 40
K <- 100
N <- J*K
...
```{r simple-ex-23, echo=FALSE, results=FALSE}
...
```{r simple-ex-30, echo=FALSE, warnings=FALSE, results=FALSE}
...
```{r simple-ex-33, echo=FALSE, warnings=FALSE, results=FALSE}
b <- 0
fit_1_noprior <- stan("stan/worldcup_first_try_noprior.stan",
                      data=c(data_worldcup, "b"))
```
```{r simple-ex-34, echo=FALSE}
...
```{r simple-ex-35,  echo=FALSE, warnings=FALSE, results=FALSE}
fit_1_rep <- stan("stan/worldcup_with_replication.stan", data=data_worldcup)
```
```{r simple-ex-36,  echo=FALSE}
...
```{r simple-ex-41,  echo=FALSE, warnings=FALSE, results=FALSE}
fit_3 <- stan("stan/worldcup_no_sqrt.stan", data=data_worldcup)
```
```{r simple-ex-42,  echo=FALSE}
...
```{r simple-ex-53,  echo=FALSE, results=FALSE}
...
```{r simple-ex-64,  echo=FALSE, warnings=FALSE, results=FALSE}
data_1 <- list(N=N, x=x, y=y)
fit_1 <- stan("stan/exponential.stan", data=data_1)
```
```{r simple-ex-65,  echo=FALSE}
print(fit_1)
```
...
```{r simple-ex-66,  echo=FALSE, warnings=FALSE, results=FALSE}
fit_1b <- stan("stan/exponential_positive.stan", data=data_1)
```
```{r simple-ex-67,  echo=FALSE}
print(fit_1b)
```
...
```{r simple-ex-69,  echo=FALSE, warnings=FALSE, results=FALSE}
data_2 <- list(N=N, x=x, y=y)
fit_2 <- stan("stan/exponential.stan", data=data_2)
```
```{r simple-ex-70,  echo=FALSE}
print(fit_2)
```

Then we fit the constrained model:

```{r simple-ex-71,  echo=FALSE, warnings=FALSE, results=FALSE}
fit_2b <- stan("stan/exponential_positive.stan", data=data_2)
```
```{r simple-ex-72,  echo=FALSE}
print(fit_2b)
```
...
```{r simple-ex-80,  echo=FALSE, warnings=FALSE, results=FALSE}
data_1 <- list(N=N, x=x, y=y)
fit_1 <- stan("stan/sum_of_exponentials.stan", data=data_1)
```
```{r simple-ex-81,  echo=FALSE}
print(fit_1)
```
...
```{r simple-ex-83,  echo=FALSE, warnings=FALSE, results=FALSE}
fit_2 <- stan("stan/sum_of_exponentials.stan", data=data_2)
```
```{r simple-ex-84,  echo=FALSE}
print(fit_2)
```
...
```{r simple-ex-87,  echo=FALSE, warnings=FALSE, results=FALSE}
fit_2_with_priors <- stan("stan/sum_of_exponentials_with_priors.stan", data=data_2)
```
```{r simple-ex-88,  echo=FALSE}
