...
transformed data variables.  There are no restrictions on the initial guess
\code{y\_guess} and the parameters \code{theta};
they can reference either data or parameter variables.
