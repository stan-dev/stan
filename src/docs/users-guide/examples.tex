...
\chapter{Computing 1D Integrals}

\noindent
Definite and indefinite 1D integrals can be performed in Stan via the \code{integrate\_1d} function.
...
\code{theta}, on the other hand, must only involve parameters.
...
%
The integral is performed with the iterative 1D quadrature methods implemented in the Boost library. If the nth estimate of the integral is denoted $I_n$ and the nth estimate of the norm of the integral is denoted $|I|_n$, the iteration is terminated when
