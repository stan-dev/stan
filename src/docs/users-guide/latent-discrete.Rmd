...
![log probability of change point being in year, calculated analytically]{img/change-point-posterior.pdf}
![frequency of change point draws in the
posterior generated using draws of change points]{img/s-discrete-posterior.pdf}
id:change-point-posterior.figure

The firts plot is on the log scale and the second plot on the linear
scale; note the narrower range of years in the right-hand plot
