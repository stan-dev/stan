...
![The two intercept parameterization leads to an
  improper prior with a ridge extending infinitely to the northwest
  and southeast.](img/non-identified.png)
![Adding a standard normal prior for the
  intercepts results in a proper posterior.](img/non-identified-plus-prior.png)
![The single
  intercept parameterization with no prior also has a proper posterior.](img/one-param-identified.png)
