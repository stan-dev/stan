...
TEST(log1m,AgradFvarVar_1stderiv) {
  using stan::agrad::fvar;
...
TEST(log1m,AgradFvarVar_2ndderiv) {
  using stan::agrad::fvar;
  using stan::agrad::var;
  using stan::math::log1m;
...
TEST(log1m,AgradFvarFvarDouble) {
  using stan::agrad::fvar;
  using stan::math::log1m;
...
TEST(log1m,AgradFvarFvarVar_1stderiv) {
  using stan::agrad::fvar;
  using stan::agrad::var;
  using stan::math::log1m;
...
TEST(log1m,AgradFvarFvarVar_2ndderiv) {
  using stan::agrad::fvar;
  using stan::agrad::var;
  using stan::math::log1m;
