...
//   EXPECT_FLOAT_EQ(std::numeric_limits<stan::agrad::fvar<double> >::min_exponent, 
// 		  -1021);
...
//   EXPECT_FLOAT_EQ(std::numeric_limits<stan::agrad::fvar<double> >::max_exponent, 
// 		  1024);
//   EXPECT_FLOAT_EQ(std::numeric_limits<stan::agrad::fvar<int> >::max_exponent, 
// 		  0);

//   EXPECT_FLOAT_EQ(std::numeric_limits<stan::agrad::fvar<double> >::max_exponent10,
// 		  308);
//   EXPECT_FLOAT_EQ(std::numeric_limits<stan::agrad::fvar<int> >::max_exponent10, 
// 		  0);

//   EXPECT_FLOAT_EQ(std::numeric_limits<stan::agrad::fvar<double> >::has_infinity, 
// 		  1);
//   EXPECT_FLOAT_EQ(std::numeric_limits<stan::agrad::fvar<int> >::has_infinity, 0);

//   EXPECT_FLOAT_EQ(std::numeric_limits<stan::agrad::fvar<double> >::has_quiet_NaN,
// 		  1);
...
//   EXPECT_FLOAT_EQ(std::numeric_limits<stan::agrad::fvar<int> >::has_signaling_NaN,
// 		  0);
...
//   fvar<double> l = std::numeric_limits<stan::agrad::fvar<double> >::quiet_NaN();
//   EXPECT_FLOAT_EQ(k.val_, 0);
//   isnan(l.val_);

//   fvar<int> m = std::numeric_limits<stan::agrad::fvar<int> >::signaling_NaN();
//   fvar<double> n = std::numeric_limits<stan::agrad::fvar<double> >::signaling_NaN();
//   EXPECT_FLOAT_EQ(m.val_, 0);
//   isnan(n.val_);

//   fvar<int> o = std::numeric_limits<stan::agrad::fvar<int> >::denorm_min();
//   fvar<double> p = std::numeric_limits<stan::agrad::fvar<double> >::denorm_min();
...
//   EXPECT_FLOAT_EQ(std::numeric_limits<stan::agrad::fvar<int> >::tinyness_before, 
// 		  0);
