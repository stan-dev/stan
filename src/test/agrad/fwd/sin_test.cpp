...
TEST(Agrad_Fwd_Sin, FvarVar_2ndDeriv) {
  using stan::agrad::fvar;
...
TEST(Agrad_Fwd_Sin, FvarFvarDouble) {
  using stan::agrad::fvar;
  using std::sin;
  using std::cos;
...
TEST(Agrad_Fwd_Sin, FvarFvarVar_1stDeriv) {
  using stan::agrad::fvar;
  using stan::agrad::var;
  using std::sin;
  using std::cos;
...
TEST(Agrad_Fwd_Sin, FvarFvarVar_2ndDeriv) {
  using stan::agrad::fvar;
  using stan::agrad::var;
  using std::sin;
  using std::cos;
