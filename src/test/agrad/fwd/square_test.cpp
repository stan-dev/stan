...
TEST(Agrad_Fwd_Square, FvarVar_1stDeriv) {
  using stan::agrad::fvar;
...
TEST(Agrad_Fwd_Square, FvarVar_2ndDeriv) {
  using stan::agrad::fvar;
  using stan::agrad::var;
  using stan::math::square;
...
TEST(Agrad_Fwd_Square, FvarFvarDouble) {
  using stan::agrad::fvar;
  using stan::math::square;
...
TEST(Agrad_Fwd_Square, FvarFvarVar_1stDeriv) {
  using stan::agrad::fvar;
  using stan::agrad::var;
  using stan::math::square;
...
TEST(Agrad_Fwd_Square, FvarFvarVar_2ndDeriv) {
  using stan::agrad::fvar;
  using stan::agrad::var;
  using stan::math::square;
