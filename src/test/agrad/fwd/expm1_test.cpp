...
TEST(expm1,AgradFvarVar_1stderiv) {
  using stan::agrad::fvar;
...
TEST(expm1,AgradFvarVar_2ndderiv) {
  using stan::agrad::fvar;
  using stan::agrad::var;
  using boost::math::expm1;
  using std::exp;
...
TEST(expm1,AgradFvarFvarDouble) {
  using stan::agrad::fvar;
  using boost::math::expm1;
  using std::exp;
...
TEST(expm1,AgradFvarFvarVar_1stderiv) {
  using stan::agrad::fvar;
  using stan::agrad::var;
  using boost::math::expm1;
  using std::exp;
...
TEST(expm1,AgradFvarFvarVar_2ndderiv) {
  using stan::agrad::fvar;
  using stan::agrad::var;
  using boost::math::expm1;
  using std::exp;
