...
TEST(log2,AgradFvarVar_1stderiv) {
  using stan::agrad::fvar;
...
TEST(log2,AgradFvarVar_2ndderiv) {
  using stan::agrad::fvar;
  using stan::agrad::var;
  using std::log;
...
TEST(log2,AgradFvarFvarVar_1stderiv) {
  using stan::agrad::fvar;
  using stan::agrad::var;
  using std::log;
...
TEST(log2,AgradFvarFvarVar_2ndderiv) {
  using stan::agrad::fvar;
  using stan::agrad::var;
  using std::log;
