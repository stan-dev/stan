...
TEST(atan,AgradFvarVar_1stderiv) {
  using stan::agrad::fvar;
...
TEST(atan,AgradFvarVar_2ndderiv) {
  using stan::agrad::fvar;
  using stan::agrad::var;
  using std::atan;
...
TEST(atan,AgradFvarFvarVar_1stderiv) {
  using stan::agrad::fvar;
  using stan::agrad::var;
  using std::atan;
...
TEST(atan,AgradFvarFvarVar_2ndderiv) {
  using stan::agrad::fvar;
  using stan::agrad::var;
  using std::atan;
