...
TEST(AgradRev,fdim_vv_defaultpolicy) {
  AVAR a = 3.0;
  AVAR b = 4.0;
  AVAR f = fdim(a,b);
...
TEST(AgradRev,fdim_vv_2_defaultpolicy) {
  AVAR a = 7.0;
  AVAR b = 2.0;
  AVAR f = fdim(a,b);
  EXPECT_FLOAT_EQ(5.0,f.val());
...
TEST(AgradRev,fdim_vd_defaultpolicy) {
  AVAR a = 3.0;
  double b = 4.0;
  AVAR f = fdim(a,b);
  EXPECT_FLOAT_EQ(0.0,f.val());
...
TEST(AgradRev,fdim_vd_2_defaultpolicy) {
  AVAR a = 7.0;
  double b = 2.0;
  AVAR f = fdim(a,b);
  EXPECT_FLOAT_EQ(5.0,f.val());
...
TEST(AgradRev,fdim_dv_defaultpolicy) {
  double a = 3.0;
  AVAR b = 4.0;
  AVAR f = fdim(a,b);
  EXPECT_FLOAT_EQ(0.0,f.val());
...
TEST(AgradRev,fdim_dv_2_defaultpolicy) {
  double a = 7.0;
  AVAR b = 2.0;
  AVAR f = fdim(a,b);
  EXPECT_FLOAT_EQ(5.0,f.val());
