...
public:
  static std::vector<std::string> get_model_path() {
    ...
    model_path.push_back("gauss_iid");
    return model_path;
  }
  ...
  get_expected_values() {
    ...
    expected_values.push_back(make_pair("x[4]", 0));
    expected_values.push_back(make_pair("x[5]", 0));
    ...
    expected_values.push_back(make_pair("x2[4]", 1));
    expected_values.push_back(make_pair("x2[5]", 1));
