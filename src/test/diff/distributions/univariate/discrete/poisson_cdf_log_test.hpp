...
class DiffCdfLogPoisson : public DiffCdfLogTest {
public:
  ...
  cdf_log(const T_n& n, const T_rate& lambda, const T2&,
          const T3&, const T4&, const T5&, const T6&, const T7&, 
          const T8&, const T9&) {
    return stan::prob::poisson_cdf_log(n, lambda);
  }
  ...
  template <typename T_n, typename T_rate, typename T2,
      ...
      typename T9>
  typename stan::return_type<T_rate>::type
  cdf_log_function(const T_n& n, const T_rate& lambda, const T2&,
                   const T3&, const T4&, const T5&, const T6&, const T7&,
                   const T8&, const T9&) {
    using std::pow;
    using stan::diff::pow;
