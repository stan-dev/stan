...
class DiffCdfLogInvChiSquare : public DiffCdfLogTest {
public:
  void valid_values(vector<vector<double> >& parameters,
    ...
    cdf_log.push_back(std::log(0.317528));  // expected cdf_log
  ...
  template <typename T_y, typename T_dof, typename T2,
      ...
      typename T9>
  typename stan::return_type<T_y, T_dof>::type 
  cdf_log_function(const T_y& y, const T_dof& nu, const T2&,
