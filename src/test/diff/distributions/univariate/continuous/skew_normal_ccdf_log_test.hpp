...
class DiffCcdfLogSkewNormal : public DiffCcdfLogTest {
public:
  void valid_values(vector<vector<double> >& parameters,
    ...
    ccdf_log.push_back(std::log(1.0 - 0.25));     // expected ccdf_log
    ...
    param[3] = 1; //alpha
    parameters.push_back(param);
    ccdf_log.push_back(std::log(1.0 - 0.707861)); // expected ccdf_log
    ...
    param[3] = 3; //alpha
    parameters.push_back(param);
    ccdf_log.push_back(std::log(1.0 - 0.0000562444337118770)); // expected ccdf_log
    ...
    param[3] = 1.9; //alpha
    parameters.push_back(param);
    ccdf_log.push_back(std::log(1.0 - 0.05529793)); // expected ccdf_log
  }
