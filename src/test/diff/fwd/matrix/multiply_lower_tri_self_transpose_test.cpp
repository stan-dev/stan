#include <stan/diff/fwd/matrix/multiply_lower_tri_self_transpose.hpp>
#include <gtest/gtest.h>
#include <stan/diff/fwd/matrix/typedefs.hpp>
#include <stan/diff/fwd/matrix/multiply.hpp>
#include <stan/math/matrix/multiply_lower_tri_self_transpose.hpp>

TEST(DiffFwdMatrix, multiply_lower_tri_self_transpose_3x3_matrix) {
  ...
  matrix_fv output = stan::diff::multiply_lower_tri_self_transpose(Y);
  for(int i = 0; i < 3; i++) {
    for(int j = 0; j < 3; j++)
...
TEST(DiffFwdMatrix, multiply_lower_tri_self_transpose_3x2_matrix) {
  using stan::diff::matrix_fv;
  using stan::math::matrix_d;
  matrix_d Z(3,2);
  Z << 1, 0, 0,
