...
TEST(DiffFwdMatrix, diag_pre_multiply_vector) {
...
TEST(DiffFwdMatrix, diag_pre_multiply_vector_exception) {
  using stan::diff::matrix_fv;
  using stan::diff::vector_fv;
...
TEST(DiffFwdMatrix, diag_pre_multiply_rowvector) {
  using stan::diff::matrix_fv;
  using stan::math::matrix_d;
...
TEST(DiffFwdMatrix, diag_pre_multiply_rowvector_exception) {
  using stan::diff::matrix_fv;
  using stan::diff::row_vector_fv;
