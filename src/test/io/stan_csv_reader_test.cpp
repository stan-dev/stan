...
TEST_F(StanIoStanCsvReader,read_samples1) {
  ...
  EXPECT_FLOAT_EQ(0.319627, timing.warmup);
  EXPECT_FLOAT_EQ(0.355654, timing.sampling);
...
TEST_F(StanIoStanCsvReader,ParseBlocker) {
  ...
  EXPECT_FLOAT_EQ(0.319627, blocker0.timing.warmup);
  EXPECT_FLOAT_EQ(0.355654, blocker0.timing.sampling);
...
TEST_F(StanIoStanCsvReader,read_samples2) { 
  ...
  EXPECT_FLOAT_EQ(4.77236, timing.warmup);
  EXPECT_FLOAT_EQ(6.06512, timing.sampling);
...
TEST_F(StanIoStanCsvReader,ParseEpil) {
  ...
  ASSERT_EQ(307, epil0.samples.cols());
  ...
  EXPECT_FLOAT_EQ(4.77236, epil0.timing.warmup);
  EXPECT_FLOAT_EQ(6.06512, epil0.timing.sampling);
