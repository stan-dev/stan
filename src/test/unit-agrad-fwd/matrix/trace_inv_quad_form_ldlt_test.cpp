...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,fd_exceptions) {
  ...
  EXPECT_THROW(trace_inv_quad_form_ldlt(fv1, fd2_), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fd1, fv2_), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fv1, fv2_), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fv1, fv2_), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fv1, fd2_), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fd1, fv2_), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fv1, rvf2), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fv1, rvf1), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fv1, rvd2), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fv1, rvd1), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fv1, vf2), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fv1, vd2), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fv2, rvf2), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fv2, rvf1), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fv2, rvd2), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fv2, rvd1), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fv2, vf1), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fv2, vd1), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fd1, rvf2), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fd1, rvf1), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fd1, vf2), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fd2, rvf2), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fd2, rvf1), std::domain_error);
  EXPECT_THROW(trace_inv_quad_form_ldlt(fd2, vf1), std::domain_error);
}
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_fv_matrix_fv_1) {
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_fv_matrix_fv_2) {
  stan::math::LDLT_factor<fvar<var>,-1,-1> ldlt_Ad;
  stan::agrad::matrix_fv Ad(2,2);
  stan::agrad::matrix_fv Av(2,2);
  fvar<var> I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_fv_matrix_d_1) {
  stan::math::LDLT_factor<fvar<var>,-1,-1> ldlt_Ad;
  stan::agrad::matrix_fv Ad(2,2);
  stan::math::matrix_d Av(2,2);
  fvar<var> I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_fv_matrix_d_2) {
  stan::math::LDLT_factor<fvar<var>,-1,-1> ldlt_Ad;
  stan::agrad::matrix_fv Ad(2,2);
  stan::math::matrix_d Av(2,2);
  fvar<var> I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_d_matrix_fv_1) {
  stan::math::LDLT_factor<double ,-1,-1> ldlt_Ad;
  stan::math::matrix_d Ad(2,2);
  stan::agrad::matrix_fv Av(2,2);
  fvar<var> I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_d_matrix_fv_2) {
  stan::math::LDLT_factor<double ,-1,-1> ldlt_Ad;
  stan::math::matrix_d Ad(2,2);
  stan::agrad::matrix_fv Av(2,2);
  fvar<var> I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_fv_vector_fv_1) {
  stan::math::LDLT_factor<fvar<var>,-1,-1> ldlt_Ad;
  stan::agrad::matrix_fv Ad(2,2);
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_fv_vector_fv_2) {
  stan::math::LDLT_factor<fvar<var>,-1,-1> ldlt_Ad;
  stan::agrad::matrix_fv Ad(2,2);
  stan::agrad::vector_fv Av(2);
  fvar<var> I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_fv_vector_d_1) {
  stan::math::LDLT_factor<fvar<var>,-1,-1> ldlt_Ad;
  stan::agrad::matrix_fv Ad(2,2);
  stan::math::vector_d Av(2);
  fvar<var> I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_fv_vector_d_2) {
  stan::math::LDLT_factor<fvar<var>,-1,-1> ldlt_Ad;
  stan::agrad::matrix_fv Ad(2,2);
  stan::math::vector_d Av(2);
  fvar<var> I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_d_vector_fv_1) {
  stan::math::LDLT_factor<double,-1,-1> ldlt_Ad;
  stan::math::matrix_d Ad(2,2);
  stan::agrad::vector_fv Av(2);
  fvar<var> I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_d_vector_fv_2) {
  stan::math::LDLT_factor<double,-1,-1> ldlt_Ad;
  stan::math::matrix_d Ad(2,2);
  stan::agrad::vector_fv Av(2);
  fvar<var> I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,fv_exceptions) {
  using stan::math::matrix_d;
  using stan::math::vector_d;
  using stan::math::row_vector_d;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_ffv_matrix_ffv_1) {
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_ffv_matrix_ffv_2) {
  stan::math::LDLT_factor<fvar<fvar<var> >,-1,-1> ldlt_Ad;
  stan::agrad::matrix_ffv Ad(2,2);
  stan::agrad::matrix_ffv Av(2,2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_ffv_matrix_ffv_3) {
  stan::math::LDLT_factor<fvar<fvar<var> >,-1,-1> ldlt_Ad;
  stan::agrad::matrix_ffv Ad(2,2);
  stan::agrad::matrix_ffv Av(2,2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_ffv_matrix_ffv_4) {
  stan::math::LDLT_factor<fvar<fvar<var> >,-1,-1> ldlt_Ad;
  stan::agrad::matrix_ffv Ad(2,2);
  stan::agrad::matrix_ffv Av(2,2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_ffv_matrix_d_1) {
  stan::math::LDLT_factor<fvar<fvar<var> >,-1,-1> ldlt_Ad;
  stan::agrad::matrix_ffv Ad(2,2);
  stan::math::matrix_d Av(2,2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_ffv_matrix_d_2) {
  stan::math::LDLT_factor<fvar<fvar<var> >,-1,-1> ldlt_Ad;
  stan::agrad::matrix_ffv Ad(2,2);
  stan::math::matrix_d Av(2,2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_ffv_matrix_d_3) {
  stan::math::LDLT_factor<fvar<fvar<var> >,-1,-1> ldlt_Ad;
  stan::agrad::matrix_ffv Ad(2,2);
  stan::math::matrix_d Av(2,2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_ffv_matrix_d_4) {
  stan::math::LDLT_factor<fvar<fvar<var> >,-1,-1> ldlt_Ad;
  stan::agrad::matrix_ffv Ad(2,2);
  stan::math::matrix_d Av(2,2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_d_matrix_ffv_1) {
  stan::math::LDLT_factor<double ,-1,-1> ldlt_Ad;
  stan::math::matrix_d Ad(2,2);
  stan::agrad::matrix_ffv Av(2,2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_d_matrix_ffv_2) {
  stan::math::LDLT_factor<double ,-1,-1> ldlt_Ad;
  stan::math::matrix_d Ad(2,2);
  stan::agrad::matrix_ffv Av(2,2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_d_matrix_ffv_3) {
  stan::math::LDLT_factor<double ,-1,-1> ldlt_Ad;
  stan::math::matrix_d Ad(2,2);
  stan::agrad::matrix_ffv Av(2,2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_d_matrix_ffv_4) {
  stan::math::LDLT_factor<double ,-1,-1> ldlt_Ad;
  stan::math::matrix_d Ad(2,2);
  stan::agrad::matrix_ffv Av(2,2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_ffv_vector_ffv_1) {
  stan::math::LDLT_factor<fvar<fvar<var> >,-1,-1> ldlt_Ad;
  stan::agrad::matrix_ffv Ad(2,2);
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_ffv_vector_ffv_2) {
  stan::math::LDLT_factor<fvar<fvar<var> >,-1,-1> ldlt_Ad;
  stan::agrad::matrix_ffv Ad(2,2);
  stan::agrad::vector_ffv Av(2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_ffv_vector_ffv_3) {
  stan::math::LDLT_factor<fvar<fvar<var> >,-1,-1> ldlt_Ad;
  stan::agrad::matrix_ffv Ad(2,2);
  stan::agrad::vector_ffv Av(2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_ffv_vector_ffv_4) {
  stan::math::LDLT_factor<fvar<fvar<var> >,-1,-1> ldlt_Ad;
  stan::agrad::matrix_ffv Ad(2,2);
  stan::agrad::vector_ffv Av(2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_ffv_vector_d_1) {
  stan::math::LDLT_factor<fvar<fvar<var> >,-1,-1> ldlt_Ad;
  stan::agrad::matrix_ffv Ad(2,2);
  stan::math::vector_d Av(2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_ffv_vector_d_2) {
  stan::math::LDLT_factor<fvar<fvar<var> >,-1,-1> ldlt_Ad;
  stan::agrad::matrix_ffv Ad(2,2);
  stan::math::vector_d Av(2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_ffv_vector_d_3) {
  stan::math::LDLT_factor<fvar<fvar<var> >,-1,-1> ldlt_Ad;
  stan::agrad::matrix_ffv Ad(2,2);
  stan::math::vector_d Av(2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_ffv_vector_d_4) {
  stan::math::LDLT_factor<fvar<fvar<var> >,-1,-1> ldlt_Ad;
  stan::agrad::matrix_ffv Ad(2,2);
  stan::math::vector_d Av(2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_d_vector_ffv_1) {
  stan::math::LDLT_factor<double,-1,-1> ldlt_Ad;
  stan::math::matrix_d Ad(2,2);
  stan::agrad::vector_ffv Av(2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_d_vector_ffv_2) {
  stan::math::LDLT_factor<double,-1,-1> ldlt_Ad;
  stan::math::matrix_d Ad(2,2);
  stan::agrad::vector_ffv Av(2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_d_vector_ffv_3) {
  stan::math::LDLT_factor<double,-1,-1> ldlt_Ad;
  stan::math::matrix_d Ad(2,2);
  stan::agrad::vector_ffv Av(2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,matrix_d_vector_ffv_4) {
  stan::math::LDLT_factor<double,-1,-1> ldlt_Ad;
  stan::math::matrix_d Ad(2,2);
  stan::agrad::vector_ffv Av(2);
  fvar<fvar<var> > I;
...
TEST(AgradFwdMatrixTraceInvQuadFormLDLT,ffv_exceptions) {
  using stan::math::matrix_d;
  using stan::math::vector_d;
  using stan::math::row_vector_d;
