...
TEST(AgradFwdMatrixMdivideRightTri,fd_exceptions_lower) {
  ...
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(fv1, fd2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(fd1, fv2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(fv1, fv2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(fv1, fv2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(fv1, fd2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(fd1, fv2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(rvf2, fv1), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(rvf2, fv1), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(rvd2, fv1), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(vf2, fv1), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(vd2, fv1), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(rvf1, fv2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(rvd1, fv2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(vf1, fv2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(vd1, fv2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(rvf2, fd1), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(vf2, fd1), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(rvf1, fd2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Lower>(vf1, fd2), std::domain_error);
}
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_fv_matrix_fv1_lower) {
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_fv_matrix_fv2_lower) {
  using stan::agrad::matrix_fv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_fv_row_vector_fv1_lower) {
  using stan::agrad::matrix_fv;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_fv_row_vector_fv2_lower) {
  using stan::agrad::matrix_fv;
  using stan::agrad::row_vector_fv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_fv_matrix_d1_lower) {
  using stan::agrad::matrix_fv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_fv_matrix_d2_lower) {
  using stan::agrad::matrix_fv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_fv_row_vector_d1_lower) {
  using stan::agrad::matrix_fv;
  using stan::agrad::row_vector_fv;
  using stan::math::row_vector_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_fv_row_vector_d2_lower) {
  using stan::agrad::matrix_fv;
  using stan::agrad::row_vector_fv;
  using stan::math::row_vector_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_matrix_fv1_lower) {
  using stan::agrad::matrix_fv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_matrix_fv2_lower) {
  using stan::agrad::matrix_fv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_row_vector_fv1_lower) {
  using stan::math::matrix_d;
  using stan::agrad::row_vector_fv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_row_vector_fv2_lower) {
  using stan::math::matrix_d;
  using stan::agrad::row_vector_fv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,fv_exceptions_lower) {
  using stan::math::matrix_d;
  using stan::math::row_vector_d;
  using stan::math::row_vector_d;
  using stan::agrad::matrix_fv;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_matrix_ffv1_lower) {
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_matrix_ffv2_lower) {
  using stan::agrad::matrix_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_matrix_ffv3_lower) {
  using stan::agrad::matrix_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_matrix_ffv4_lower) {
  using stan::agrad::matrix_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_row_vector_ffv1_lower) {
  using stan::agrad::matrix_ffv;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_row_vector_ffv2_lower) {
  using stan::agrad::matrix_ffv;
  using stan::agrad::row_vector_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_row_vector_ffv3_lower) {
  using stan::agrad::matrix_ffv;
  using stan::agrad::row_vector_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_row_vector_ffv4_lower) {
  using stan::agrad::matrix_ffv;
  using stan::agrad::row_vector_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_matrix_d1_lower) {
  using stan::agrad::matrix_ffv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_matrix_d2_lower) {
  using stan::agrad::matrix_ffv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_matrix_d3_lower) {
  using stan::agrad::matrix_ffv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_matrix_d4_lower) {
  using stan::agrad::matrix_ffv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_row_vector_d1_lower) {
  using stan::agrad::matrix_ffv;
  using stan::agrad::row_vector_ffv;
  using stan::math::row_vector_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_row_vector_d2_lower) {
  using stan::agrad::matrix_ffv;
  using stan::agrad::row_vector_ffv;
  using stan::math::row_vector_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_row_vector_d3_lower) {
  using stan::agrad::matrix_ffv;
  using stan::agrad::row_vector_ffv;
  using stan::math::row_vector_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_row_vector_d4_lower) {
  using stan::agrad::matrix_ffv;
  using stan::agrad::row_vector_ffv;
  using stan::math::row_vector_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_matrix_ffv1_lower) {
  using stan::agrad::matrix_ffv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_matrix_ffv2_lower) {
  using stan::agrad::matrix_ffv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_matrix_ffv3_lower) {
  using stan::agrad::matrix_ffv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_matrix_ffv4_lower) {
  using stan::agrad::matrix_ffv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_row_vector_ffv1_lower) {
  using stan::math::matrix_d;
  using stan::agrad::row_vector_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_row_vector_ffv2_lower) {
  using stan::math::matrix_d;
  using stan::agrad::row_vector_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_row_vector_ffv3_lower) {
  using stan::math::matrix_d;
  using stan::agrad::row_vector_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_row_vector_ffv4_lower) {
  using stan::math::matrix_d;
  using stan::agrad::row_vector_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,ffv_exceptions_lower) {
  using stan::math::matrix_d;
  using stan::math::row_vector_d;
  using stan::math::row_vector_d;
  using stan::agrad::matrix_ffv;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_fd_matrix_fd_upper) {
  using stan::agrad::matrix_fd;
  using stan::math::mdivide_right_tri;
  ...
  EXPECT_FLOAT_EQ(0.66666667,I(0,0).val_);
  EXPECT_FLOAT_EQ(0.58333333,I(0,1).val_);
  EXPECT_FLOAT_EQ(1.66666667,I(1,0).val_);
  EXPECT_FLOAT_EQ(1.3333333,I(1,1).val_);
  EXPECT_FLOAT_EQ(0.11111111,I(0,0).d_);
  EXPECT_FLOAT_EQ(-0.090277778,I(0,1).d_);
  EXPECT_FLOAT_EQ(-0.22222222,I(1,0).d_);
  EXPECT_FLOAT_EQ(-0.44444444,I(1,1).d_);
}
TEST(AgradFwdMatrixMdivideRightTri,matrix_fd_row_vector_fd_upper) {
  using stan::agrad::matrix_fd;
  using stan::agrad::row_vector_fd;
  using stan::math::mdivide_right_tri;
  ...
  I = mdivide_right_tri<Eigen::Upper>(Ad,Av);
  EXPECT_FLOAT_EQ(0.66666666,I(0).val_);
  EXPECT_FLOAT_EQ(0.58333333,I(1).val_);
  EXPECT_FLOAT_EQ(0.11111111,I(0).d_);
  EXPECT_FLOAT_EQ(-0.090277776,I(1).d_);
}
TEST(AgradFwdMatrixMdivideRightTri,matrix_fd_matrix_d_upper) {
  using stan::agrad::matrix_fd;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
  ...
  EXPECT_FLOAT_EQ(-0.25694445,I(0,1).d_);
  EXPECT_FLOAT_EQ(-0.55555556,I(1,0).d_);
  EXPECT_FLOAT_EQ(-0.6111111,I(1,1).d_);
}
TEST(AgradFwdMatrixMdivideRightTri,matrix_fd_row_vector_d_upper) {
  using stan::agrad::matrix_fd;
  using stan::agrad::row_vector_fd;
  using stan::math::row_vector_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_matrix_fd_upper) {
  using stan::agrad::matrix_fd;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
  ...
  EXPECT_FLOAT_EQ(1.66666667,I(1,0).val_);
  EXPECT_FLOAT_EQ(1.3333333,I(1,1).val_);
  EXPECT_FLOAT_EQ(0.33333333,I(0,0).d_);
  EXPECT_FLOAT_EQ(0.16666667,I(0,1).d_);
  EXPECT_FLOAT_EQ(0.33333333,I(1,0).d_);
  EXPECT_FLOAT_EQ(0.16666667,I(1,1).d_);
}
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_row_vector_fd_upper) {
  using stan::math::matrix_d;
  using stan::agrad::row_vector_fd;
  using stan::math::mdivide_right_tri;
  ...
  EXPECT_FLOAT_EQ(0.66666666,I(0).val_);
  EXPECT_FLOAT_EQ(0.58333333,I(1).val_);
  EXPECT_FLOAT_EQ(0.33333333,I(0).d_);
  EXPECT_FLOAT_EQ(0.16666667,I(1).d_);
}

TEST(AgradFwdMatrixMdivideRightTri,fd_exceptions_upper) {
  using stan::math::matrix_d;
  using stan::math::row_vector_d;
  using stan::math::row_vector_d;
  using stan::agrad::matrix_fd;
  ...
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(fv1, fd2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(fd1, fv2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(fv1, fv2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(fv1, fv2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(fv1, fd2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(fd1, fv2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(rvf2, fv1), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(rvf2, fv1), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(rvd2, fv1), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(vf2, fv1), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(vd2, fv1), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(rvf1, fv2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(rvd1, fv2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(vf1, fv2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(vd1, fv2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(rvf2, fd1), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(vf2, fd1), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(rvf1, fd2), std::domain_error);
  EXPECT_THROW(mdivide_right_tri<Eigen::Upper>(vf1, fd2), std::domain_error);
}

TEST(AgradFwdMatrixMdivideRightTri,matrix_ffd_matrix_ffd_upper) {
  using stan::agrad::matrix_ffd;
  using stan::math::mdivide_right_tri;
  ...
  I = mdivide_right_tri<Eigen::Upper>(Ad,Av);
  EXPECT_FLOAT_EQ(0.66666667,I(0,0).val_.val_);
  EXPECT_FLOAT_EQ(0.58333333,I(0,1).val_.val_);
  EXPECT_FLOAT_EQ(1.6666667,I(1,0).val_.val_);
  EXPECT_FLOAT_EQ(1.3333333,I(1,1).val_.val_);
  EXPECT_FLOAT_EQ(0.11111111,I(0,0).d_.val_);
  EXPECT_FLOAT_EQ(-0.090277776,I(0,1).d_.val_);
  EXPECT_FLOAT_EQ(-0.22222222,I(1,0).d_.val_);
  EXPECT_FLOAT_EQ(-0.44444444,I(1,1).d_.val_);
}
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffd_row_vector_ffd_upper) {
  using stan::agrad::matrix_ffd;
  using stan::agrad::row_vector_ffd;
  using stan::math::mdivide_right_tri;
  ...
  I = mdivide_right_tri<Eigen::Upper>(Ad,Av);
  EXPECT_FLOAT_EQ(0.66666666,I(0).val_.val_);
  EXPECT_FLOAT_EQ(0.58333333,I(1).val_.val_);
  EXPECT_FLOAT_EQ(0.11111111,I(0).d_.val_);
  EXPECT_FLOAT_EQ(-0.090277778,I(1).d_.val_);
}
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffd_matrix_d_upper) {
  using stan::agrad::matrix_ffd;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
  ...
  EXPECT_FLOAT_EQ(-0.25694445,I(0,1).d_.val_);
  EXPECT_FLOAT_EQ(-0.55555556,I(1,0).d_.val_);
  EXPECT_FLOAT_EQ(-0.6111111,I(1,1).d_.val_);
}
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffd_row_vector_d_upper) {
  using stan::agrad::matrix_ffd;
  using stan::agrad::row_vector_ffd;
  using stan::math::row_vector_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_matrix_ffd_upper) {
  using stan::agrad::matrix_ffd;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
  ...
  EXPECT_FLOAT_EQ(1.6666667,I(1,0).val_.val_);
  EXPECT_FLOAT_EQ(1.3333333,I(1,1).val_.val_);
  EXPECT_FLOAT_EQ(0.33333333,I(0,0).d_.val_);
  EXPECT_FLOAT_EQ(0.16666667,I(0,1).d_.val_);
  EXPECT_FLOAT_EQ(0.33333333,I(1,0).d_.val_);
  EXPECT_FLOAT_EQ(0.16666667,I(1,1).d_.val_);
}
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_row_vector_ffd_upper) {
  using stan::math::matrix_d;
  using stan::agrad::row_vector_ffd;
  using stan::math::mdivide_right_tri;
  ...
  EXPECT_FLOAT_EQ(0.66666666,I(0).val_.val_);
  EXPECT_FLOAT_EQ(0.58333333,I(1).val_.val_);
  EXPECT_FLOAT_EQ(0.33333333,I(0).d_.val_);
  EXPECT_FLOAT_EQ(0.16666667,I(1).d_.val_);
}

TEST(AgradFwdMatrixMdivideRightTri,ffd_exceptions_upper) {
  using stan::math::matrix_d;
  using stan::math::row_vector_d;
  using stan::math::row_vector_d;
  using stan::agrad::matrix_ffd;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_fv_matrix_fv1_upper) {
  using stan::agrad::matrix_fv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_fv_matrix_fv2_upper) {
  using stan::agrad::matrix_fv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_fv_row_vector_fv1_upper) {
  using stan::agrad::matrix_fv;
  using stan::agrad::row_vector_fv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_fv_row_vector_fv2_upper) {
  using stan::agrad::matrix_fv;
  using stan::agrad::row_vector_fv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_fv_matrix_d1_upper) {
  using stan::agrad::matrix_fv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_fv_matrix_d2_upper) {
  using stan::agrad::matrix_fv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_fv_row_vector_d1_upper) {
  using stan::agrad::matrix_fv;
  using stan::agrad::row_vector_fv;
  using stan::math::row_vector_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_fv_row_vector_d2_upper) {
  using stan::agrad::matrix_fv;
  using stan::agrad::row_vector_fv;
  using stan::math::row_vector_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_matrix_fv1_upper) {
  using stan::agrad::matrix_fv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_matrix_fv2_upper) {
  using stan::agrad::matrix_fv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_row_vector_fv1_upper) {
  using stan::math::matrix_d;
  using stan::agrad::row_vector_fv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_row_vector_fv2_upper) {
  using stan::math::matrix_d;
  using stan::agrad::row_vector_fv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,fv_exceptions_upper) {
  using stan::math::matrix_d;
  using stan::math::row_vector_d;
  using stan::math::row_vector_d;
  using stan::agrad::matrix_fv;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_matrix_ffv1_upper) {
  using stan::agrad::matrix_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_matrix_ffv2_upper) {
  using stan::agrad::matrix_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_matrix_ffv3_upper) {
  using stan::agrad::matrix_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_matrix_ffv4_upper) {
  using stan::agrad::matrix_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_row_vector_ffv1_upper) {
  using stan::agrad::matrix_ffv;
  using stan::agrad::row_vector_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_row_vector_ffv2_upper) {
  using stan::agrad::matrix_ffv;
  using stan::agrad::row_vector_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_row_vector_ffv3_upper) {
  using stan::agrad::matrix_ffv;
  using stan::agrad::row_vector_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_row_vector_ffv4_upper) {
  using stan::agrad::matrix_ffv;
  using stan::agrad::row_vector_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_matrix_d1_upper) {
  using stan::agrad::matrix_ffv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_matrix_d2_upper) {
  using stan::agrad::matrix_ffv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_matrix_d3_upper) {
  using stan::agrad::matrix_ffv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_matrix_d4_upper) {
  using stan::agrad::matrix_ffv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_row_vector_d1_upper) {
  using stan::agrad::matrix_ffv;
  using stan::agrad::row_vector_ffv;
  using stan::math::row_vector_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_row_vector_d2_upper) {
  using stan::agrad::matrix_ffv;
  using stan::agrad::row_vector_ffv;
  using stan::math::row_vector_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_row_vector_d3_upper) {
  using stan::agrad::matrix_ffv;
  using stan::agrad::row_vector_ffv;
  using stan::math::row_vector_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_ffv_row_vector_d4_upper) {
  using stan::agrad::matrix_ffv;
  using stan::agrad::row_vector_ffv;
  using stan::math::row_vector_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_matrix_ffv1_upper) {
  using stan::agrad::matrix_ffv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_matrix_ffv2_upper) {
  using stan::agrad::matrix_ffv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_matrix_ffv3_upper) {
  using stan::agrad::matrix_ffv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_matrix_ffv4_upper) {
  using stan::agrad::matrix_ffv;
  using stan::math::matrix_d;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_row_vector_ffv1_upper) {
  using stan::math::matrix_d;
  using stan::agrad::row_vector_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_row_vector_ffv2_upper) {
  using stan::math::matrix_d;
  using stan::agrad::row_vector_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_row_vector_ffv3_upper) {
  using stan::math::matrix_d;
  using stan::agrad::row_vector_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,matrix_d_row_vector_ffv4_upper) {
  using stan::math::matrix_d;
  using stan::agrad::row_vector_ffv;
  using stan::math::mdivide_right_tri;
...
TEST(AgradFwdMatrixMdivideRightTri,ffv_exceptions_upper) {
  using stan::math::matrix_d;
  using stan::math::row_vector_d;
  using stan::math::row_vector_d;
  using stan::agrad::matrix_ffv;
