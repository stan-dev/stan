...
TEST(AgradFwdMatrixGetBase1,failing_pre_20_fv) {
  using Eigen::Matrix;
  using Eigen::Dynamic;
  using stan::math::get_base1;
...
TEST(AgradFwdMatrixGetBase1,get_base1_vec1_fv) {
  using stan::math::get_base1;
...
TEST(AgradFwdMatrixGetBase1,get_base1_vec2_fv) {
  using stan::math::get_base1;
  using std::vector;
  size_t M = 3;
  size_t N = 4;
  ...
  for (size_t m = 1; m <= M; ++m) {
    for (size_t n = 1; n <= N; ++n) {
      ...
      fvar<var>  found = get_base1(get_base1(x, m, "x[m]",1),
                               n, "x[m][n]",2);
...
TEST(AgradFwdMatrixGetBase1,get_base1_matrix_fv) {
  using Eigen::Matrix;
  using Eigen::Dynamic;
  using stan::math::get_base1;
  ...
  for (size_t i = 0; i < 4; ++i) {
    for (size_t j = 0; j < 3; ++j) {
      ...
      Matrix<fvar<var> ,1,Dynamic> xi
        = get_base1<fvar<var> >(x,i+1,"x",1);
      EXPECT_FLOAT_EQ(x(i,j).val_.val(),xi[j].val_.val());
      EXPECT_FLOAT_EQ(x(i,j).val_.val(),get_base1(xi,j+1,"xi",2).val_.val());
    }
  }
  EXPECT_THROW(get_base1(x,10,"x",1), std::out_of_range);
  EXPECT_THROW(get_base1(x,0,"x",1), std::out_of_range);
...
TEST(AgradFwdMatrixGetBase1,get_base1_vector_fv) {
  using Eigen::Matrix;
  using Eigen::Dynamic;
  using stan::math::get_base1;
...
TEST(AgradFwdMatrixGetBase1,get_base1_row_vector_fv) {
  using Eigen::Matrix;
  using Eigen::Dynamic;
  using stan::math::get_base1;
...
TEST(AgradFwdMatrixGetBase1,get_base1_8_fv) {
  using stan::math::get_base1;
  using std::vector;
  fvar<var>  x0(42.0);
  // ~ 4m entries ~ 32MB memory + sizes
...
TEST(AgradFwdMatrixGetBase1,failing_pre_20_ffv) {
  using Eigen::Matrix;
  using Eigen::Dynamic;
  using stan::math::get_base1;
...
TEST(AgradFwdMatrixGetBase1,get_base1_vec1_ffv) {
  using stan::math::get_base1;
...
TEST(AgradFwdMatrixGetBase1,get_base1_vec2_ffv) {
  using stan::math::get_base1;
  using std::vector;
  size_t M = 3;
  size_t N = 4;
  ...
  for (size_t m = 1; m <= M; ++m) {
    for (size_t n = 1; n <= N; ++n) {
      ...
      fvar<fvar<var> >  found = get_base1(get_base1(x, m, "x[m]",1),
                               n, "x[m][n]",2);
...
TEST(AgradFwdMatrixGetBase1,get_base1_matrix_ffv) {
  using Eigen::Matrix;
  using Eigen::Dynamic;
  using stan::math::get_base1;
  ...
  for (size_t i = 0; i < 4; ++i) {
    for (size_t j = 0; j < 3; ++j) {
      ...
      Matrix<fvar<fvar<var> > ,1,Dynamic> xi
        = get_base1<fvar<fvar<var> > >(x,i+1,"x",1);
      EXPECT_FLOAT_EQ(x(i,j).val_.val_.val(),xi[j].val_.val_.val());
      EXPECT_FLOAT_EQ(x(i,j).val_.val_.val(),get_base1(xi,j+1,"xi",2).val_.val_.val());
    }
  }
  EXPECT_THROW(get_base1(x,10,"x",1), std::out_of_range);
  EXPECT_THROW(get_base1(x,0,"x",1), std::out_of_range);
...
TEST(AgradFwdMatrixGetBase1,get_base1_vector_ffv) {
  using Eigen::Matrix;
  using Eigen::Dynamic;
  using stan::math::get_base1;
  ...
  for (size_t i = 0; i < 3; ++i)
    EXPECT_FLOAT_EQ(x(i).val_.val_.val(), get_base1(x,i+1,"x",1).val_.val_.val());
  EXPECT_THROW(get_base1(x,0,"x",1), std::out_of_range);
  EXPECT_THROW(get_base1(x,100,"x",1), std::out_of_range);
}
TEST(AgradFwdMatrixGetBase1,get_base1_row_vector_ffv) {
  using Eigen::Matrix;
  using Eigen::Dynamic;
  using stan::math::get_base1;
...
TEST(AgradFwdMatrixGetBase1,get_base1_8_ffv) {
  using stan::math::get_base1;
  using std::vector;
