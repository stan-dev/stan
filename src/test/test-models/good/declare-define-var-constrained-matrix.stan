...
transformed data {
  ...
  corr_matrix[d] td_corr_matrix_ar[d] = d_corr_matrix_ar;

  cov_matrix[d] td_cov_matrix1 = d_cov_matrix;
  cov_matrix[d] td_cov_matrix2 = d_cov_matrix_ar[1];
  cov_matrix[d] td_cov_matrix_ar[d] = d_cov_matrix_ar;
  ...
  cholesky_factor_corr[d] td_cholesky_factor_corr_ar[d] = d_cholesky_factor_corr_ar;
  ...
  cholesky_factor_cov[d] td_cholesky_factor_cov_ar[d] = d_cholesky_factor_cov_ar;
...
transformed parameters {
  ...
  corr_matrix[d] tp_corr_matrix_ar[d] = d_corr_matrix_ar;

  cov_matrix[d] tp_cov_matrix1 = d_cov_matrix;
  cov_matrix[d] tp_cov_matrix2 = d_cov_matrix_ar[1];
  cov_matrix[d] tp_cov_matrix_ar[d] = d_cov_matrix_ar;
  ...
  cholesky_factor_corr[d] tp_cholesky_factor_corr_ar[d] = d_cholesky_factor_corr_ar;
  ...
  cholesky_factor_cov[d] tp_cholesky_factor_cov_ar[d] = d_cholesky_factor_cov_ar;
...
generated quantities {
  ...
  corr_matrix[d] gq_corr_matrix_ar[d] = d_corr_matrix_ar;

  cov_matrix[d] gq_cov_matrix1 = d_cov_matrix;
  cov_matrix[d] gq_cov_matrix2 = d_cov_matrix_ar[1];
  cov_matrix[d] gq_cov_matrix_ar[d] = d_cov_matrix_ar;
  ...
  cholesky_factor_corr[d] gq_cholesky_factor_corr_ar[d] = d_cholesky_factor_corr_ar;
  ...
  cholesky_factor_cov[d] gq_cholesky_factor_cov_ar[d] = d_cholesky_factor_cov_ar;
