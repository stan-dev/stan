...
transformed data {
  ...
  transformed_data_real <- binomial_cdf_log(d_int, d_int, d_int);
  ...
  transformed_data_real <- binomial_cdf_log(d_int, d_int_array, d_int);
  ...
  transformed_data_real <- binomial_cdf_log(d_int_array, d_int, d_int);
  ...
  transformed_data_real <- binomial_cdf_log(d_int_array, d_int_array, d_int);
...
transformed parameters {
  ...
  transformed_param_real <- binomial_cdf_log(d_int, d_int, d_int);
  ...
  transformed_param_real <- binomial_cdf_log(d_int, d_int_array, d_int);
  ...
  transformed_param_real <- binomial_cdf_log(d_int_array, d_int, d_int);
  ...
  transformed_param_real <- binomial_cdf_log(d_int_array, d_int_array, d_int);
