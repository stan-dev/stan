transformed data {
  ...
  transformed_data_real = neg_binomial_2_log_glm_lpmf(d_y_a| d_x_v, d_beta_fm, d_alpha, d_phi_a);
  transformed_data_real = neg_binomial_2_log_glm_lpmf(d_y_a| d_x_v, d_beta_fa, d_alpha, d_phi_a);
  ...
  transformed_data_real = neg_binomial_2_log_glm_lpmf(d_y_a| d_x_v, d_beta_fm, d_alpha, d_phi_v);
  transformed_data_real = neg_binomial_2_log_glm_lpmf(d_y_a| d_x_v, d_beta_fa, d_alpha, d_phi_v);
  ...
  transformed_data_real = neg_binomial_2_log_glm_lpmf(d_y_a| d_x_v, d_beta_fm, d_alpha, d_phi_rv);
  transformed_data_real = neg_binomial_2_log_glm_lpmf(d_y_a| d_x_v, d_beta_fa, d_alpha, d_phi_rv);
...
transformed parameters {
  ...
  transformed_param_real = neg_binomial_2_log_glm_lpmf(d_y_a| p_x_v, p_beta_fm, p_alpha, p_phi_a);
  transformed_param_real = neg_binomial_2_log_glm_lpmf(d_y_a| p_x_v, p_beta_fa, p_alpha, p_phi_a);
  ...
  transformed_param_real = neg_binomial_2_log_glm_lpmf(d_y_a| p_x_v, p_beta_fm, p_alpha, p_phi_v);
  transformed_param_real = neg_binomial_2_log_glm_lpmf(d_y_a| p_x_v, p_beta_fa, p_alpha, p_phi_v);
