transformed data {
  ...
  transformed_data_real = poisson_log_glm_lpmf(d_y_a| d_x_v, d_beta_fm, d_alpha);
  transformed_data_real = poisson_log_glm_lpmf(d_y_a| d_x_v, d_beta_fa, d_alpha);
...
transformed parameters {
  ...
  transformed_param_real = poisson_log_glm_lpmf(d_y_a| p_x_v, p_beta_fm, p_alpha);
  transformed_param_real = poisson_log_glm_lpmf(d_y_a| p_x_v, p_beta_fa, p_alpha);
