...
transformed data {
  ...
  transformed_data_real <- exponential_cdf_log(d_int, d_int);
  transformed_data_real <- exponential_cdf_log(d_int, d_real);
  transformed_data_real <- exponential_cdf_log(d_int, d_real_array);
  transformed_data_real <- exponential_cdf_log(d_int, d_vector);
  transformed_data_real <- exponential_cdf_log(d_int, d_row_vector);
  transformed_data_real <- exponential_cdf_log(d_real, d_int);
  ...
  transformed_data_real <- exponential_cdf_log(d_real_array, d_int);
  ...
  transformed_data_real <- exponential_cdf_log(d_vector, d_int);
  ...
  transformed_data_real <- exponential_cdf_log(d_row_vector, d_int);
...
transformed parameters {
  ...
  transformed_param_real <- exponential_cdf_log(d_int, d_int);
  transformed_param_real <- exponential_cdf_log(d_int, d_real);
  transformed_param_real <- exponential_cdf_log(d_int, d_real_array);
  transformed_param_real <- exponential_cdf_log(d_int, d_vector);
  transformed_param_real <- exponential_cdf_log(d_int, d_row_vector);
  transformed_param_real <- exponential_cdf_log(d_int, p_real);
  transformed_param_real <- exponential_cdf_log(d_int, p_real_array);
  transformed_param_real <- exponential_cdf_log(d_int, p_vector);
  transformed_param_real <- exponential_cdf_log(d_int, p_row_vector);
  transformed_param_real <- exponential_cdf_log(d_real, d_int);
  ...
  transformed_param_real <- exponential_cdf_log(d_real_array, d_int);
  ...
  transformed_param_real <- exponential_cdf_log(d_vector, d_int);
  ...
  transformed_param_real <- exponential_cdf_log(d_row_vector, d_int);
  ...
  transformed_param_real <- exponential_cdf_log(p_real, d_int);
  ...
  transformed_param_real <- exponential_cdf_log(p_real_array, d_int);
  ...
  transformed_param_real <- exponential_cdf_log(p_vector, d_int);
  ...
  transformed_param_real <- exponential_cdf_log(p_row_vector, d_int);
