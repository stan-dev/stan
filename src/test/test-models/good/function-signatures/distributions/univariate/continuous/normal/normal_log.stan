...
transformed data {
  ...
  transformed_data_real <- normal_log(d_int, d_int, d_int);
  transformed_data_real <- normal_log(d_int, d_int, d_real);
  transformed_data_real <- normal_log(d_int, d_int, d_real_array);
  transformed_data_real <- normal_log(d_int, d_int, d_vector);
  transformed_data_real <- normal_log(d_int, d_int, d_row_vector);
  transformed_data_real <- normal_log(d_int, d_real, d_int);
  transformed_data_real <- normal_log(d_int, d_real, d_real);
  transformed_data_real <- normal_log(d_int, d_real, d_real_array);
  transformed_data_real <- normal_log(d_int, d_real, d_vector);
  transformed_data_real <- normal_log(d_int, d_real, d_row_vector);
  transformed_data_real <- normal_log(d_int, d_real_array, d_int);
  transformed_data_real <- normal_log(d_int, d_real_array, d_real);
  transformed_data_real <- normal_log(d_int, d_real_array, d_real_array);
  transformed_data_real <- normal_log(d_int, d_real_array, d_vector);
  transformed_data_real <- normal_log(d_int, d_real_array, d_row_vector);
  transformed_data_real <- normal_log(d_int, d_vector, d_int);
  transformed_data_real <- normal_log(d_int, d_vector, d_real);
  transformed_data_real <- normal_log(d_int, d_vector, d_real_array);
  transformed_data_real <- normal_log(d_int, d_vector, d_vector);
  transformed_data_real <- normal_log(d_int, d_vector, d_row_vector);
  transformed_data_real <- normal_log(d_int, d_row_vector, d_int);
  transformed_data_real <- normal_log(d_int, d_row_vector, d_real);
  transformed_data_real <- normal_log(d_int, d_row_vector, d_real_array);
  transformed_data_real <- normal_log(d_int, d_row_vector, d_vector);
  transformed_data_real <- normal_log(d_int, d_row_vector, d_row_vector);
  transformed_data_real <- normal_log(d_real, d_int, d_int);
  transformed_data_real <- normal_log(d_real, d_int, d_real);
  transformed_data_real <- normal_log(d_real, d_int, d_real_array);
  transformed_data_real <- normal_log(d_real, d_int, d_vector);
  transformed_data_real <- normal_log(d_real, d_int, d_row_vector);
  transformed_data_real <- normal_log(d_real, d_real, d_int);
  ...
  transformed_data_real <- normal_log(d_real, d_real_array, d_int);
  ...
  transformed_data_real <- normal_log(d_real, d_vector, d_int);
  ...
  transformed_data_real <- normal_log(d_real, d_row_vector, d_int);
  ...
  transformed_data_real <- normal_log(d_real_array, d_int, d_int);
  transformed_data_real <- normal_log(d_real_array, d_int, d_real);
  transformed_data_real <- normal_log(d_real_array, d_int, d_real_array);
  transformed_data_real <- normal_log(d_real_array, d_int, d_vector);
  transformed_data_real <- normal_log(d_real_array, d_int, d_row_vector);
  transformed_data_real <- normal_log(d_real_array, d_real, d_int);
  transformed_data_real <- normal_log(d_real_array, d_real, d_real);
  transformed_data_real <- normal_log(d_real_array, d_real, d_real_array);
  transformed_data_real <- normal_log(d_real_array, d_real, d_vector);
  transformed_data_real <- normal_log(d_real_array, d_real, d_row_vector);
  transformed_data_real <- normal_log(d_real_array, d_real_array, d_int);
  ...
  transformed_data_real <- normal_log(d_real_array, d_vector, d_int);
  ...
  transformed_data_real <- normal_log(d_real_array, d_row_vector, d_int);
  ...
  transformed_data_real <- normal_log(d_vector, d_int, d_int);
  transformed_data_real <- normal_log(d_vector, d_int, d_real);
  transformed_data_real <- normal_log(d_vector, d_int, d_real_array);
  transformed_data_real <- normal_log(d_vector, d_int, d_vector);
  transformed_data_real <- normal_log(d_vector, d_int, d_row_vector);
  transformed_data_real <- normal_log(d_vector, d_real, d_int);
  ...
  transformed_data_real <- normal_log(d_vector, d_real_array, d_int);
  ...
  transformed_data_real <- normal_log(d_vector, d_vector, d_int);
  ...
  transformed_data_real <- normal_log(d_vector, d_row_vector, d_int);
  ...
  transformed_data_real <- normal_log(d_row_vector, d_int, d_int);
  transformed_data_real <- normal_log(d_row_vector, d_int, d_real);
  transformed_data_real <- normal_log(d_row_vector, d_int, d_real_array);
  transformed_data_real <- normal_log(d_row_vector, d_int, d_vector);
  transformed_data_real <- normal_log(d_row_vector, d_int, d_row_vector);
  transformed_data_real <- normal_log(d_row_vector, d_real, d_int);
  ...
  transformed_data_real <- normal_log(d_row_vector, d_real_array, d_int);
  ...
  transformed_data_real <- normal_log(d_row_vector, d_vector, d_int);
  ...
  transformed_data_real <- normal_log(d_row_vector, d_row_vector, d_int);
...
transformed parameters {
  ...
  transformed_param_real <- normal_log(d_int, d_int, d_int);
  transformed_param_real <- normal_log(d_int, d_int, d_real);
  transformed_param_real <- normal_log(d_int, d_int, d_real_array);
  transformed_param_real <- normal_log(d_int, d_int, d_vector);
  transformed_param_real <- normal_log(d_int, d_int, d_row_vector);
  transformed_param_real <- normal_log(d_int, d_int, p_real);
  transformed_param_real <- normal_log(d_int, d_int, p_real_array);
  transformed_param_real <- normal_log(d_int, d_int, p_vector);
  transformed_param_real <- normal_log(d_int, d_int, p_row_vector);
  transformed_param_real <- normal_log(d_int, d_real, d_int);
  transformed_param_real <- normal_log(d_int, d_real, d_real);
  transformed_param_real <- normal_log(d_int, d_real, d_real_array);
  transformed_param_real <- normal_log(d_int, d_real, d_vector);
  transformed_param_real <- normal_log(d_int, d_real, d_row_vector);
  transformed_param_real <- normal_log(d_int, d_real, p_real);
  transformed_param_real <- normal_log(d_int, d_real, p_real_array);
  transformed_param_real <- normal_log(d_int, d_real, p_vector);
  transformed_param_real <- normal_log(d_int, d_real, p_row_vector);
  transformed_param_real <- normal_log(d_int, d_real_array, d_int);
  transformed_param_real <- normal_log(d_int, d_real_array, d_real);
  transformed_param_real <- normal_log(d_int, d_real_array, d_real_array);
  transformed_param_real <- normal_log(d_int, d_real_array, d_vector);
  transformed_param_real <- normal_log(d_int, d_real_array, d_row_vector);
  transformed_param_real <- normal_log(d_int, d_real_array, p_real);
  transformed_param_real <- normal_log(d_int, d_real_array, p_real_array);
  transformed_param_real <- normal_log(d_int, d_real_array, p_vector);
  transformed_param_real <- normal_log(d_int, d_real_array, p_row_vector);
  transformed_param_real <- normal_log(d_int, d_vector, d_int);
  transformed_param_real <- normal_log(d_int, d_vector, d_real);
  transformed_param_real <- normal_log(d_int, d_vector, d_real_array);
  transformed_param_real <- normal_log(d_int, d_vector, d_vector);
  transformed_param_real <- normal_log(d_int, d_vector, d_row_vector);
  transformed_param_real <- normal_log(d_int, d_vector, p_real);
  transformed_param_real <- normal_log(d_int, d_vector, p_real_array);
  transformed_param_real <- normal_log(d_int, d_vector, p_vector);
  transformed_param_real <- normal_log(d_int, d_vector, p_row_vector);
  transformed_param_real <- normal_log(d_int, d_row_vector, d_int);
  transformed_param_real <- normal_log(d_int, d_row_vector, d_real);
  transformed_param_real <- normal_log(d_int, d_row_vector, d_real_array);
  transformed_param_real <- normal_log(d_int, d_row_vector, d_vector);
  transformed_param_real <- normal_log(d_int, d_row_vector, d_row_vector);
  transformed_param_real <- normal_log(d_int, d_row_vector, p_real);
  transformed_param_real <- normal_log(d_int, d_row_vector, p_real_array);
  transformed_param_real <- normal_log(d_int, d_row_vector, p_vector);
  transformed_param_real <- normal_log(d_int, d_row_vector, p_row_vector);
  transformed_param_real <- normal_log(d_int, p_real, d_int);
  transformed_param_real <- normal_log(d_int, p_real, d_real);
  transformed_param_real <- normal_log(d_int, p_real, d_real_array);
  transformed_param_real <- normal_log(d_int, p_real, d_vector);
  transformed_param_real <- normal_log(d_int, p_real, d_row_vector);
  transformed_param_real <- normal_log(d_int, p_real, p_real);
  transformed_param_real <- normal_log(d_int, p_real, p_real_array);
  transformed_param_real <- normal_log(d_int, p_real, p_vector);
  transformed_param_real <- normal_log(d_int, p_real, p_row_vector);
  transformed_param_real <- normal_log(d_int, p_real_array, d_int);
  transformed_param_real <- normal_log(d_int, p_real_array, d_real);
  transformed_param_real <- normal_log(d_int, p_real_array, d_real_array);
  transformed_param_real <- normal_log(d_int, p_real_array, d_vector);
  transformed_param_real <- normal_log(d_int, p_real_array, d_row_vector);
  transformed_param_real <- normal_log(d_int, p_real_array, p_real);
  transformed_param_real <- normal_log(d_int, p_real_array, p_real_array);
  transformed_param_real <- normal_log(d_int, p_real_array, p_vector);
  transformed_param_real <- normal_log(d_int, p_real_array, p_row_vector);
  transformed_param_real <- normal_log(d_int, p_vector, d_int);
  transformed_param_real <- normal_log(d_int, p_vector, d_real);
  transformed_param_real <- normal_log(d_int, p_vector, d_real_array);
  transformed_param_real <- normal_log(d_int, p_vector, d_vector);
  transformed_param_real <- normal_log(d_int, p_vector, d_row_vector);
  transformed_param_real <- normal_log(d_int, p_vector, p_real);
  transformed_param_real <- normal_log(d_int, p_vector, p_real_array);
  transformed_param_real <- normal_log(d_int, p_vector, p_vector);
  transformed_param_real <- normal_log(d_int, p_vector, p_row_vector);
  transformed_param_real <- normal_log(d_int, p_row_vector, d_int);
  transformed_param_real <- normal_log(d_int, p_row_vector, d_real);
  transformed_param_real <- normal_log(d_int, p_row_vector, d_real_array);
  transformed_param_real <- normal_log(d_int, p_row_vector, d_vector);
  transformed_param_real <- normal_log(d_int, p_row_vector, d_row_vector);
  transformed_param_real <- normal_log(d_int, p_row_vector, p_real);
  transformed_param_real <- normal_log(d_int, p_row_vector, p_real_array);
  transformed_param_real <- normal_log(d_int, p_row_vector, p_vector);
  transformed_param_real <- normal_log(d_int, p_row_vector, p_row_vector);
  transformed_param_real <- normal_log(d_real, d_int, d_int);
  transformed_param_real <- normal_log(d_real, d_int, d_real);
  transformed_param_real <- normal_log(d_real, d_int, d_real_array);
  transformed_param_real <- normal_log(d_real, d_int, d_vector);
  transformed_param_real <- normal_log(d_real, d_int, d_row_vector);
  transformed_param_real <- normal_log(d_real, d_int, p_real);
  transformed_param_real <- normal_log(d_real, d_int, p_real_array);
  transformed_param_real <- normal_log(d_real, d_int, p_vector);
  transformed_param_real <- normal_log(d_real, d_int, p_row_vector);
  transformed_param_real <- normal_log(d_real, d_real, d_int);
  ...
  transformed_param_real <- normal_log(d_real, d_real_array, d_int);
  ...
  transformed_param_real <- normal_log(d_real, d_vector, d_int);
  ...
  transformed_param_real <- normal_log(d_real, d_row_vector, d_int);
  ...
  transformed_param_real <- normal_log(d_real, p_real, d_int);
  ...
  transformed_param_real <- normal_log(d_real, p_real_array, d_int);
  ...
  transformed_param_real <- normal_log(d_real, p_vector, d_int);
  ...
  transformed_param_real <- normal_log(d_real, p_row_vector, d_int);
  ...
  transformed_param_real <- normal_log(d_real_array, d_int, d_int);
  transformed_param_real <- normal_log(d_real_array, d_int, d_real);
  transformed_param_real <- normal_log(d_real_array, d_int, d_real_array);
  transformed_param_real <- normal_log(d_real_array, d_int, d_vector);
  transformed_param_real <- normal_log(d_real_array, d_int, d_row_vector);
  transformed_param_real <- normal_log(d_real_array, d_int, p_real);
  transformed_param_real <- normal_log(d_real_array, d_int, p_real_array);
  transformed_param_real <- normal_log(d_real_array, d_int, p_vector);
  transformed_param_real <- normal_log(d_real_array, d_int, p_row_vector);
  transformed_param_real <- normal_log(d_real_array, d_real, d_int);
  ...
  transformed_param_real <- normal_log(d_real_array, d_real_array, d_int);
  ...
  transformed_param_real <- normal_log(d_real_array, d_vector, d_int);
  ...
  transformed_param_real <- normal_log(d_real_array, d_row_vector, d_int);
  ...
  transformed_param_real <- normal_log(d_real_array, p_real, d_int);
  ...
  transformed_param_real <- normal_log(d_real_array, p_real_array, d_int);
  ...
  transformed_param_real <- normal_log(d_real_array, p_vector, d_int);
  ...
  transformed_param_real <- normal_log(d_real_array, p_row_vector, d_int);
  ...
  transformed_param_real <- normal_log(d_vector, d_int, d_int);
  transformed_param_real <- normal_log(d_vector, d_int, d_real);
  transformed_param_real <- normal_log(d_vector, d_int, d_real_array);
  transformed_param_real <- normal_log(d_vector, d_int, d_vector);
  transformed_param_real <- normal_log(d_vector, d_int, d_row_vector);
  transformed_param_real <- normal_log(d_vector, d_int, p_real);
  transformed_param_real <- normal_log(d_vector, d_int, p_real_array);
  transformed_param_real <- normal_log(d_vector, d_int, p_vector);
  transformed_param_real <- normal_log(d_vector, d_int, p_row_vector);
  transformed_param_real <- normal_log(d_vector, d_real, d_int);
  ...
  transformed_param_real <- normal_log(d_vector, d_real_array, d_int);
  ...
  transformed_param_real <- normal_log(d_vector, d_vector, d_int);
  ...
  transformed_param_real <- normal_log(d_vector, d_row_vector, d_int);
  ...
  transformed_param_real <- normal_log(d_vector, p_real, d_int);
  ...
  transformed_param_real <- normal_log(d_vector, p_real_array, d_int);
  ...
  transformed_param_real <- normal_log(d_vector, p_vector, d_int);
  ...
  transformed_param_real <- normal_log(d_vector, p_row_vector, d_int);
  ...
  transformed_param_real <- normal_log(d_row_vector, d_int, d_int);
  transformed_param_real <- normal_log(d_row_vector, d_int, d_real);
  transformed_param_real <- normal_log(d_row_vector, d_int, d_real_array);
  transformed_param_real <- normal_log(d_row_vector, d_int, d_vector);
  transformed_param_real <- normal_log(d_row_vector, d_int, d_row_vector);
  transformed_param_real <- normal_log(d_row_vector, d_int, p_real);
  transformed_param_real <- normal_log(d_row_vector, d_int, p_real_array);
  transformed_param_real <- normal_log(d_row_vector, d_int, p_vector);
  transformed_param_real <- normal_log(d_row_vector, d_int, p_row_vector);
  transformed_param_real <- normal_log(d_row_vector, d_real, d_int);
  ...
  transformed_param_real <- normal_log(d_row_vector, d_real_array, d_int);
  ...
  transformed_param_real <- normal_log(d_row_vector, d_vector, d_int);
  ...
  transformed_param_real <- normal_log(d_row_vector, d_row_vector, d_int);
  ...
  transformed_param_real <- normal_log(d_row_vector, p_real, d_int);
  ...
  transformed_param_real <- normal_log(d_row_vector, p_real_array, d_int);
  ...
  transformed_param_real <- normal_log(d_row_vector, p_vector, d_int);
  ...
  transformed_param_real <- normal_log(d_row_vector, p_row_vector, d_int);
  ...
  transformed_param_real <- normal_log(p_real, d_int, d_int);
  transformed_param_real <- normal_log(p_real, d_int, d_real);
  transformed_param_real <- normal_log(p_real, d_int, d_real_array);
  transformed_param_real <- normal_log(p_real, d_int, d_vector);
  transformed_param_real <- normal_log(p_real, d_int, d_row_vector);
  transformed_param_real <- normal_log(p_real, d_int, p_real);
  transformed_param_real <- normal_log(p_real, d_int, p_real_array);
  transformed_param_real <- normal_log(p_real, d_int, p_vector);
  transformed_param_real <- normal_log(p_real, d_int, p_row_vector);
  transformed_param_real <- normal_log(p_real, d_real, d_int);
  ...
  transformed_param_real <- normal_log(p_real, d_real_array, d_int);
  ...
  transformed_param_real <- normal_log(p_real, d_vector, d_int);
  ...
  transformed_param_real <- normal_log(p_real, d_row_vector, d_int);
  ...
  transformed_param_real <- normal_log(p_real, p_real, d_int);
  ...
  transformed_param_real <- normal_log(p_real, p_real_array, d_int);
  ...
  transformed_param_real <- normal_log(p_real, p_vector, d_int);
  ...
  transformed_param_real <- normal_log(p_real, p_row_vector, d_int);
  ...
  transformed_param_real <- normal_log(p_real_array, d_int, d_int);
  transformed_param_real <- normal_log(p_real_array, d_int, d_real);
  transformed_param_real <- normal_log(p_real_array, d_int, d_real_array);
  transformed_param_real <- normal_log(p_real_array, d_int, d_vector);
  transformed_param_real <- normal_log(p_real_array, d_int, d_row_vector);
  transformed_param_real <- normal_log(p_real_array, d_int, p_real);
  transformed_param_real <- normal_log(p_real_array, d_int, p_real_array);
  transformed_param_real <- normal_log(p_real_array, d_int, p_vector);
  transformed_param_real <- normal_log(p_real_array, d_int, p_row_vector);
  transformed_param_real <- normal_log(p_real_array, d_real, d_int);
  ...
  transformed_param_real <- normal_log(p_real_array, d_real_array, d_int);
  ...
  transformed_param_real <- normal_log(p_real_array, d_vector, d_int);
  ...
  transformed_param_real <- normal_log(p_real_array, d_row_vector, d_int);
  ...
  transformed_param_real <- normal_log(p_real_array, p_real, d_int);
  ...
  transformed_param_real <- normal_log(p_real_array, p_real_array, d_int);
  ...
  transformed_param_real <- normal_log(p_real_array, p_vector, d_int);
  ...
  transformed_param_real <- normal_log(p_real_array, p_row_vector, d_int);
  ...
  transformed_param_real <- normal_log(p_vector, d_int, d_int);
  transformed_param_real <- normal_log(p_vector, d_int, d_real);
  transformed_param_real <- normal_log(p_vector, d_int, d_real_array);
  transformed_param_real <- normal_log(p_vector, d_int, d_vector);
  transformed_param_real <- normal_log(p_vector, d_int, d_row_vector);
  transformed_param_real <- normal_log(p_vector, d_int, p_real);
  transformed_param_real <- normal_log(p_vector, d_int, p_real_array);
  transformed_param_real <- normal_log(p_vector, d_int, p_vector);
  transformed_param_real <- normal_log(p_vector, d_int, p_row_vector);
  transformed_param_real <- normal_log(p_vector, d_real, d_int);
  ...
  transformed_param_real <- normal_log(p_vector, d_real_array, d_int);
  ...
  transformed_param_real <- normal_log(p_vector, d_vector, d_int);
  ...
  transformed_param_real <- normal_log(p_vector, d_row_vector, d_int);
  ...
  transformed_param_real <- normal_log(p_vector, p_real, d_int);
  ...
  transformed_param_real <- normal_log(p_vector, p_real_array, d_int);
  ...
  transformed_param_real <- normal_log(p_vector, p_vector, d_int);
  ...
  transformed_param_real <- normal_log(p_vector, p_row_vector, d_int);
  ...
  transformed_param_real <- normal_log(p_row_vector, d_int, d_int);
  transformed_param_real <- normal_log(p_row_vector, d_int, d_real);
  transformed_param_real <- normal_log(p_row_vector, d_int, d_real_array);
  transformed_param_real <- normal_log(p_row_vector, d_int, d_vector);
  transformed_param_real <- normal_log(p_row_vector, d_int, d_row_vector);
  transformed_param_real <- normal_log(p_row_vector, d_int, p_real);
  transformed_param_real <- normal_log(p_row_vector, d_int, p_real_array);
  transformed_param_real <- normal_log(p_row_vector, d_int, p_vector);
  transformed_param_real <- normal_log(p_row_vector, d_int, p_row_vector);
  transformed_param_real <- normal_log(p_row_vector, d_real, d_int);
  ...
  transformed_param_real <- normal_log(p_row_vector, d_real_array, d_int);
  ...
  transformed_param_real <- normal_log(p_row_vector, d_vector, d_int);
  ...
  transformed_param_real <- normal_log(p_row_vector, d_row_vector, d_int);
  ...
  transformed_param_real <- normal_log(p_row_vector, p_real, d_int);
  ...
  transformed_param_real <- normal_log(p_row_vector, p_real_array, d_int);
  ...
  transformed_param_real <- normal_log(p_row_vector, p_vector, d_int);
  ...
  transformed_param_real <- normal_log(p_row_vector, p_row_vector, d_int);
