data {
  ...
  int M;
  real d_real_theta;
  array[N] real d_real_theta_arr;
  vector[N] d_vec_theta;
  row_vector[N] d_rowvec_theta;
  real d_real_lam_1;
  real d_real_lam_2;
  array[N] real d_real_lam_arr;
  vector[N] d_vec_lam;
  row_vector[N] d_rowvec_lam;
  array[M] vector[N] d_vec_lam_arr;
  array[M] row_vector[N] d_rowvec_lam_arr;
  real y_p;
}
transformed data {
...
parameters {
  real p_real_theta;
  array[N] real p_real_theta_arr;
  vector[N] p_vec_theta;
  row_vector[N] p_rowvec_theta;
  real p_real_lam_1;
  real p_real_lam_2;
  array[N] real p_real_lam_arr;
  vector[N] p_vec_lam;
  row_vector[N] p_rowvec_lam;
  array[M] vector[N] p_vec_lam_arr;
  array[M] row_vector[N] p_rowvec_lam_arr;
}
