...
transformed parameters {
  ...
  transformed_param_row_vector <- mdivide_right_tri_low(p_row_vector,d_matrix);
  transformed_param_matrix <- mdivide_right_tri_low(d_matrix,p_matrix);
  transformed_param_row_vector <- mdivide_right_tri_low(d_row_vector,p_matrix);
  transformed_param_matrix <- mdivide_right_tri_low(p_matrix,p_matrix);
  transformed_param_row_vector <- mdivide_right_tri_low(p_row_vector,p_matrix);
}
model {  
  y_p ~ normal(0,1);
}
