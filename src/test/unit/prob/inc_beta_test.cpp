...
// TEST(ProbInternalMath, inc_beta_ffv_3rdderiv) {
//   using stan::agrad::fvar;
//   using stan::agrad::var;
//   double a_d = 1.0;
//   double b_d = 1.0;
//   double g_d = 0.4;
//   fvar<fvar<var> > a_fv = 1.0;
//   fvar<fvar<var> > b_fv = 1.0;
//   fvar<fvar<var> > g_fv = 0.4;
//   a_fv.d_ = 1.0;
//   b_fv.d_ = 1.0;
//   g_fv.d_ = 1.0;
//   a_fv.val_.d_ = 1.0;
...
//   fvar<fvar<var> > z = stan::agrad::inc_beta(a_d,b_d,g_fv);

//   AVEC y1 = createAVEC(g_fv.val_.val_);
//   VEC grad1;
//   z.d_.d_.grad(y1,grad1);
//   EXPECT_FLOAT_EQ(0, grad1[0]);

//   z = stan::agrad::inc_beta(a_fv,b_d,g_d);
//   // z = stan::agrad::inc_beta(a_fv,b_fv,g_fv);

// //   AVEC y2 = createAVEC(a_fv.val_.val_);
// //   VEC grad2;
// //   z.d_.d_.grad(y2,grad2);
// //   EXPECT_FLOAT_EQ(1.8688680676267141432939094389587075968001762828102110959314, grad2[0]);

//   z = stan::agrad::inc_beta(a_d,b_fv,g_d);

//   // AVEC y3 = createAVEC(b_fv.val_.val_);
//   // VEC grad3;
//   // z.d_.d_.grad(y3,grad3);
//   // EXPECT_NEAR(-0.01135291559842811507560643721669539256593397382680184269398, grad3[0],1e-6);
// }
