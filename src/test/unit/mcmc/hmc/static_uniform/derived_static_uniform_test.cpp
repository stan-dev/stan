...
TEST(McmcStaticUniform, unit_e_transition) {
  ...
  EXPECT_FLOAT_EQ(0.9501853, s.cont_params()(0));
  EXPECT_FLOAT_EQ(-0.45142606, s.log_prob());
  EXPECT_FLOAT_EQ(1, s.accept_stat());
  EXPECT_EQ("", debug.str());
  EXPECT_EQ("", info.str());
  EXPECT_EQ("", warn.str());
  EXPECT_EQ("", error.str());
...
TEST(McmcStaticUniform, softabs_transition) {
  ...
  EXPECT_FLOAT_EQ(0.95708251, s.cont_params()(0));
  EXPECT_FLOAT_EQ(-0.45800349, s.log_prob());
  EXPECT_FLOAT_EQ(1, s.accept_stat());
  EXPECT_EQ("", debug.str());
  EXPECT_EQ("", info.str());
  EXPECT_EQ("", warn.str());
