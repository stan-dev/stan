...
TEST(McmcNutsClassic, instantiaton_test) {
  ...
  stan::mcmc::unit_e_nuts_classic<gauss3D_model_namespace::gauss3D_model,
                                  stan::rng_t>
      unit_e_sampler(model, base_rng);

  stan::mcmc::diag_e_nuts_classic<gauss3D_model_namespace::gauss3D_model,
                                  stan::rng_t>
      diag_e_sampler(model, base_rng);

  stan::mcmc::dense_e_nuts_classic<gauss3D_model_namespace::gauss3D_model,
                                   stan::rng_t>
      dense_e_sampler(model, base_rng);

  stan::mcmc::adapt_unit_e_nuts_classic<gauss3D_model_namespace::gauss3D_model,
                                        stan::rng_t>
      adapt_unit_e_sampler(model, base_rng);

  stan::mcmc::adapt_diag_e_nuts_classic<gauss3D_model_namespace::gauss3D_model,
                                        stan::rng_t>
      adapt_diag_e_sampler(model, base_rng);

  stan::mcmc::adapt_dense_e_nuts_classic<gauss3D_model_namespace::gauss3D_model,
                                         stan::rng_t>
