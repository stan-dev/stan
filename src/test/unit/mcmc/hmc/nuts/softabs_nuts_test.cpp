...
TEST(McmcSoftAbsNuts, build_tree_test) {
  ...
  stan::mcmc::softabs_nuts<gauss3D_model_namespace::gauss3D_model, stan::rng_t>
...
TEST(McmcSoftAbsNuts, tree_boundary_test) {
  ...
  typedef stan::mcmc::softabs_metric<model_t, stan::rng_t> metric_t;
  ...
  stan::mcmc::softabs_nuts<model_t, stan::rng_t> sampler(model, base_rng);
