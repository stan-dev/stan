...
TEST(ServicesOptimizeLbfgs, rosenbrock) {
  ...
  int return_code = stan::services::optimize::lbfgs(model, base_rng,
                                                    cont_params,
                                                    5,
                                                    0.001,
                                                    1e-12,
  ...
  EXPECT_EQ(37, std::count(parameter_str.begin(), parameter_str.end(), '\n'));
...
TEST(ServicesOptimizeLbfgs, rosenbrock_no_save_refresh) {
  Eigen::VectorXd cont_params(2);
  cont_params[0] = -1; cont_params[1] = 1;
...
TEST(ServicesOptimizeLbfgs, rosenbrock_no_save_1_iteration) {
  Eigen::VectorXd cont_params(2);
  cont_params[0] = -1; cont_params[1] = 1;
