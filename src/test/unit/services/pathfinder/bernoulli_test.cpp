...
stan::io::array_var_context init_context() {
  ...
  boost::ecuyer1988 rng = stan::services::util::create_rng<boost::ecuyer1988>(123, 1);
...
TEST_F(ServicesPathfinderSingle, rosenbrock) {
  ...
  double tol_obj = 9.9999999999999998e-13;
  double tol_rel_obj = 10000;
  double tol_grad = 1e-14;
  double tol_rel_grad = 10000000;
  ...
  int return_code = stan::services::optimize::pathfinder_lbfgs_single(
      model, init_context, seed, chain, init_radius, history_size, init_alpha, tol_obj, tol_rel_obj, tol_grad,
      tol_rel_grad, tol_param, num_iterations, save_iterations, refresh, callback, num_elbo_draws, num_draws, 1,
