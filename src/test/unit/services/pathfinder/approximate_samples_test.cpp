...
TEST_F(ServicesPathfinderSingle, construct_taylor_approximation_sparse) {
  ...
  Ykt_h << 0.263092330532746, 0.143589358486603, -0.0818528136221707, -0.460361552400624, 0.33670953791481, -0.448781711393516, -0.502689907890507, -0.181500257575491, 0.0114128191076615, 0.00336915622440426;
  Eigen::VectorXd Skt_h(10);
  Skt_h << 0.2702573474316, 0.147806401452839, -0.0827824534075856, -0.457531159979105, 0.335399275850177, -0.448878739870787, -0.492741074421406, -0.179497169947386, 0.114847824404478, 0.294524918129742;
  ...
  point_est << -0.667708, -0.363698, 0.208631, 1.1753, -0.857873, 1.14468, 1.28596, 0.463694, 0.631304, -1.45833;
  Eigen::VectorXd grad_est(10);
  grad_est << -0.696164, -0.381036, 0.211975, 1.16359, -0.853761, 1.14448, 1.24625, 0.455609, -0.396231, -1.04201;
  using stan::services::optimize::construct_taylor_approximation_sparse;
  auto xx = construct_taylor_approximation_sparse(
      Ykt_mat, alpha,
      Dk, ninvRST,
      point_est, grad_est);
