...
public:
  ...
  void SetUp() { 
    ...
    recorder_ptr = new stan::interface::recorder::filtered_values
  ...
  int N;
  int M;
  stan::interface::recorder::filtered_values<std::vector<double> > *recorder_ptr;
  std::vector<std::vector<double> > preallocated_values;
  std::vector<size_t> filter;
};

TEST_F(StanInterfaceRecorder, filtered_values_vector_double) {
  stan::interface::recorder::filtered_values<std::vector<double> > 
...
TEST_F(StanInterfaceRecorder, filtered_values_vector_string) {
  stan::interface::recorder::filtered_values<std::vector<double> > 
    recorder = *recorder_ptr;
...
TEST_F(StanInterfaceRecorder, filtered_values_string) {
  stan::interface::recorder::filtered_values<std::vector<double> > 
    recorder = *recorder_ptr;
...
TEST_F(StanInterfaceRecorder, filtered_values_noargs) {
  stan::interface::recorder::filtered_values<std::vector<double> > 
    recorder = *recorder_ptr;
...
TEST_F(StanInterfaceRecorder, filtered_values_is_recording) {
  stan::interface::recorder::filtered_values<std::vector<double> > 
    recorder = *recorder_ptr;
