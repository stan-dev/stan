...
bool run_test(std::string& stan_code,
  ...
  stan::lang::generate_log_prob_var_inits(bvds, true, 2, cpp_code);
...
TEST(generateLogProbVarInitsMethod, t1) {
...
TEST(generateLogProbVarInitsMethod, t2) {
...
TEST(generateLogProbVarInitsMethod, t5) {
