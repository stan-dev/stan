...
TEST(ioJson, jsonParserErr02) {
  test_exception("[ .5 ]",
                 "illegal value, expecting object, array, number, string, or "
                 "literal true/false/null\n");
}

TEST(ioJson, jsonParserErr02a) {
  test_exception("[ 0", "unexpected end of stream\n");
}
...
TEST(ioJson, jsonParserErr02c) {
  test_exception("[ 99.9", "unexpected end of stream\n");
}

TEST(ioJson, jsonParserErr03) {
  test_exception("[ 000.005 ]", "zero padded numbers not allowed\n");
}

TEST(ioJson, jsonParserErr04) {
  test_exception("[ 1. ]", "expected digit after decimal\n");
}

TEST(ioJson, jsonParserErr05) {
  test_exception("[ 1.009e ]", "expected digit after e/E\n");
}
...
TEST(ioJson, jsonParserErr06b) {
  test_exception("[ \"\\uD834abc\" ]",
                 "illegal unicode values, found high-surrogate, expecting "
                 "low-surrogate\n");
}
...
TEST(ioJson, jsonParserErr06e) {
  test_exception("[ \"\\uD834", "unexpected end of stream\n");
}

TEST(ioJson, jsonParserErr06f) {
  test_exception("[ \"\\uD8", "unexpected end of stream\n");
}

TEST(ioJson, jsonParserErr06g) {
  test_exception("[ \"\\uE000\\uD", "unexpected end of stream\n");
}

TEST(ioJson, jsonParserErr07) {
  test_exception("[ \"\\aFFFF\" ]", "expecting legal escape\n");
}
...
TEST(ioJson, jsonParserErr08) {
  ...
  test_exception(ss.str(),
                 "found control character, char values less than U+0020 must "
                 "be \\u escaped\n");
}

TEST(ioJson, jsonParserErr09) {
  test_exception("[ t ]", "expecting rest of literal: rue\n");
}

TEST(ioJson, jsonParserErr10) {
  test_exception("[ f ]", "expecting rest of literal: alse\n");
}

TEST(ioJson, jsonParserErr11) {
  test_exception("[ n ]", "expecting rest of literal: ull\n");
}

TEST(ioJson, jsonParserErr12) {
  test_exception("[5}", "in array, expecting ] or ,\n");
}
...
TEST(ioJson, jsonParserErr12c) {
  test_exception("[ \"a\", ", "unexpected end of stream\n");
}
...
TEST(ioJson, jsonParserErr14f) {
  test_exception("{ \"foo\": -1.0100e09 , ", "unexpected end of stream\n");
}

TEST(ioJson, jsonParserErr15) {
  test_exception("{ \"5\" 5 }", "expecting key-value separator :\n");
}
...
TEST(ioJson, jsonParserErr17) {
  test_exception("{ \"5\" : ", "unexpected end of stream\n");
}

TEST(ioJson, jsonParserErr18) {
  test_exception("[ -1, -2, \"-inf\", ]", "in array, expecting value\n");
}
