...
TEST(prog_reader, zero) {
  ...
  EXPECT_EQ("in file 'foo' at line 1\n",
            stan::io::program_reader::trace_to_string(reader.trace(1)));
  EXPECT_EQ("in file 'foo' at line 2\n",
            stan::io::program_reader::trace_to_string(reader.trace(2)));
  EXPECT_EQ("in file 'foo' at line 3\n",
            stan::io::program_reader::trace_to_string(reader.trace(3)));
  EXPECT_EQ("in file 'foo' at line 4\n",
            stan::io::program_reader::trace_to_string(reader.trace(4)));
  EXPECT_EQ("in file 'foo' at line 5\n",
            stan::io::program_reader::trace_to_string(reader.trace(5)));
  EXPECT_EQ("in file 'foo' at line 6\n",
            stan::io::program_reader::trace_to_string(reader.trace(6)));
