...
TEST(ExpressionTestPrim, add_udf0) {
  ...
  Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> arg_mat1 = stan::test::make_arg<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>>();

  auto res_mat = simple_udf_model_namespace::add_udf(arg_mat0, arg_mat1, nullptr);
  ...
  Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> arg_expr1 = stan::test::make_arg<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>>();
  int counter1 = 0;
  stan::test::counterOp<double> counter_op1(&counter1);

  auto res_expr = simple_udf_model_namespace::add_udf(arg_expr0.unaryExpr(counter_op0), arg_expr1.unaryExpr(counter_op1), nullptr);
...
TEST(ExpressionTestRev, add_udf0) {
  ...
  Eigen::Matrix<stan::math::var, Eigen::Dynamic, Eigen::Dynamic> arg_mat1 = stan::test::make_arg<Eigen::Matrix<stan::math::var, Eigen::Dynamic, Eigen::Dynamic>>();
  ...
  Eigen::Matrix<stan::math::var, Eigen::Dynamic, Eigen::Dynamic> arg_expr1 = stan::test::make_arg<Eigen::Matrix<stan::math::var, Eigen::Dynamic, Eigen::Dynamic>>();
  int counter1 = 0;
...
TEST(ExpressionTestFwd, add_udf0) {
  ...
  Eigen::Matrix<stan::math::fvar<double>, Eigen::Dynamic, Eigen::Dynamic> arg_mat1 = stan::test::make_arg<Eigen::Matrix<stan::math::fvar<double>, Eigen::Dynamic, Eigen::Dynamic>>();
  ...
  Eigen::Matrix<stan::math::fvar<double>, Eigen::Dynamic, Eigen::Dynamic> arg_expr1 = stan::test::make_arg<Eigen::Matrix<stan::math::fvar<double>, Eigen::Dynamic, Eigen::Dynamic>>();
  int counter1 = 0;
