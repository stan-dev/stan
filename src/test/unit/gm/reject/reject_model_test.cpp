...
#include <stdexcept>
#include <sstream>
#include <test/test-models/no-main/gm/reject_model.cpp>
...
TEST(StanCommon, reject_model) {
  ...
  // instantiate model
  reject_model_model_namespace::reject_model_model* model 
       = new reject_model_model_namespace::reject_model_model(empty_data_context, &model_output);
