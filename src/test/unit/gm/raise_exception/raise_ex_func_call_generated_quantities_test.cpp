...
#include <stdexcept>
#include <sstream>
#include <test/test-models/no-main/gm/raise_ex_func_call_generated_quantities.cpp>
...
TEST(StanCommon, raise_ex_func_call_generated_quantities) {
  ...
  // instantiate model
  raise_ex_func_call_generated_quantities_model_namespace::raise_ex_func_call_generated_quantities_model* model 
       = new raise_ex_func_call_generated_quantities_model_namespace::raise_ex_func_call_generated_quantities_model(empty_data_context, &model_output);
