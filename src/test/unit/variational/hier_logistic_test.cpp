...
typedef hier_logistic_model_namespace::hier_logistic_model Model;

TEST(advi_test, hier_logistic_constraint_fullrank) {
  ...
  // Instantiate model
  Model my_model(data_var_context);
...
TEST(advi_test, hier_logistic_constraint_meanfield) {
