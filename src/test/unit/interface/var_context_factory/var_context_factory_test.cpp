...
TEST(CmdStan, dump_factory_constructor) {
  stan::interface::var_context_factory::dump_factory f;
...
TEST(CmdStan, dump_factory_source) {
  ...
  stan::io::dump context = f("src/test/unit/interface/var_context_factory/var_context_factory.data.R");
...
TEST(StanInterface, var_context_factory) {
  //stan::interface::var_context_factory f;
  SUCCEED() 
