...
public:
  ...
  int N;
  int M;
  stan::interface::recorder::values<std::vector<double> > recorder;
  std::vector<std::vector<double> > preallocated_values;
};

TEST_F(StanInterfaceRecorder, values_vector_double) {
  std::vector<double> x;
  for (int n = 1; n <= N; n++) 
    x.push_back(n);
...
TEST_F(StanInterfaceRecorder, values_vector_string) {
...
TEST_F(StanInterfaceRecorder, values_string) {
  std::string x;
...
TEST_F(StanInterfaceRecorder, values_noargs) {
  EXPECT_NO_THROW(recorder());
  EXPECT_NO_THROW(recorder());
}

TEST_F(StanInterfaceRecorder, values_is_recording) {
...
TEST_F(StanInterfaceRecorder, values_preallocated_vector_double) {
  stan::interface::recorder::values<std::vector<double> > 
...
TEST_F(StanInterfaceRecorder, values_preallocated_vector_string) {
  stan::interface::recorder::values<std::vector<double> > 
    recorder_preallocated(preallocated_values);
...
TEST_F(StanInterfaceRecorder, values_preallocated_string) {
  stan::interface::recorder::values<std::vector<double> > 
    recorder_preallocated(preallocated_values);
...
TEST_F(StanInterfaceRecorder, values_preallocated_noargs) {
  stan::interface::recorder::values<std::vector<double> > 
    recorder_preallocated(preallocated_values);
...
TEST_F(StanInterfaceRecorder, values_preallocated_is_recording) {
  stan::interface::recorder::values<std::vector<double> > 
    recorder_preallocated(preallocated_values);
