...
TEST(lang, data_block_hpp_ctor) {
  ...
  std::string expected(
      ...
      "\"cfcov_54\", \"matrix_d\", context__.to_vec(5,4));\n"
      "            cfcov_54 = Eigen::Matrix<double, Eigen::Dynamic, "
      "Eigen::Dynamic>(5, 4);\n"
      ...
      "{\n"
      "                for (size_t j_1__ = 0; j_1__ < cfcov_54_j_1_max__; "
      "++j_1__) {\n"
      "                    cfcov_54(j_1__, j_2__) = vals_r__[pos__++];\n"
      "                }\n"
      "            }\n"
      "            stan::math::check_cholesky_factor(function__, \"cfcov_54\", "
      "cfcov_54);\n"
      "\n"
      ...
      "            validate_non_negative_index(\"cfcov_33\", \"3\", 3);\n"
      "            context__.validate_dims(\"data initialization\", "
      "\"cfcov_33\", \"matrix_d\", context__.to_vec(3,3));\n"
      "            cfcov_33 = Eigen::Matrix<double, Eigen::Dynamic, "
      "Eigen::Dynamic>(3, 3);\n"
      ...
      "{\n"
      "                for (size_t j_1__ = 0; j_1__ < cfcov_33_j_1_max__; "
      "++j_1__) {\n"
      "                    cfcov_33(j_1__, j_2__) = vals_r__[pos__++];\n"
      "                }\n"
      "            }\n"
      "            stan::math::check_cholesky_factor(function__, \"cfcov_33\", "
      "cfcov_33);\n");
...
TEST(lang, transformed_data_block_ast) {
  ...
  stan::lang::program prog
      = model_to_ast("transformed_data_cholesky_cov_mat", m1);
...
TEST(lang, params_block_var_hpp_xform_inits) {
  ...
  std::string expected_1(
      ...
      "cfcov_54 missing\")), current_statement_begin__, prog_reader__());\n"
      "        vals_r__ = context__.vals_r(\"cfcov_54\");\n"
      "        pos__ = 0U;\n"
      "        validate_non_negative_index(\"cfcov_54\", \"5\", 5);\n"
      "        validate_non_negative_index(\"cfcov_54\", \"4\", 4);\n"
      ...
      "transforming variable cfcov_54: \") + e.what()), "
  ...
  std::string expected_2(
      ...
      "            "
      "stan::model::rethrow_located(std::runtime_error(std::string(\"Variable "
      "cfcov_33 missing\")), current_statement_begin__, prog_reader__());\n"
      "        vals_r__ = context__.vals_r(\"cfcov_33\");\n"
      "        pos__ = 0U;\n"
      "        validate_non_negative_index(\"cfcov_33\", \"3\", 3);\n"
      "        validate_non_negative_index(\"cfcov_33\", \"3\", 3);\n"
      ...
      "            "
      "stan::model::rethrow_located(std::runtime_error(std::string(\"Error "
      "transforming variable cfcov_33: \") + e.what()), "
      "current_statement_begin__, prog_reader__());\n"
      "        }\n");
  EXPECT_EQ(1, count_matches(expected_2, hpp));
}
...
TEST(lang, params_block_var_hpp_xform_log_prob) {
  ...
  std::string expected(
      "            // model parameters\n"
      "            current_statement_begin__ = 2;\n"
      "            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, "
      "Eigen::Dynamic> cfcov_54;\n"
...
TEST(lang, params_block_var_hpp_write_array) {
  ...
  std::string expected(
      ...
      "        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> cfcov_54 "
      "= in__.cholesky_factor_cov_constrain(5, 4);\n"
      "        size_t cfcov_54_j_2_max__ = 4;\n"
      "        size_t cfcov_54_j_1_max__ = 5;\n"
      "        for (size_t j_2__ = 0; j_2__ < cfcov_54_j_2_max__; ++j_2__) {\n"
      "            for (size_t j_1__ = 0; j_1__ < cfcov_54_j_1_max__; ++j_1__) "
      ...
      "        }\n"
      "\n"
      "        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> cfcov_33 "
      "= in__.cholesky_factor_cov_constrain(3, 3);\n"
      "        size_t cfcov_33_j_2_max__ = 3;\n"
      "        size_t cfcov_33_j_1_max__ = 3;\n"
      "        for (size_t j_2__ = 0; j_2__ < cfcov_33_j_2_max__; ++j_2__) {\n"
      "            for (size_t j_1__ = 0; j_1__ < cfcov_33_j_1_max__; ++j_1__) "
...
TEST(lang, params_block_var_hpp_unconstrained_param_names) {
  ...
  std::string expected(
      "        size_t cfcov_54_j_1_max__ = (((4 * (4 + 1)) / 2) + ((5 - 4) * "
      "4));\n"
      "        for (size_t j_1__ = 0; j_1__ < cfcov_54_j_1_max__; ++j_1__) {\n"
      "            param_name_stream__.str(std::string());\n"
      "            param_name_stream__ << \"cfcov_54\" << '.' << j_1__ + 1;\n"
      "            param_names__.push_back(param_name_stream__.str());\n"
      "        }\n"
      "        size_t cfcov_33_j_1_max__ = (((3 * (3 + 1)) / 2) + ((3 - 3) * "
      "3));\n"
      "        for (size_t j_1__ = 0; j_1__ < cfcov_33_j_1_max__; ++j_1__) {\n"
      "            param_name_stream__.str(std::string());\n"
      "            param_name_stream__ << \"cfcov_33\" << '.' << j_1__ + 1;\n"
...
TEST(lang, transformed_params_block_var_hpp_log_prob) {
  ...
  std::string expected_2(
      ...
      "            for (size_t j_1__ = 0; j_1__ < cfcov_54_j_1_max__; ++j_1__) "
      "{\n"
      "                for (size_t j_2__ = 0; j_2__ < cfcov_54_j_2_max__; "
      "++j_2__) {\n"
      "                    if (stan::math::is_uninitialized(cfcov_54(j_1__, "
      "j_2__))) {\n"
      "                        std::stringstream msg__;\n"
      "                        msg__ << \"Undefined transformed parameter: "
      "cfcov_54\" << \"(\" << j_1__ << \", \" << j_2__ << \")\";\n"
      "                        "
      "stan::model::rethrow_located(std::runtime_error(std::string(\"Error "
      "initializing variable cfcov_54: \") + msg__.str()), "
      "current_statement_begin__, prog_reader__());\n"
      "                    }\n"
      "                }\n"
      "            }\n"
      ...
      "            for (size_t j_1__ = 0; j_1__ < cfcov_33_j_1_max__; ++j_1__) "
      "{\n"
      "                for (size_t j_2__ = 0; j_2__ < cfcov_33_j_2_max__; "
      "++j_2__) {\n"
      "                    if (stan::math::is_uninitialized(cfcov_33(j_1__, "
      "j_2__))) {\n"
      "                        std::stringstream msg__;\n"
      "                        msg__ << \"Undefined transformed parameter: "
      "cfcov_33\" << \"(\" << j_1__ << \", \" << j_2__ << \")\";\n"
      "                        "
      "stan::model::rethrow_located(std::runtime_error(std::string(\"Error "
      "initializing variable cfcov_33: \") + msg__.str()), "
      "current_statement_begin__, prog_reader__());\n"
      "                    }\n"
      "                }\n"
      "            }\n"
...
TEST(lang, xform_params_block_var_hpp_constrained_param_names) {
  ...
  std::string expected(
      ...
      "++j_1__) {\n"
      "                    param_name_stream__.str(std::string());\n"
      "                    param_name_stream__ << \"cfcov_54\" << '.' << j_1__ "
      "+ 1 << '.' << j_2__ + 1;\n"
      "                    "
      "param_names__.push_back(param_name_stream__.str());\n"
      "                }\n"
      ...
      "++j_1__) {\n"
      "                    param_name_stream__.str(std::string());\n"
      "                    param_name_stream__ << \"cfcov_33\" << '.' << j_1__ "
      "+ 1 << '.' << j_2__ + 1;\n"
      "                    "
      "param_names__.push_back(param_name_stream__.str());\n"
      "                }\n"
