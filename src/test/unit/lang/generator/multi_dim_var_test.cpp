...
TEST(lang, data_block_var_hpp) {
  ...
  std::string expected(
      ...
      "\"ar_mat\", \"matrix_d\", context__.to_vec(4,5,2,3));\n"
      "            ar_mat = std::vector<std::vector<Eigen::Matrix<double, "
      "Eigen::Dynamic, Eigen::Dynamic> > >(4, "
      "std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >(5, "
      "Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(2, 3)));\n"
      ...
      "{\n"
      "                for (size_t j_1__ = 0; j_1__ < ar_mat_j_1_max__; "
      "++j_1__) {\n"
      "                    for (size_t k_1__ = 0; k_1__ < ar_mat_k_1_max__; "
      "++k_1__) {\n"
      "                        for (size_t k_0__ = 0; k_0__ < "
      "ar_mat_k_0_max__; ++k_0__) {\n"
      "                            ar_mat[k_0__][k_1__](j_1__, j_2__) = "
      "vals_r__[pos__++];\n"
      "                        }\n"
      "                    }\n"
      "                }\n"
      ...
      "{\n"
      "                for (size_t i_1__ = 0; i_1__ < ar_mat_i_1_max__; "
      "++i_1__) {\n"
      "                    check_greater_or_equal(function__, "
      "\"ar_mat[i_0__][i_1__]\", ar_mat[i_0__][i_1__], 0);\n"
      "                    check_less_or_equal(function__, "
      "\"ar_mat[i_0__][i_1__]\", ar_mat[i_0__][i_1__], 1);\n"
      "                }\n"
      "            }\n");
...
TEST(lang, params_block_var_hpp_xform_inits) {
  ...
  std::string expected(
      ...
      "            "
      "stan::model::rethrow_located(std::runtime_error(std::string(\"Variable "
      "ar_mat missing\")), current_statement_begin__, prog_reader__());\n"
      "        vals_r__ = context__.vals_r(\"ar_mat\");\n"
      "        pos__ = 0U;\n"
      "        validate_non_negative_index(\"ar_mat\", \"2\", 2);\n"
      "        validate_non_negative_index(\"ar_mat\", \"3\", 3);\n"
      ...
      "\"ar_mat\", \"matrix_d\", context__.to_vec(4,5,2,3));\n"
      "        std::vector<std::vector<Eigen::Matrix<double, Eigen::Dynamic, "
      "Eigen::Dynamic> > > ar_mat(4, std::vector<Eigen::Matrix<double, "
      "Eigen::Dynamic, Eigen::Dynamic> >(5, Eigen::Matrix<double, "
      "Eigen::Dynamic, Eigen::Dynamic>(2, 3)));\n"
      "        size_t ar_mat_j_2_max__ = 3;\n"
      "        size_t ar_mat_j_1_max__ = 2;\n"
      "        size_t ar_mat_k_0_max__ = 4;\n"
      "        size_t ar_mat_k_1_max__ = 5;\n"
      ...
      "                for (size_t k_1__ = 0; k_1__ < ar_mat_k_1_max__; "
      "++k_1__) {\n"
      "                    for (size_t k_0__ = 0; k_0__ < ar_mat_k_0_max__; "
      "++k_0__) {\n"
      "                        ar_mat[k_0__][k_1__](j_1__, j_2__) = "
      "vals_r__[pos__++];\n"
      "                    }\n"
      ...
      "{\n"
      "                try {\n"
      "                    writer__.matrix_lub_unconstrain(0, 1, "
      "ar_mat[i_0__][i_1__]);\n"
      "                } catch (const std::exception& e) {\n"
      "                    "
      "stan::model::rethrow_located(std::runtime_error(std::string(\"Error "
      "transforming variable ar_mat: \") + e.what()), "
...
TEST(lang, params_block_var_hpp_xform_log_prob) {
  ...
  std::string expected(
      "            // model parameters\n"
      "            current_statement_begin__ = 2;\n"
      "            std::vector<std::vector<Eigen::Matrix<local_scalar_t__, "
      "Eigen::Dynamic, Eigen::Dynamic> > > ar_mat;\n"
      ...
      "                for (size_t d_1__ = 0; d_1__ < ar_mat_d_1_max__; "
      "++d_1__) {\n"
      "                    if (jacobian__)\n"
      "                        "
...
TEST(lang, params_block_var_hpp_write_array) {
  ...
  std::string expected(
      ...
      "{\n"
      "                ar_mat[d_0__].push_back(in__.matrix_lub_constrain(0, 1, "
      "2, 3));\n"
      "            }\n"
      "        }\n"
      "        size_t ar_mat_j_2_max__ = 3;\n"
      ...
      "                    for (size_t k_0__ = 0; k_0__ < ar_mat_k_0_max__; "
      "++k_0__) {\n"
      "                        vars__.push_back(ar_mat[k_0__][k_1__](j_1__, "
      "j_2__));\n"
      "                    }\n"
      "                }\n"
      "            }\n"
...
TEST(lang, params_block_var_hpp_param_names) {
  ...
  std::string expected(
      ...
      "                        param_name_stream__ << \"ar_mat\" << '.' << "
      "k_0__ + 1 << '.' << k_1__ + 1 << '.' << j_1__ + 1 << '.' << j_2__ + 1;\n"
      "                        "
      ...
      "        }\n");
  EXPECT_EQ(2,
            count_matches(expected,
                          hpp));  // matches 2 methods: constrained_param_names,
...
TEST(lang, transformed_params_block_var_hpp_log_prob) {
  ...
  std::string expected_1(
      ...
      "            validate_non_negative_index(\"ar_mat\", \"5\", 5);\n"
      "            std::vector<std::vector<Eigen::Matrix<local_scalar_t__, "
      "Eigen::Dynamic, Eigen::Dynamic> > > ar_mat(4, "
      "std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, "
      "Eigen::Dynamic> >(5, Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, "
      "Eigen::Dynamic>(2, 3)));\n"
  ...
  std::string expected_2(
      ...
      "                    for (size_t j_1__ = 0; j_1__ < ar_mat_j_1_max__; "
      "++j_1__) {\n"
      "                        for (size_t j_2__ = 0; j_2__ < "
      "ar_mat_j_2_max__; ++j_2__) {\n"
      "                            if "
      "(stan::math::is_uninitialized(ar_mat[k_0__][k_1__](j_1__, j_2__))) {\n"
      "                                std::stringstream msg__;\n"
      "                                msg__ << \"Undefined transformed "
      "parameter: ar_mat\" << \"[\" << k_0__ << \"]\" << \"[\" << k_1__ << "
      "\"]\" << \"(\" << j_1__ << \", \" << j_2__ << \")\";\n"
      "                                "
      "stan::model::rethrow_located(std::runtime_error(std::string(\"Error "
      "initializing variable ar_mat: \") + msg__.str()), "
      "current_statement_begin__, prog_reader__());\n"
      "                            }\n"
      "                        }\n"
      "                    }\n"
...
TEST(lang, transformed_params_block_var_hpp_write_array) {
  ...
  std::string expected_1(
      ...
      "            validate_non_negative_index(\"ar_mat\", \"4\", 4);\n"
      "            validate_non_negative_index(\"ar_mat\", \"5\", 5);\n"
      "            std::vector<std::vector<Eigen::Matrix<double, "
      "Eigen::Dynamic, Eigen::Dynamic> > > ar_mat(4, "
      "std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >(5, "
      "Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(2, 3)));\n"
      "            stan::math::initialize(ar_mat, DUMMY_VAR__);\n"
  ...
  std::string expected_3(
      ...
      "                size_t ar_mat_k_0_max__ = 4;\n"
      "                size_t ar_mat_k_1_max__ = 5;\n"
      "                for (size_t j_2__ = 0; j_2__ < ar_mat_j_2_max__; "
      "++j_2__) {\n"
      "                    for (size_t j_1__ = 0; j_1__ < ar_mat_j_1_max__; "
      "++j_1__) {\n"
      "                        for (size_t k_1__ = 0; k_1__ < "
      "ar_mat_k_1_max__; ++k_1__) {\n"
      "                            for (size_t k_0__ = 0; k_0__ < "
      "ar_mat_k_0_max__; ++k_0__) {\n"
      "                                "
