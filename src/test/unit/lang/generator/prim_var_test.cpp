...
TEST(lang, data_block_var_hpp_ctor) {
  ...
  std::string expected("            // initialize data block variables from context__\n"
                       ...
                       "            context__.validate_dims(\"data initialization\", \"p2\", \"double\", context__.to_vec());\n"
                       "            p2 = double(0);\n"
                       ...
                       "            context__.validate_dims(\"data initialization\", \"ar_p1\", \"int\", context__.to_vec(3));\n"
                       ...
                       "            context__.validate_dims(\"data initialization\", \"ar_p2\", \"double\", context__.to_vec(4));\n"
...
TEST(lang, params_block_var_hpp_ctor) {
  ...
  std::string expected("            // validate, set parameter ranges\n"
                       "            num_params_r__ = 0U;\n"
...
TEST(lang, params_block_var_hpp_xform_inits) {
  ...
  std::string expected("        current_statement_begin__ = 2;\n"
                       ...
                       "        vals_r__ = context__.vals_r(\"p2\");\n"
                       "        pos__ = 0U;\n"
                       "        context__.validate_dims(\"parameter initialization\", \"p2\", \"double\", context__.to_vec());\n"
                       "        double p2(0);\n"
                       "        p2 = vals_r__[pos__++];\n"
                       "        try {\n"
                       ...
                       "            stan::lang::rethrow_located(std::runtime_error(std::string(\"Variable ar_p2 missing\")), current_statement_begin__, prog_reader__());\n"
                       "        vals_r__ = context__.vals_r(\"ar_p2\");\n"
                       "        pos__ = 0U;\n"
                       "        validate_non_negative_index(\"ar_p2\", \"4\", 4);\n"
                       "        context__.validate_dims(\"parameter initialization\", \"ar_p2\", \"double\", context__.to_vec(4));\n"
...
TEST(lang, params_block_var_hpp_param_names) {
  ...
  std::string expected("        std::stringstream param_name_stream__;\n"
...
TEST(lang, transformed_params_block_var_hpp_log_prob) {
  ...
  std::string expected_1("            // transformed parameters\n"
                         ...
                         "            current_statement_begin__ = 3;\n"
                         "            validate_non_negative_index(\"ar_p2\", \"4\", 4);\n"
                         "            std::vector<local_scalar_t__> ar_p2(4, local_scalar_t__(0));\n"
  ...
  std::string expected_2("            // validate transformed parameters\n"
                         ...
                         "                stan::lang::rethrow_located(std::runtime_error(std::string(\"Error initializing variable p2: \") + msg__.str()), current_statement_begin__, prog_reader__());\n"
                         "            }\n"
                         "            current_statement_begin__ = 3;\n"
                         "            size_t ar_p2_k_0_max__ = 4;\n"
                         "            for (size_t k_0__ = 0; k_0__ < ar_p2_k_0_max__; ++k_0__) {\n"
                         ...
                         "                    std::stringstream msg__;\n"
                         "                    msg__ << \"Undefined transformed parameter: ar_p2\" << \"[\" << k_0__ << \"]\";\n"
                         "                    stan::lang::rethrow_located(std::runtime_error(std::string(\"Error initializing variable ar_p2: \") + msg__.str()), current_statement_begin__, prog_reader__());\n"
                         "                }\n"
                         "            }\n"
                         "            size_t ar_p2_i_0_max__ = 4;\n"
                         "            for (size_t i_0__ = 0; i_0__ < ar_p2_i_0_max__; ++i_0__) {\n"
...
TEST(lang, generated_quantities_block_var_hpp_write_array) {
  ...
  // validate
  std::string expected_2("            current_statement_begin__ = 2;\n"
                         "            check_greater_or_equal(function__, \"p1\", p1, 0);\n"
                         "            check_less_or_equal(function__, \"p1\", p1, 1);\n");
  EXPECT_EQ(1, count_matches(expected_2,hpp));

  // push_back
  std::string expected_3("            vars__.push_back(p1);\n"
                         "\n"
                         "            current_statement_begin__ = 3;\n"
                         "            vars__.push_back(p2);\n"
                         "\n"
