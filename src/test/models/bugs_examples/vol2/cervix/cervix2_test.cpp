...
class Models_BugsExamples_Vol2_Cervix2 : public ::testing::Test {
protected:
  virtual void SetUp() {
    FILE *in;
    ...
    model.append("cervix").append(path_separator);
    model.append("cervix2");
...
TEST_F(Models_BugsExamples_Vol2_Cervix2,RunModel) {
  std::string command;
  command = model;
  command += " --samples=";
  command += output1;
