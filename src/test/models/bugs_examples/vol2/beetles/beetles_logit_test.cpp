...
public:
  ...
  get_expected_values(int i) {
    ...
    expected_values.push_back(make_pair(chains[i]->index("alpha"), -60.79));

    expected_values.push_back(make_pair(chains[i]->index("beta"), 34.31));

    expected_values.push_back(make_pair(chains[i]->index("rhat[1]"), 3.56));
    expected_values.push_back(make_pair(chains[i]->index("rhat[2]"), 9.932));
    expected_values.push_back(make_pair(chains[i]->index("rhat[3]"), 22.47));
    expected_values.push_back(make_pair(chains[i]->index("rhat[4]"), 33.87));
    expected_values.push_back(make_pair(chains[i]->index("rhat[5]"), 50.03));
    expected_values.push_back(make_pair(chains[i]->index("rhat[6]"), 53.21));
    expected_values.push_back(make_pair(chains[i]->index("rhat[7]"), 59.14));
    expected_values.push_back(make_pair(chains[i]->index("rhat[8]"), 58.68));
