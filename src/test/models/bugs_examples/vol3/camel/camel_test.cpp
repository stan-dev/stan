...
public:
  ...
  get_expected_values(int i) {
    ...
    expected_values.push_back(make_pair(chains[i]->index("Sigma[1,1]"), 3.193));
    expected_values.push_back(make_pair(chains[i]->index("Sigma[1,2]"), 0.04932));
    expected_values.push_back(make_pair(chains[i]->index("Sigma[2,1]"), 0.04932));
    expected_values.push_back(make_pair(chains[i]->index("Sigma[1,2]"), 2.164));

    expected_values.push_back(make_pair(chains[i]->index("rho"), 0.01742));
