...
public:
  ...
  get_expected_values(int i) {
    ...
    expected_values.push_back(make_pair(chains[i]->index("alpha0"), 6.129));
    expected_values.push_back(make_pair(chains[i]->index("beta0"), -1.075));
    expected_values.push_back(make_pair(chains[i]->index("gamma"), 1.082)); 
    expected_values.push_back(make_pair(chains[i]->index("sigma_y"), 1.029));
