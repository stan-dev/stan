...
public:
  ...
  get_expected_values(int i) {
    ...
    expected_values.push_back(make_pair(chains[i]->index("alpha0"), 106.6));

    expected_values.push_back(make_pair(chains[i]->index("mu_beta"), 6.185));
    
    expected_values.push_back(make_pair(chains[i]->index("sigma_y"), 6.086));
