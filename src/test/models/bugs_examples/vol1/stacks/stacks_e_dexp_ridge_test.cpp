...
public:
  ...
  get_expected_values(int i) {
    ...
    expected_values.push_back(make_pair(chains[i]->index("b[1]"), 0.796));
    expected_values.push_back(make_pair(chains[i]->index("b[2]"), 0.7883));
    expected_values.push_back(make_pair(chains[i]->index("b[3]"), -0.09911));

    expected_values.push_back(make_pair(chains[i]->index("b0"), -38.82));

    expected_values.push_back(make_pair(chains[i]->index("sigma"), 3.499));

    expected_values.push_back(make_pair(chains[i]->index("outlier_1"), 0.0603));
    expected_values.push_back(make_pair(chains[i]->index("outlier_3"), 0.0735));
    expected_values.push_back(make_pair(chains[i]->index("outlier_4"), 0.2875));
    expected_values.push_back(make_pair(chains[i]->index("outlier_21"), 0.5463));
