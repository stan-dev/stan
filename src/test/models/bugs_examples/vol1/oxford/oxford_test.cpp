...
public:
  ...
  get_expected_values(int i) {
    ...
    expected_values.push_back(make_pair(chains[i]->index("alpha"), 0.579));
    
    expected_values.push_back(make_pair(chains[i]->index("beta1"), -0.04557));

    expected_values.push_back(make_pair(chains[i]->index("beta2"), 0.007041));

    expected_values.push_back(make_pair(chains[i]->index("sigma"), 0.09697));
