#ifndef __TEST__UNIT_DISTRIBUTION__TEST_FIXTURE_DISTR_HPP___
#define __TEST__UNIT_DISTRIBUTION__TEST_FIXTURE_DISTR_HPP___
...
public:
  ...
  typedef typename stan::partials_return_type<T0,T1,T2,T3,T4,T5>::type T_partials_return;
