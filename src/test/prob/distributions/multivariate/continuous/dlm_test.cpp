...
TEST(ProbDistributionsGaussianDLM,LoglikeUU) {
  Matrix<double, Dynamic, Dynamic> FF(1, 1);
  FF << 0.585528817843856;
  Matrix<double, Dynamic, Dynamic> GG(1, 1);
  GG << -0.109303314681054;
  Matrix<double, Dynamic, Dynamic> V(1, 1);
  V << 2.25500747900521;
...
TEST(ProbDistributionsGaussianDLM,LoglikeMM) {
  ...
  Matrix<double, Dynamic, Dynamic> W(2, 2);
...
TEST(ProbDistributionsGaussianDLM,Sizing) {
  // consistent matrices
