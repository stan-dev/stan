#ifndef STAN_MCMC_HMC_NUTS_ADAPT_DIAG_E_RB_NUTS_HPP
#define STAN_MCMC_HMC_NUTS_ADAPT_DIAG_E_RB_NUTS_HPP

#include <stan/interface_callbacks/writer/base_writer.hpp>
#include <stan/mcmc/stepsize_var_adapter.hpp>
#include <stan/mcmc/hmc/rb_nuts/diag_e_rb_nuts.hpp>
...
namespace stan {
  namespace mcmc {
    ...
    class adapt_diag_e_rb_nuts: public diag_e_rb_nuts<Model, BaseRNG>,
                                public stepsize_var_adapter {
    public:
        adapt_diag_e_rb_nuts(const Model& model, BaseRNG& rng)
          : diag_e_rb_nuts<Model, BaseRNG>(model, rng),
            stepsize_var_adapter(model.num_params_r()) {}

      ~adapt_diag_e_rb_nuts() {}
