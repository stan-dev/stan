...
class base_nuts
 ...
 public:
  ...
  inline virtual sample transition(sample& init_sample, callbacks::logger& logger) {
    ...
    this->z_.point_type::operator=(z_sample);
  ...
  inline virtual bool compute_criterion(Eigen::VectorXd& p_sharp_minus,
   ...
   */
  inline bool build_tree(int depth, point_type& z_propose,
