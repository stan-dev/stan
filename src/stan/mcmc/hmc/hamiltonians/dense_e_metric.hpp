...
namespace stan {
  ...
  namespace mcmc {
    ...
    class dense_e_metric : public base_hamiltonian<Model, dense_e_point,
                                                   BaseRNG, Writer> {
    public:
      dense_e_metric(Model& model, Writer& writer)
        : base_hamiltonian<Model, dense_e_point, BaseRNG, Writer>(model, writer) {}
