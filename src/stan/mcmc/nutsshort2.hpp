#ifndef __STAN__MCMC__NUTSSHORT2_H__
#define __STAN__MCMC__NUTSSHORT2_H__
...
namespace stan {
  ...
  namespace mcmc {
     ...
     */
    class nutsshort2 : public sampler {
    private:
    ...
    public:
       ...
       */
      nutsshort2(mcmc::prob_grad& model,
...
//         _meanacceptprob = H - _H0;
        _meanacceptprob = min(H - _H0, _meanacceptprob);
...
//           g = g > maxg ? maxg : g;
//           g = g < -maxg ? -maxg : g;
          double g = 10*((_meanacceptprob > 0 ? 1 : exp(_meanacceptprob)) - _delta);
...
//           _meanacceptprob = direction == 1 ? Hplus - _H0 : Hminus - _H0;
          _meanacceptprob = min(direction == 1 ? Hplus - _H0 : Hminus - _H0, _meanacceptprob);
