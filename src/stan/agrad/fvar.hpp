...
struct numeric_limits<stan::agrad::fvar<T> > {
    ...
    static stan::agrad::fvar<T> epsilon() { return numeric_limits<T>::epsilon(); }
    static stan::agrad::fvar<T> round_error() { return numeric_limits<T>::round_error(); }
    ...
    static stan::agrad::fvar<T> infinity() { return numeric_limits<T>::infinity(); }
    static stan::agrad::fvar<T> quiet_NaN() { return numeric_limits<T>::quiet_NaN(); } 
    static stan::agrad::fvar<T> signaling_NaN() { return numeric_limits<T>::signaling_NaN(); }
    static stan::agrad::fvar<T> denorm_min() { return numeric_limits<T>::denorm_min(); }
