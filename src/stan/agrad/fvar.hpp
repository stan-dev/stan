...
struct numeric_limits<stan::agrad::fvar<T> > {
    ...
    static stan::agrad::var min() { return numeric_limits<T>::min(); }
    static stan::agrad::var max() { return numeric_limits<T>::max(); }
    ...
    static stan::agrad::var epsilon() { return numeric_limits<T>::epsilon(); }
    static stan::agrad::var round_error() { return numeric_limits<T>::round_error(); }
    ...
    static stan::agrad::var infinity() { return numeric_limits<T>::infinity(); }
    static stan::agrad::var quiet_NaN() { return numeric_limits<T>::quiet_NaN(); }
    static stan::agrad::var signaling_NaN() { return numeric_limits<T>::signaling_NaN(); }
    static stan::agrad::var denorm_min() { return numeric_limits<T>::denorm_min(); }
