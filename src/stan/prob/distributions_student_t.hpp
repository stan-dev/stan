...
namespace stan {
  namespace prob {
    ...
    student_t_log(const T_y& y, const T_dof& nu, const T_loc& mu, const T_scale& sigma, const Policy& /* pol */) {
    ...
    student_t_log(const T_y& y, const T_dof& nu, const T_loc& mu, const T_scale& sigma) {
      return student_t_log (y, nu, mu, sigma, boost::math::policies::policy<>());
    }
    ...
    template <typename T_y, 
	      ...
	      class Policy>
    inline typename boost::math::tools::promote_args<T_y,T_dof,T_loc,T_scale>::type
    student_t_propto_log(const T_y& y, const T_dof& nu, const T_loc& mu, const T_scale& sigma, const Policy& /* pol */) {
      return student_t_log (y, nu, mu, sigma, Policy());
    }
    ...
    student_t_propto_log(const T_y& y, const T_dof& nu, const T_loc& mu, const T_scale& sigma) {
      return student_t_propto_log (y, nu, mu, sigma, boost::math::policies::policy<>());
    }
