...
namespace stan {
  namespace prob {
     ...
     */
    template <typename T_y, typename T_low, typename T_high, class Policy = boost::math::policies::policy<> >
    ...
    template <typename T_y, typename T_low, typename T_high, class Policy = boost::math::policies::policy<> >
    inline typename boost::math::tools::promote_args<T_y,T_low,T_high>::type
    uniform_propto_log(const T_y& y, const T_low& alpha, const T_high& beta, const Policy& /* pol */ = Policy()) {
