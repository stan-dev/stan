...
namespace stan {
  namespace prob {
    ...
    template <typename T_y, typename T_low, typename T_high, class Policy>
    inline void
    uniform_propto_log(stan::agrad::var& lp, const T_y& y, const T_low& alpha, const T_high& beta, const Policy& /* pol */) {
      lp += uniform_propto_log (y, alpha, beta, Policy());
    }
    ...
    uniform_propto_log(stan::agrad::var& lp, const T_y& y, const T_low& alpha, const T_high& beta) {
      lp += uniform_propto_log (y, alpha, beta, boost::math::policies::policy<>());
    }
