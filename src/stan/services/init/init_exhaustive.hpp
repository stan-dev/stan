#ifndef STAN_SERVICES_INIT_INIT_EXHAUSTIVE_HPP
#define STAN_SERVICES_INIT_INIT_EXHAUSTIVE_HPP
...
namespace stan {
  namespace services {
    namespace init {
      ...
      bool init_exhaustive(stan::mcmc::base_mcmc* sampler,
        ...
        stan::services::categorical_argument* base
          = dynamic_cast<stan::services::categorical_argument*>
              (algorithm->arg("hmc")->arg("engine")->arg("exhaustive"));
