...
int hmc_nuts_diag_e_adapt(
    ...
    int num_cross_chains, int cross_chain_window, int num_warmup, int num_samples,
  ...
  util::run_mpi_adaptive_sampler(sampler, 
      model, cont_vector, num_cross_chains, cross_chain_window, num_warmup, num_samples, num_thin, refresh,
...
int hmc_nuts_diag_e_adapt(
  ...
  return hmc_nuts_diag_e_adapt(
      ...
      num_cross_chains, cross_chain_window, num_warmup,
