#ifndef STAN_SERVICES_SAMPLE_INIT_RB_NUTS_HPP
#define STAN_SERVICES_SAMPLE_INIT_RB_NUTS_HPP
...
namespace stan {
  namespace services {
    namespace sample {
      ...
      bool init_rb_nuts(stan::mcmc::base_mcmc* sampler,
        ...
        stan::services::categorical_argument* base
          = dynamic_cast<stan::services::categorical_argument*>
          (algorithm->arg("hmc")->arg("engine")->arg("rb_nuts"));
