...
namespace stan {
  namespace services {
    namespace sample {
      ...
      int hmc_nuts_auto_e_adapt(Model& model, stan::io::var_context& init,
        ...
        stan::mcmc::adapt_auto_e_nuts<Model, boost::ecuyer1988>
          sampler(model, rng);
      ...
      int hmc_nuts_auto_e_adapt(Model& model, stan::io::var_context& init,
        ...
        return hmc_nuts_auto_e_adapt(model, init, unit_e_metric,
