  ...
  namespace services {
    ...
    int command(int argc, const char* argv[]) {
      ...
      if (parser.arg("method")->arg("sample")) {
        ...
        if (algo->value() == "fixed_param") {
          ...
          switch (sampler_select) {
            ...
            case 0: {
              ...
              if (!init::init_static_hmc<sampler>(sampler_ptr, algo)) return 0;
              break;
            }
            ...
            case 1: {        
              ...
              sampler_ptr = new sampler(model, base_rng, &std::cout, &std::cout);
              if (!init::init_nuts<sampler>(sampler_ptr, algo)) return 0;
              break;
            }
            ...
            case 100: {
              ...
              sampler_ptr = new sampler(model, base_rng, &std::cout, &std::cout);
              if (!init::init_static_hmc<sampler>(sampler_ptr, algo)) return 0;
              if (!init::init_adapt<sampler>(sampler_ptr, adapt, cont_params)) return 0;
              break;
            }
        ...
        mcmc::sample<Model, rng_t>(sampler_ptr, num_warmup, num_samples, num_thin,
                                   refresh, true,
                                   writer,
                                   s, model, base_rng,
                                   prefix, suffix, std::cout,
