...
/**
 * Configuration class for NUTS adaptation parameters.
 * 
 * Handles target acceptance rate, adaptation schedule,
 * and step size adaptation settings.
 */
class nuts_adapt_config {
public:
  /**
   * Builder class for constructing NUTS adaptation configuration.
   */
