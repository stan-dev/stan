 ...
 */
inline auto rvalue_at(int n, const index_multi& idx) { return idx.ns_[n]; }
 ...
 * @return Underlying index position (from 1).
 */
inline auto rvalue_at(int n, const index_omni& idx) { return n + 1; }
 ...
 * @return Underlying index position (from 1).
 */
inline auto rvalue_at(int n, const index_min& idx) { return idx.min_ + n; }
 ...
 * @return Underlying index position (from 1).
 */
inline auto rvalue_at(int n, const index_max& idx) { return n + 1; }
 ...
 * @return Underlying index position (from 1).
 */
inline auto rvalue_at(int n, const index_min_max& idx) { return idx.min_ + n; }
