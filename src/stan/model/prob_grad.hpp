...
namespace stan {
  ...
  namespace model {
    ...
    public:
      ...
      /**
       * Write the parameters on a single line in CSV format.  The
       * implementation in this abstract base class writes out the
       * free parameters as viwed by HMC.  Subclasses may extend this
       * class and override this implementation to return constrained
       * values which may differ in both number and scale from the raw
