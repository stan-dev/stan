...
class model_base : public prob_grad {
 public:
  ...
  /**
   * Return a vector of the sizes of the parameters, transformed
   * parameters, and generated quantities in the order in which they
   * were declared.
   *
   * @param[in] include_tparams true if transformed parameters should
   ...
   * @param[in] include_gqs true if generated quantities should be
   * included
   * @return vector of sizes of parameters, transformed parameters,
   * and generated quantities
   */
  virtual std::vector<size_t> get_param_sizes(bool include_tparams = true,
                                              bool include_gqs = true) const
      = 0;
   ...
   * Existing usages of this function can most likely be re-written
   * to only depend on `get_param_sizes()` while a more sophisticated
   * replacement of this function is developed.
   *
