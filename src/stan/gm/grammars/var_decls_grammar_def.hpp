...
namespace stan {
  ...
  namespace gm {
    ...
    struct add_var {
      ...
      template <typename T>
      void operator()(const T& var_decl, 
                   variable_map& vm,
                   bool& pass,
                   const var_origin& vo,
    ...
    struct set_int_range_lower {
      ...
      void operator()(range& range,
        ...
        validator(expr,error_msgs, pass);
      }
    };
        ...
        expression07_g(var_map,error_msgs,false)
    {
      ...
      var_decl_r 
        %= (int_decl_r(_r2)             
            [add_var_f(_1,boost::phoenix::ref(var_map_),_a,_r2,
      ...
      vector_decl_r 
        ...
        > lit('[')
        > expression_g(_r1)
        [validate_int_expr_f(_1,boost::phoenix::ref(error_msgs_), _pass)]
        > lit(']')
        > identifier_r 
        > opt_dims_r(_r1)
        > lit(';');
      ...
      range_brackets_double_r 
        ...
        > ( 
           ( (lit("lower")
              > lit('=')
              > expression07_g(_r1)
              [ set_double_range_lower_f(_val,_1,
                                        boost::phoenix::ref(error_msgs_),
                                        _pass) ])
             > -( lit(',')
                  > lit("upper")
                  > lit('=')
                  > expression07_g(_r1)
                    [ set_double_range_upper_f(_val,_1,
                                                boost::phoenix::ref(error_msgs_),
                                                _pass) ] ) )
           | 
           ( lit("upper")
