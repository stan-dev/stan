...
namespace stan {
  ...
  namespace gm {
    ...
    int nuts_command(int argc, const char* argv[]) {
      ...
      // Combine this outpot wtih below calling std::cout instead of sample_stream?
      ...
      stan::io::mcmc_writer mcmc_output(&sample_stream, 0);
      ...
      if (nondiag_mass) {
        ...
        */
        ...
        //mcmc_output.print_sample_names(s, sampler, model);
        //mcmc_output.print_sample_params(s, sampler, model);
        ...
        mcmc_output.print_adapt_finish(sampler);
      ...
      mcmc_output.print_timing(warmDeltaT, sampleDeltaT);
