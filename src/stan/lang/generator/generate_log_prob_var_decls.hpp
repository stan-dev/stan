#ifndef STAN_LANG_GENERATOR_GENERATE_LOG_PROB_VAR_DECLS_HPP
#define STAN_LANG_GENERATOR_GENERATE_LOG_PROB_VAR_DECLS_HPP
...
namespace stan {
  namespace lang {
     ...
     */
    void generate_log_prob_var_decls(const std::vector<block_var_decl>& vs, int indent,
                                  std::ostream& o) {
