...
namespace stan {
namespace lang {
vector_block_type::vector_block_type(const range& bounds, const offset_multiplier& ls,
                                     const expression& N)
...
vector_block_type::vector_block_type(const offset_multiplier& ls, const expression& N)
