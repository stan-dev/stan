...
namespace stan {
  namespace lang {
    ...
    expression block_type_params_total_vis::operator()(const block_array_type& x) const {
    ...
    expression block_type_params_total_vis::operator()(const ill_formed_type& x) const {
    ...
    expression block_type_params_total_vis::operator()(const ordered_block_type& x) const {
      return x.K_;
    }

    expression block_type_params_total_vis::operator()(const positive_ordered_block_type& x) const {
      return x.K_;
    }

    expression block_type_params_total_vis::operator()(const row_vector_block_type& x) const {
      return x.N_;
    }
    ...
    expression block_type_params_total_vis::operator()(const vector_block_type& x) const {
      return x.N_;
    }
  }
}
