...
bool is_array_type_vis::operator()(
...
bool is_array_type_vis::operator()(const double_type& x) const { return false; }
...
bool is_array_type_vis::operator()(const int_type& x) const { return false; }
...
bool is_array_type_vis::operator()(const matrix_type& x) const { return false; }
...
bool is_array_type_vis::operator()(const vector_type& x) const { return false; }

bool is_array_type_vis::operator()(const void_type& x) const { return false; }
}  // namespace lang
}  // namespace stan
#endif
