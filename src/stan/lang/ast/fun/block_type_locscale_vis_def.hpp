#ifndef STAN_LANG_AST_FUN_BLOCK_TYPE_LOCSCALE_VIS_DEF_HPP
#define STAN_LANG_AST_FUN_BLOCK_TYPE_LOCSCALE_VIS_DEF_HPP

#include <stan/lang/ast.hpp>

namespace stan {
namespace lang {
block_type_locscale_vis::block_type_locscale_vis() {}

locscale block_type_locscale_vis::operator()(const block_array_type& x) const {
  return locscale();
}

locscale block_type_locscale_vis::operator()(
...
locscale block_type_locscale_vis::operator()(const int_block_type& x) const {
  return locscale();
}
