#ifndef STAN_LANG_AST_FUN_GET_BARE_ARRAY_DIMS_VIS_HPP
#define STAN_LANG_AST_FUN_GET_BARE_ARRAY_DIMS_VIS_HPP
...
namespace stan {
  namespace lang {
     ...
     */
    struct get_bare_array_dims_vis : public boost::static_visitor<int> {
      /**
       * Construct a visitor.
       */
      get_bare_array_dims_vis();
