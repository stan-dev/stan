#ifndef STAN_LANG_AST_FUN_IS_MATRIX_TYPE_VIS_HPP
#define STAN_LANG_AST_FUN_IS_MATRIX_TYPE_VIS_HPP
...
namespace stan {
  namespace lang {
    ...
    /**
     * Visitor to determine if a base_expr_type is matrix type.
     */
    struct is_matrix_type_vis : public boost::static_visitor<bool> {
    
      /**
       * Return true if the specified base expression type is matrix type.
       *
