...
offset_multiplier block_type_offset_multiplier_vis::operator()(const block_array_type& x) const {
...
offset_multiplier block_type_offset_multiplier_vis::operator()(const int_block_type& x) const {
  return offset_multiplier();
}
