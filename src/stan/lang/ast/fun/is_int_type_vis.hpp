#ifndef STAN_LANG_AST_FUN_IS_INT_TYPE_VIS_HPP
#define STAN_LANG_AST_FUN_IS_INT_TYPE_VIS_HPP
...
namespace stan {
  namespace lang {
    ...
    /**
     * Visitor to determine if a base_expr_type is int type.
     */
    struct is_int_type_vis : public boost::static_visitor<bool> {
    
      /**
       * Return true if the specified base expression type is int type.
       *
