...
namespace stan {
  namespace lang {
    ...
    function_arg_type::function_arg_type(const bare_expr_type& e_type)
      : bare_expr_type_(e_type), data_only_(false) { }

    function_arg_type::function_arg_type(const bare_expr_type& e_type,
                                         bool data_only)
      : bare_expr_type_(e_type), data_only_(data_only) { }

    bool function_arg_type::operator==(const function_arg_type& fa_type) const {
      return bare_expr_type_ == fa_type.bare_expr_type_;
    }
