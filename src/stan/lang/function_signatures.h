      ...
      for (size_t k = 0; k < 2; ++k) {
        for (size_t l = 0; l < 2; ++l) {
          add("multi_normal_cholesky_log", bare_expr_type(double_type()),
              bare_expr_type(bare_array_type(eigen_vector_types[k], i)),
              bare_expr_type(bare_array_type(eigen_vector_types[l], j)), bare_expr_type(matrix_type()));
          ...
          add("multi_student_t_log", bare_expr_type(double_type()),
              bare_expr_type(bare_array_type(eigen_vector_types[k], i)), bare_expr_type(double_type()),
              bare_expr_type(bare_array_type(eigen_vector_types[l], j)), bare_expr_type(matrix_type()));
