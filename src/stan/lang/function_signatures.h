...
/* for (size_t i = 0; i < bare_types.size(); ++i) { */
/*   add("head", expr_type(bare_types[i], 1U), */
/*       expr_type(bare_types[i], 1U), expr_type(int_type())); */
/*   add("head", expr_type(bare_types[i], 2U), */
/*       expr_type(bare_types[i], 2U), expr_type(int_type())); */
/*   add("head", expr_type(bare_types[i], 3U), */
/*       expr_type(bare_types[i], 3U), expr_type(int_type())); */
/* } */
...
/* for (size_t i = 0; i < bare_types.size(); ++i) { */
/*   add("rep_array", expr_type(bare_types[i], 1), bare_types[i], expr_type(int_type())); */
/*   add("rep_array", expr_type(bare_types[i], 2), bare_types[i], expr_type(int_type()), expr_type(int_type())); */
/*   add("rep_array", expr_type(bare_types[i], 3), bare_types[i], */
/*       expr_type(int_type()), expr_type(int_type()), expr_type(int_type())); */
/*   for (size_t j = 1; j <= 3; ++j) { */
/*     add("rep_array", expr_type(bare_types[i], j + 1), */
/* 	expr_type(bare_types[i], j),  expr_type(int_type())); */
/*     add("rep_array", expr_type(bare_types[i], j + 2), */
/* 	expr_type(bare_types[i], j),  expr_type(int_type()), expr_type(int_type())); */
/*     add("rep_array", expr_type(bare_types[i], j + 3), */
/* 	expr_type(bare_types[i], j),  expr_type(int_type()), expr_type(int_type()), expr_type(int_type())); */
/*   } */
/* } */
...
/* for (size_t i = 0; i < bare_types.size(); ++i) { */
/*   add("segment", expr_type(bare_types[i], 1U), */
/*       expr_type(bare_types[i], 1U), expr_type(int_type()), expr_type(int_type())); */
/*   add("segment", expr_type(bare_types[i], 2U), */
/*       expr_type(bare_types[i], 2U), expr_type(int_type()), expr_type(int_type())); */
/*   add("segment", expr_type(bare_types[i], 3U), */
/*       expr_type(bare_types[i], 3U), expr_type(int_type()), expr_type(int_type())); */
/* } */
...
/* for (size_t i = 0; i < bare_types.size(); ++i) { */
/*   add("tail", expr_type(bare_types[i], 1U), */
/*       expr_type(bare_types[i], 1U), expr_type(int_type())); */
/*   add("tail", expr_type(bare_types[i], 2U), */
/*       expr_type(bare_types[i], 2U), expr_type(int_type())); */
/*   add("tail", expr_type(bare_types[i], 3U), */
/*       expr_type(bare_types[i], 3U), expr_type(int_type())); */
/* } */
