...
namespace stan {
  ...
  namespace common {
    ...
    int command(int argc, const char* argv[]) {
      ...
      // Identification
      unsigned int id = dynamic_cast<stan::gm::int_argument*>
        (parser.arg("id"))->value();
      ...
      stan::gm::u_int_argument* random_arg
        = dynamic_cast<stan::gm::u_int_argument*>
      ...
      if (parser.arg("method")->arg("optimize")) {
        ...
        stan::gm::list_argument* algo
          = dynamic_cast<stan::gm::list_argument*>
          (parser.arg("method")->arg("optimize")->arg("algorithm"));

        int num_iterations
          = dynamic_cast<stan::gm::int_argument*>
      ...
      if (parser.arg("method")->arg("sample")) {
        ...
        bool save_warmup
          = dynamic_cast<stan::gm::bool_argument*>
        ...
        bool adapt_engaged
          = dynamic_cast<stan::gm::bool_argument*>(adapt->arg("engaged"))
          ->value();
          ...
          switch (sampler_select) {
            case 0: {
              ...
              sampler_ptr = new sampler(model, base_rng,
                                        &std::cout, &std::cout);
              if (!init_static_hmc<sampler>(sampler_ptr, algo))
                return 0;
              break;
            }
            ...
            case 1: {
              ...
              sampler_ptr = new sampler(model, base_rng,
                                        &std::cout, &std::cout);
              if (!init_nuts<sampler>(sampler_ptr, algo))
                return 0;
              break;
            }
            ...
            case 100: {
              ...
              if (!init_static_hmc<sampler>(sampler_ptr, algo))
                return 0;
              if (!init_adapt<sampler>(sampler_ptr, adapt, cont_params))
                return 0;
              break;
            }
            ...
            case 110: {
              ...
              if (!init_static_hmc<sampler>(sampler_ptr, algo))
                return 0;
              if (!init_windowed_adapt<sampler>
        ...
        if (adapt_engaged) {
          dynamic_cast<mcmc::base_adapter*>(sampler_ptr)
