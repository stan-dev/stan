#ifndef __STAN__DIFF__FWD__NUMERIC__LIMITS__HPP__
#define __STAN__DIFF__FWD__NUMERIC__LIMITS__HPP__
...
namespace std {
  ...
  struct numeric_limits<stan::diff::fvar<T> > {
    static const bool is_specialized = true;
    static stan::diff::fvar<T> min() { return numeric_limits<double>::min(); }
    static stan::diff::fvar<T> max() { return numeric_limits<double>::max(); }
    ...
    static stan::diff::fvar<T> epsilon() { 
      return numeric_limits<double>::epsilon(); }
    static stan::diff::fvar<T> round_error() { 
    ...
    static stan::diff::fvar<T> infinity() { 
      return numeric_limits<double>::infinity(); }
    static stan::diff::fvar<T> quiet_NaN() { 
      return numeric_limits<double>::quiet_NaN(); }
    static stan::diff::fvar<T> signaling_NaN() { 
      return numeric_limits<double>::signaling_NaN(); }
    static stan::diff::fvar<T> denorm_min() { 
