...
namespace stan {
  namespace math {
    ...
    mdivide_right_spd(const Eigen::Matrix<T1,R1,C1> &b,
      ...
      stan::error_handling::check_symmetric("mdivide_right_spd(%1%)",A,"A",(double*)0);
      stan::error_handling::check_pos_definite("mdivide_right_spd(%1%)",A,"A",(double*)0);
      stan::error_handling::check_square("mdivide_right_spd(%1%)",A,"A",(double*)0);
      stan::error_handling::check_multiplicable("mdivide_right_spd(%1%)",b,"b",
                                      A,"A",(double*)0);
