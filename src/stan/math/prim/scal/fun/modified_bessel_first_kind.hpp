#ifndef STAN__MATH__PRIM__SCAL__FUN__MODIFIED_BESSEL_FIRST_KIND_HPP
#define STAN__MATH__PRIM__SCAL__FUN__MODIFIED_BESSEL_FIRST_KIND_HPP
...
namespace stan {
  namespace math {
     ...
     *
       ...
       \begin{cases}
         \frac{\partial\, I_v(z)}{\partial z} & \mbox{if } -\infty\leq z\leq \infty \\[6pt]
         \textrm{error} & \mbox{if } z = \textrm{NaN}
       \end{cases}
       \f]
