#ifndef STAN__MATH__PRIM__SCAL__PROB__EXPONENTIAL_CDF_LOG_HPP
#define STAN__MATH__PRIM__SCAL__PROB__EXPONENTIAL_CDF_LOG_HPP
  ...
  namespace prob {
    ...
    exponential_cdf_log(const T_y& y, const T_inv_scale& beta) {
      ...
      for (size_t n = 0; n < N; n++) {
        ...
        const T_partials_return y_dbl = value_of(y_vec[n]);        T_partials_return one_m_exp = 1.0 - exp(-beta_dbl * y_dbl);
        // log cdf
