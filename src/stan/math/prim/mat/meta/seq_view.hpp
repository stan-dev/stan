...
namespace stan {
  ...
  namespace math {
    ...
    public:
      explicit seq_view(typename pass_type<S>::type x)
        : x_(x) {
      }
      inline typename pass_type<T>::type
    ...
    public:
      explicit seq_view(typename
                        pass_type<Eigen::Matrix<S, Eigen::Dynamic, 1> >::type x)
        : x_(x) {
      }
      inline typename pass_type<T>::type
      operator[](int n) const {
    ...
    public:
      explicit seq_view(typename pass_type
                        <Eigen::Matrix<S, 1, Eigen::Dynamic> >::type x)
        : x_(x) {
      }
      inline typename pass_type<T>::type
      operator[](int n) const {
    ...
    private:
      typename store_type<Eigen::Matrix
                          <S, Eigen::Dynamic, Eigen::Dynamic> >::type x_;
    public:
      explicit
      seq_view(typename pass_type<Eigen::Matrix
               <S, Eigen::Dynamic, Eigen::Dynamic> >::type x)
        : x_(x) {
      }
      inline typename pass_type<T>::type
      operator[](int n) const {
    ...
    public:
      explicit seq_view(typename pass_type<std::vector<S> >::type x)
        : x_(x),
          elt_size_(x_.size() == 0 ? 0 : seq_view<T, S>(x_[0]).size()) {
      }
      inline typename pass_type<T>::type
      operator[](int n) const {
    ...
    public:
      explicit seq_view(typename pass_type<std::vector<T> >::type x)
        : x_(x) {
      }
      inline typename pass_type<T>::type
      operator[](int n) const {
    ...
    public:
      explicit seq_view(typename pass_type
                        <std::vector<std::vector<T> > >::type x)
        : x_(x),
          cols_(x_.size() == 0 ? 0 : x_[0].size()) {  }
      inline typename pass_type<T>::type
      operator[](int n) const {
    ...
    public:
      explicit seq_view(pass_type<std::vector<int> >::type x)
        : x_(x) {
      }
