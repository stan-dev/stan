...
namespace stan {
  ...
  namespace math {
    ...
    sparse_multiply_csc(const int& m,
      ...
      stan::math::check_size_match("sparse_multiply_csc","n/b", n, b.size());
      stan::math::check_size_match("sparse_multiply_csc","n/u", n, u.size()-1);
      stan::math::check_size_match("sparse_multiply_csc","n/z", n, z.size()  );
      stan::math::check_size_match("sparse_multiply_csc","w/v", w.size(), v.size());
      stan::math::check_size_match("sparse_multiply_csc","u/z/v", u[n-1] + z[n-1]-1, v.size());
