#ifndef STAN__ERROR_HANDLING__CHECK_CONSISTENT_SIZES_HPP
#define STAN__ERROR_HANDLING__CHECK_CONSISTENT_SIZES_HPP

#include <stan/error_handling/check_consistent_size.hpp>
