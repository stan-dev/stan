#ifndef STAN_OLD_SERVICES_ARGUMENTS_ARG_VARIATIONAL_ADAPT_HPP
#define STAN_OLD_SERVICES_ARGUMENTS_ARG_VARIATIONAL_ADAPT_HPP

#include <stan/old_services/arguments/categorical_argument.hpp>
#include <stan/old_services/arguments/arg_variational_adapt_engaged.hpp>
#include <stan/old_services/arguments/arg_variational_adapt_iter.hpp>
