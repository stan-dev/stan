#ifndef STAN_OLD_SERVICES_ARGUMENTS_ARG_METHOD_HPP
#define STAN_OLD_SERVICES_ARGUMENTS_ARG_METHOD_HPP
...
#include <stan/old_services/arguments/arg_variational.hpp>
