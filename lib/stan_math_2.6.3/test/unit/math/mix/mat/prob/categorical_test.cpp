...
TEST(ProbDistributionsCategorical,fvar_var) {
  ...
  EXPECT_FLOAT_EQ(std::log(0.3), stan::math::categorical_log(1,theta).val_.val());
  EXPECT_FLOAT_EQ(std::log(0.5), stan::math::categorical_log(2,theta).val_.val());
  EXPECT_FLOAT_EQ(std::log(0.2), stan::math::categorical_log(3,theta).val_.val());
...
TEST(ProbDistributionsCategorical,fvar_fvar_var) {
  ...
  EXPECT_FLOAT_EQ(std::log(0.3), stan::math::categorical_log(1,theta).val_.val_.val());
  EXPECT_FLOAT_EQ(std::log(0.5), stan::math::categorical_log(2,theta).val_.val_.val());
  EXPECT_FLOAT_EQ(std::log(0.2), stan::math::categorical_log(3,theta).val_.val_.val());
