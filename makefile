...
clean-all: clean clean-manual clean-models
	...
	cd src/test/unit-distribution/univariate/continuous; $(RM) $(shell find src/test/unit-distribution/univariate/continuous -name '*_generated_v_test.cpp' -type f | sed 's#src/test/unit-distribution/univariate/continuous/\(.*\)/.*#\1/*_generated_v_test.cpp#' | sort -u)
	cd src/test/unit-distribution/univariate/discrete; $(RM) $(shell find src/test/unit-distribution/univariate/discrete -name '*_generated_v_test.cpp' -type f | sed 's#src/test/unit-distribution/univariate/discrete/\(.*\)/.*#\1/*_generated_v_test.cpp#' | sort -u)
	cd src/test/unit-distribution/univariate/continuous; $(RM) $(shell find src/test/unit-distribution/univariate/continuous -name '*_generated_fd_test.cpp' -type f | sed 's#src/test/unit-distribution/univariate/continuous/\(.*\)/.*#\1/*_generated_fd_test.cpp#' | sort -u)
	cd src/test/unit-distribution/univariate/discrete; $(RM) $(shell find src/test/unit-distribution/univariate/discrete -name '*_generated_fd_test.cpp' -type f | sed 's#src/test/unit-distribution/univariate/discrete/\(.*\)/.*#\1/*_generated_fd_test.cpp#' | sort -u)
	cd src/test/unit-distribution/univariate/continuous; $(RM) $(shell find src/test/unit-distribution/univariate/continuous -name '*_generated_fv_test.cpp' -type f | sed 's#src/test/unit-distribution/univariate/continuous/\(.*\)/.*#\1/*_generated_fv_test.cpp#' | sort -u)
	cd src/test/unit-distribution/univariate/discrete; $(RM) $(shell find src/test/unit-distribution/univariate/discrete -name '*_generated_fv_test.cpp' -type f | sed 's#src/test/unit-distribution/univariate/discrete/\(.*\)/.*#\1/*_generated_fv_test.cpp#' | sort -u)
	cd src/test/unit-distribution/univariate/continuous; $(RM) $(shell find src/test/unit-distribution/univariate/continuous -name '*_generated_ffd_test.cpp' -type f | sed 's#src/test/unit-distribution/univariate/continuous/\(.*\)/.*#\1/*_generated_ffd_test.cpp#' | sort -u)
	cd src/test/unit-distribution/univariate/discrete; $(RM) $(shell find src/test/unit-distribution/univariate/discrete -name '*_generated_ffd_test.cpp' -type f | sed 's#src/test/unit-distribution/univariate/discrete/\(.*\)/.*#\1/*_generated_ffd_test.cpp#' | sort -u)
	cd src/test/unit-distribution/univariate/continuous; $(RM) $(shell find src/test/unit-distribution/univariate/continuous -name '*_generated_fv_test.cpp' -type f | sed 's#src/test/unit-distribution/univariate/continuous/\(.*\)/.*#\1/*_generated_ffv_test.cpp#' | sort -u)
	cd src/test/unit-distribution/univariate/discrete; $(RM) $(shell find src/test/unit-distribution/univariate/discrete -name '*_generated_fv_test.cpp' -type f | sed 's#src/test/unit-distribution/univariate/discrete/\(.*\)/.*#\1/*_generated_ffv_test.cpp#' | sort -u)
