...
RCPP_MODULE(rstantest){
  ...
  function("test_rlist_ref_var_context1", &test_rlist_ref_var_context1); 
  function("test_rlist_ref_var_context2", &test_rlist_ref_var_context2); 
  function("test_rlist_ref_var_context3", &test_rlist_ref_var_context3); 
}
