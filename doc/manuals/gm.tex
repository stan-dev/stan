...
\subsection{Inverse Correlation Matrix Transform}
...
\subsection{Absolute Jacobian Determinant of the Inverse Correlation
  Matrix Transform}
...
Without writing everything out again, the Jacobian determinant is
multiplied by the exponential transforms and the multipliers.
...
\]
%
The unconstrained scaling factors themselves are then recoverd by
