...
\chapter{Data Types \\ and Variable Declarations}
...
denote an action to be taken.  This chapter describes \Stan expressions
and the next covers statements.  
...
\chapter{Continuous Probabilities}
