...
signature of the function must be registered with \Stan.  After that,
as long as the source code for the function is included for the
compiler, the custom distribution may be used like any other
distribution.
...
\Cpp and then their function signature ma be registered with the
parser and then they can be used just like any other distribution in
Stan.

distributions within its programming language.
