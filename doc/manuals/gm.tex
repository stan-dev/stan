...
If $\theta \in [0,1]$ and $c \in \setlist{0,1}$, then
\[
...
\section{Bounded Discrete Probabilities}
...
If $N \in \{0,1,\ldots\}$, $n \in \{0,\ldots,N\}$, and $\theta \in
[0,1]$, then
\[
...
If $N \in \setlist{0,1,\ldots}$, $n \in \setlist{0,\ldots,N}$, 
$\alpha \in (0,\infty)$, and $\beta \in (0,\infty)$, then
\[
...
If $a \in \setlist{0,1,\ldots}$, $b \in \setlist{0,1,\ldots}$,
$N \in \setlist{0,\ldots,a+b}$, and
$n \in \setlist{0,\ldots,\min(a,N)}$, then
\[
...
If $N \in \setlist{1,\ldots}$, $\theta \in \mbox{$N$-simplex}$, and $n
\in \setlist{1,\ldots,N}$, then
\[
...
If $n \in \setlist{0,1,\ldots}$, $\alpha \in (0,\infty)$, and $\beta
\in (0,\infty)$, then
\[
...
If $n \in \setlist{0,1,\ldots}$ and $\lambda \in (0,\infty)$, then
\[
...
If $K \in \setlist{0,1,\ldots}$, 
$N \in \setlist{0,1,\ldots}$, 
$\theta \in \mbox{$K$-simplex}$, and
$y \in \mathbb{N}^K$ such $\sum_{k=1}^K y_k = N$, then
%
\[
...
\begin{description}
  \fitem{real}{pareto\_log}{real \farg{y}, real \farg{y\_min}, real
    \farg{alph}}{The Pareto density of \farg{y} given positive minimum
...
The simplex probabilities have support on the $K$-simplex for a
specified $K$.
...
\subsection{Multivariate Normal Distribution (Cholesky Factor Parameterization)}
\begin{description}
%
