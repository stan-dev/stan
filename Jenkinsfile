                ...
                stage('Integration Mac') {
                    ...
                    steps {
                        ...
                        sh """
                            ...
                            make -j${env.PARALLEL} build
                            cd ..
                            python3 ./runPerformanceTests.py -j${env.PARALLEL} ${integration_tests_flags()}--runs=0 stanc3/test/integration/good
                            python3 ./runPerformanceTests.py -j${env.PARALLEL} ${integration_tests_flags()}--runs=0 example-models
                        """
                        sh """
                            cd performance-tests-cmdstan/cmdstan/stan
